...
public:
	...
	// Corpses
	/*inline*/ bool					IsDeadplantsLevel();
	// Zombotany
	/*inline*/ bool					IsZombotanyLevel();
	// Accelerated
	/*inline*/ bool					IsAcceleratedLevel();
	// Config
	void							ShowConfigScreen(ConfigPage thePage);
	void							KillConfigScreen();
	// New
	/*inline*/ bool					IsMinecraftLevel();
	/*inline*/ bool					IsSkipAreaLevel();
	/*inline*/ bool					IsColumnLevel();
	/*inline*/ bool					IsPortalLevel();
	/*inline*/ bool					GetConfigCheckbox(bool theSaveBoard, int theConfigCheckbox);
};
