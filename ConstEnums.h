...
enum BackgroundType
{
    ...
    BACKGROUND_DAY_FALL,
    BACKGROUND_NIGHT_FALL,
    BACKGROUND_POOL_FALL,
    BACKGROUND_FOG_FALL,
    BACKGROUND_ROOF_FALL,
    BACKGROUND_MOON_FALL,
    BACKGROUND_DAY_WINTER,
    BACKGROUND_NIGHT_WINTER,
    BACKGROUND_POOL_WINTER,
    BACKGROUND_FOG_WINTER,
    BACKGROUND_ROOF_WINTER,
    BACKGROUND_MOON_WINTER,
    BACKGROUND_DAY_SPRING,
    BACKGROUND_NIGHT_SPRING,
    BACKGROUND_POOL_SPRING,
    BACKGROUND_FOG_SPRING,
    BACKGROUND_ROOF_SPRING,
    BACKGROUND_MOON_SPRING,
    BACKGROUND_RESORT,
    BACKGROUND_DEADPLANTS,
    BACKGROUND_HEAVEN,
};
enum BoardResult
{
...
enum ChallengePage
{
    ...
    CHALLENGE_PAGE_SURVIVAL_FALL = 4,
    CHALLENGE_PAGE_SURVIVAL_WINTER = 5,
    CHALLENGE_PAGE_SURVIVAL_SPRING = 6,
    CHALLENGE_PAGE_CHALLENGE_2 = 7,
    MAX_CHALLENGE_PAGES = 8,
};
enum ChallengeState
{
...
enum GameMode
{
    ...
    GAMEMODE_CHALLENGE_WAR_AND_PEAS, // 0 0
    GAMEMODE_CHALLENGE_WALLNUT_BOWLING, // 0 2 MID DAY
    GAMEMODE_CHALLENGE_SLOT_MACHINE, // 0 1
    GAMEMODE_CHALLENGE_RAINING_SEEDS, // 0 3
    GAMEMODE_CHALLENGE_BEGHOULED, // 1 0
    GAMEMODE_CHALLENGE_INVISIGHOUL, // 1 1
    GAMEMODE_CHALLENGE_SEEING_STARS, // 1 3
    GAMEMODE_CHALLENGE_ZOMBIQUARIUM, // 2 0
    GAMEMODE_CHALLENGE_BEGHOULED_TWIST, // 2 1
    GAMEMODE_CHALLENGE_LITTLE_TROUBLE, // 2 2 MID POOL
    GAMEMODE_CHALLENGE_PORTAL_COMBAT, // 2 3 ?
    GAMEMODE_CHALLENGE_COLUMN, // 5 2 MID MOON
    GAMEMODE_CHALLENGE_BOBSLED_BONANZA, // 3 0
    GAMEMODE_CHALLENGE_SPEED, // 3 1
    GAMEMODE_CHALLENGE_WHACK_A_ZOMBIE, // 1 2 MID NIGHT
    GAMEMODE_CHALLENGE_LAST_STAND, // 3 3
    GAMEMODE_CHALLENGE_WAR_AND_PEAS_2, // 4 0
    GAMEMODE_CHALLENGE_WALLNUT_BOWLING_2, // 4 1
    GAMEMODE_CHALLENGE_POGO_PARTY, // 4 3
    GAMEMODE_CHALLENGE_FINAL_BOSS, // 5 5 FINAL MOON

    GAMEMODE_CHALLENGE_ART_CHALLENGE_WALLNUT, // 5 0
    GAMEMODE_CHALLENGE_SUNNY_DAY, // 5 4 BONUS MOON
    GAMEMODE_CHALLENGE_RESODDED, // 0 4 BONUS DAY
    GAMEMODE_CHALLENGE_BIG_TIME, // 2 4 BONUS POOL
    GAMEMODE_CHALLENGE_ART_CHALLENGE_SUNFLOWER, // 5 1
    GAMEMODE_CHALLENGE_AIR_RAID, // 3 4 BONUS FOG
    GAMEMODE_CHALLENGE_ICE, // 5 3
    GAMEMODE_CHALLENGE_HIGH_GRAVITY, // 4 4 BONUS ROOF
    GAMEMODE_CHALLENGE_GRAVE_DANGER, // 1 4 BONUS NIGHT
    GAMEMODE_CHALLENGE_SHOVEL, // SCREW YOU
    GAMEMODE_CHALLENGE_STORMY_NIGHT, // 3 2 MID FOG
    GAMEMODE_CHALLENGE_BUNGEE_BLITZ, // 4 2 MID ROOF
    GAMEMODE_CHALLENGE_SQUIRREL, // YOU TOO
    ...
    GAMEMODE_INTRO,
    // New
    GAMEMODE_SURVIVAL_NORMAL_MOON,
    GAMEMODE_SURVIVAL_NORMAL_DAY_FALL,
    GAMEMODE_SURVIVAL_NORMAL_NIGHT_FALL,
    GAMEMODE_SURVIVAL_NORMAL_POOL_FALL,
    GAMEMODE_SURVIVAL_NORMAL_FOG_FALL,
    GAMEMODE_SURVIVAL_NORMAL_ROOF_FALL,
    GAMEMODE_SURVIVAL_NORMAL_MOON_FALL,
    GAMEMODE_SURVIVAL_NORMAL_DAY_WINTER,
    GAMEMODE_SURVIVAL_NORMAL_NIGHT_WINTER,
    GAMEMODE_SURVIVAL_NORMAL_POOL_WINTER,
    GAMEMODE_SURVIVAL_NORMAL_FOG_WINTER,
    GAMEMODE_SURVIVAL_NORMAL_ROOF_WINTER,
    GAMEMODE_SURVIVAL_NORMAL_MOON_WINTER,
    GAMEMODE_SURVIVAL_NORMAL_DAY_SPRING,
    GAMEMODE_SURVIVAL_NORMAL_NIGHT_SPRING,
    GAMEMODE_SURVIVAL_NORMAL_POOL_SPRING,
    GAMEMODE_SURVIVAL_NORMAL_FOG_SPRING,
    GAMEMODE_SURVIVAL_NORMAL_ROOF_SPRING,
    GAMEMODE_SURVIVAL_NORMAL_MOON_SPRING,
    GAMEMODE_SURVIVAL_HARD_MOON,
    GAMEMODE_SURVIVAL_HARD_DAY_FALL,
    GAMEMODE_SURVIVAL_HARD_NIGHT_FALL,
    GAMEMODE_SURVIVAL_HARD_POOL_FALL,
    GAMEMODE_SURVIVAL_HARD_FOG_FALL,
    GAMEMODE_SURVIVAL_HARD_ROOF_FALL,
    GAMEMODE_SURVIVAL_HARD_MOON_FALL,
    GAMEMODE_SURVIVAL_HARD_DAY_WINTER,
    GAMEMODE_SURVIVAL_HARD_NIGHT_WINTER,
    GAMEMODE_SURVIVAL_HARD_POOL_WINTER,
    GAMEMODE_SURVIVAL_HARD_FOG_WINTER,
    GAMEMODE_SURVIVAL_HARD_ROOF_WINTER,
    GAMEMODE_SURVIVAL_HARD_MOON_WINTER,
    GAMEMODE_SURVIVAL_HARD_DAY_SPRING,
    GAMEMODE_SURVIVAL_HARD_NIGHT_SPRING,
    GAMEMODE_SURVIVAL_HARD_POOL_SPRING,
    GAMEMODE_SURVIVAL_HARD_FOG_SPRING,
    GAMEMODE_SURVIVAL_HARD_ROOF_SPRING,
    GAMEMODE_SURVIVAL_HARD_MOON_SPRING,
    GAMEMODE_SURVIVAL_ENDLESS_MOON,
    GAMEMODE_SURVIVAL_ENDLESS_DAY_FALL,
    GAMEMODE_SURVIVAL_ENDLESS_NIGHT_FALL,
    GAMEMODE_SURVIVAL_ENDLESS_POOL_FALL,
    GAMEMODE_SURVIVAL_ENDLESS_FOG_FALL,
    GAMEMODE_SURVIVAL_ENDLESS_ROOF_FALL,
    GAMEMODE_SURVIVAL_ENDLESS_MOON_FALL,
    GAMEMODE_SURVIVAL_ENDLESS_DAY_WINTER,
    GAMEMODE_SURVIVAL_ENDLESS_NIGHT_WINTER,
    GAMEMODE_SURVIVAL_ENDLESS_POOL_WINTER,
    GAMEMODE_SURVIVAL_ENDLESS_FOG_WINTER,
    GAMEMODE_SURVIVAL_ENDLESS_ROOF_WINTER,
    GAMEMODE_SURVIVAL_ENDLESS_MOON_WINTER,
    GAMEMODE_SURVIVAL_ENDLESS_DAY_SPRING,
    GAMEMODE_SURVIVAL_ENDLESS_NIGHT_SPRING,
    GAMEMODE_SURVIVAL_ENDLESS_POOL_SPRING,
    GAMEMODE_SURVIVAL_ENDLESS_FOG_SPRING,
    GAMEMODE_SURVIVAL_ENDLESS_ROOF_SPRING,
    GAMEMODE_SURVIVAL_ENDLESS_MOON_SPRING,
    GAMEMODE_SURVIVAL_ENDLESS_ZOMBOTANY,
    GAMEMODE_SURVIVAL_ENDLESS_WALLNUT_BOWLING,
    GAMEMODE_CHALLENGE_MINIBOSS_DAY, // 0 5
    GAMEMODE_CHALLENGE_MINIBOSS_NIGHT, // 1 5
    GAMEMODE_CHALLENGE_MINIBOSS_POOL, // 2 5
    GAMEMODE_CHALLENGE_MINIBOSS_FOG, // 3 5
    GAMEMODE_CHALLENGE_MINIBOSS_ROOF, // 4 5
    GAMEMODE_CHALLENGE_ECLIPSE, // 6 0
    GAMEMODE_CHALLENGE_DEADPLANTS, // 6 1
    GAMEMODE_CHALLENGE_HEAVEN, // 6 2
    GAMEMODE_CHALLENGE_ZOMBOWLING, // 6 3
    GAMEMODE_CHALLENGE_CUBELAND, // 7 0
    GAMEMODE_CHALLENGE_SHALLNOTPASS, // 7 1
    GAMEMODE_CHALLENGE_LOOKUPPVZINFLATION, // 7 2
    GAMEMODE_CHALLENGE_POOL_PARTY, // 7 3
    // Test
    GAMEMODE_CHALLENGE_DAY,
    GAMEMODE_CHALLENGE_NIGHT,
    GAMEMODE_CHALLENGE_POOL,
    GAMEMODE_CHALLENGE_FOG,
    GAMEMODE_CHALLENGE_ROOF,
    GAMEMODE_CHALLENGE_MOON,
    GAMEMODE_CHALLENGE_STREAM,
    GAMEMODE_CHALLENGE_STREAM_NIGHT,
    GAMEMODE_CHALLENGE_FLOODED,
    GAMEMODE_CHALLENGE_DARKNESS,
    GAMEMODE_CHALLENGE_BORING,
    GAMEMODE_CHALLENGE_BORING2,
    GAMEMODE_CHALLENGE_WHAT,
    GAMEMODE_SURVIVAL_ENDLESS_CHAOS,
...
enum GameObjectType
{
    ...
    OBJECT_TYPE_FAST_FORWARD_BUTTON,
};
enum GameScenes
{
    SCENE_LOADING = 0,
...
enum NotRecommend
{
    ...
    NOT_RECOMMENDED_NEEDS_SOLID_GROUND,
    NOT_RECOMMENDED_NEEDS_COLD,
};
enum ParticleEffect
{
    PARTICLE_NONE = -1,
    ...
    // new
    PARTICLE_ZOMBIE_GARGANTUAR_HELMET,
    PARTICLE_ZOMBIE_POT,
    NUM_PARTICLES
};
enum PlantPriority
...
enum ProjectileType
{
    ...
    // New
    PROJECTILE_LETTUCE = 13, // Iceberg Lettuce (Cools)
    PROJECTILE_PLASMAPEA = 14,  // Plasma / Flame Pea (3x)
    PROJECTILE_PEPPER = 15, // Pepper (2x)
    PROJECTILE_MINT = 16, // Mint (Bounces)
    PROJECTILE_BEE = 17, // Bee (Um)
    PROJECTILE_ICEPEA = 18, // Ice Pea (Freezes)
    PROJECTILE_GOOPEA = 19, // Goo Pea (Poisons)
    PROJECTILE_BOMB = 20, // Bomb (BOOM!)
    PROJECTILE_FUTURESTAR = 21,   // Milk Star (Bounces off walls)
    PROJECTILE_SUN = 22, // Sun (Drops sun on impact)
    PROJECTILE_MOLD = 23,   // Mold Spore (Lobbed Spore)
    PROJECTILE_BIGPLASMAPEA = 24, // Big Plasma Pea (Implodes, dealing 240 on impact)
    PROJECTILE_ARROW = 25, // Oak Arrow (Nothin' Special)
    PROJECTILE_SPECIALARROW = 26, // Special Oak Arrow (Drops on every zombie on the lawn)
    PROJECTILE_ASPARAGUS = 27, // Special Oak Arrow (Drops on every zombie on the lawn)
    PROJECTILE_MCARROW = 28,
    PROJECTILE_FIREBALL = 29,
    PROJECTILE_PLASMABALL = 30,
    PROJECTILE_BOOMERANG = 31,
    PROJECTILE_ROCKPEA = 32,
    PROJECTILE_SEASTARFRUIT = 33,
    PROJECTILE_SPORE = 34,
    NUM_PROJECTILES = 35
};
enum ReanimationType
{
    ...
    REANIM_ICYFUMESHROOM,
    REANIM_POWERFLOWER,
    REANIM_ZOMBIE_GIGAFOOTBALL,
    REANIM_ZOMBIE_DISCO,
    REANIM_ZOMBIE_BACKUP_DISCO,
    REANIM_ZOMBIE_GIGAVAULTER,
    REANIM_SHADOWSUN,
    REANIM_SUPERCHOMPER,
    REANIM_BUSHES3,
    REANIM_BUSHES4,
...
enum SeedType
{
    ...
    SEED_WATERPOT = 41,
    SEED_COFFEEPOT = 42,
    SEED_ICEBERGLETTUCEBETA = 43,
    SEED_GATLINGPEA = 44,
    SEED_TWINSUNFLOWER = 45,
    SEED_GLOOMSHROOM = 46,
    SEED_CATTAIL = 47,
    SEED_WINTERMELON = 48,
    SEED_GOLD_MAGNET = 49,
    ...
    SEED_INFINUT,
    SEED_SPORESHROOM,
    SEED_PRIMALSUNFLOWER,
    SEED_PRIMALPEASHOOTER,
    SEED_GOLDBLOOM,
    SEED_GOOPEASHOOTER,
    SEED_SEASTARFRUIT,
    SEED_PICKLEDPEPPER,
...
enum ZombiePhase
{
    ...
    PHASE_FOOTBALL_PRE_TACKLE,
    PHASE_FOOTBALL_IN_TACKLE,
    PHASE_FOOTBALL_STUNNED,
    PHASE_FOOTBALL_POST_TACKLE,
};
enum ZombieType
{
    ZOMBIE_INVALID = -1,
    ...
    ZOMBIE_GIGAOUTHOUSE,
        // Zombotany
    ZOMBIE_SNOWPEA_HEAD,
    ZOMBIE_GIANTNUT_HEAD,
    ZOMBIE_PICKLED_HEAD,
    ZOMBIE_ICEQUEEN_HEAD,
    ZOMBIE_EXPLODENUT_HEAD,
    ZOMBIE_VINENUT_HEAD,
    NUM_ZOMBIE_TYPES,
...
enum ConfigCheckbox
{
    CONFIG_CHECKBOX_GIGA_MODE = 0,
    CONFIG_CHECKBOX_DEADPLANTS_MODE = 1,
    CONFIG_CHECKBOX_PLANT_SOUNDS = 2,
    CONFIG_CHECKBOX_KILL_SOUND = 3,
    CONFIG_CHECKBOX_COFFEE_BOOST = 4,
    CONFIG_CHECKBOX_INDEPENDANT_UPGRADES = 5,
    CONFIG_CHECKBOX_NEW_PLANTS = 6,
    CONFIG_CHECKBOX_NERF_DOOM = 7,
    CONFIG_CHECKBOX_SUN_AMOUNT = 8,
    CONFIG_CHECKBOX_COIN_AMOUNT = 9,
    CONFIG_CHECKBOX_SLOT_HOTKEYS = 10,
    CONFIG_CHECKBOX_HOLD_TO_COLLECT = 11,
    CONFIG_CHECKBOX_GIGA_ABILITIES = 12,
    CONFIG_CHECKBOX_CHILL_REBALANCE = 13,
    NUM_CONFIG_CHECKBOXES,
};
enum ConfigPage
{
    CONFIG_PAGE_ZOMBIES = 0,
    CONFIG_PAGE_PLANTS = 1,
    CONFIG_PAGE_CHALLENGE = 2,
    CONFIG_PAGE_TEMP = 3,
    MAX_CONFIG_PAGES = 4
};
