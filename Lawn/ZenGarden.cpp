...
{
    {  73 + ZEN_GRID_XOFFSET,  73 + ZEN_GRID_YOFFSET, 0, 0 },
    { 155 + ZEN_GRID_XOFFSET,  71 + ZEN_GRID_YOFFSET, 1, 0 },
    { 239 + ZEN_GRID_XOFFSET,  68 + ZEN_GRID_YOFFSET, 2, 0 },
    { 321 + ZEN_GRID_XOFFSET,  73 + ZEN_GRID_YOFFSET, 3, 0 },
    { 406 + ZEN_GRID_XOFFSET,  71 + ZEN_GRID_YOFFSET, 4, 0 },
    { 484 + ZEN_GRID_XOFFSET,  67 + ZEN_GRID_YOFFSET, 5, 0 },
    { 566 + ZEN_GRID_XOFFSET,  70 + ZEN_GRID_YOFFSET, 6, 0 },
    { 648 + ZEN_GRID_XOFFSET,  72 + ZEN_GRID_YOFFSET, 7, 0 },
    {  67 + ZEN_GRID_XOFFSET, 168 + ZEN_GRID_YOFFSET, 0, 1 },
    { 150 + ZEN_GRID_XOFFSET, 165 + ZEN_GRID_YOFFSET, 1, 1 },
    { 232 + ZEN_GRID_XOFFSET, 170 + ZEN_GRID_YOFFSET, 2, 1 },
    { 314 + ZEN_GRID_XOFFSET, 175 + ZEN_GRID_YOFFSET, 3, 1 },
    { 416 + ZEN_GRID_XOFFSET, 173 + ZEN_GRID_YOFFSET, 4, 1 },
    { 497 + ZEN_GRID_XOFFSET, 170 + ZEN_GRID_YOFFSET, 5, 1 },
    { 578 + ZEN_GRID_XOFFSET, 164 + ZEN_GRID_YOFFSET, 6, 1 },
    { 660 + ZEN_GRID_XOFFSET, 168 + ZEN_GRID_YOFFSET, 7, 1 },
    {  41 + ZEN_GRID_XOFFSET, 268 + ZEN_GRID_YOFFSET, 0, 2 },
    { 130 + ZEN_GRID_XOFFSET, 266 + ZEN_GRID_YOFFSET, 1, 2 },
    { 219 + ZEN_GRID_XOFFSET, 260 + ZEN_GRID_YOFFSET, 2, 2 },
    { 310 + ZEN_GRID_XOFFSET, 266 + ZEN_GRID_YOFFSET, 3, 2 },
    { 416 + ZEN_GRID_XOFFSET, 267 + ZEN_GRID_YOFFSET, 4, 2 },
    { 504 + ZEN_GRID_XOFFSET, 261 + ZEN_GRID_YOFFSET, 5, 2 },
    { 594 + ZEN_GRID_XOFFSET, 265 + ZEN_GRID_YOFFSET, 6, 2 },
    { 684 + ZEN_GRID_XOFFSET, 269 + ZEN_GRID_YOFFSET, 7, 2 },
    {  37 + ZEN_GRID_XOFFSET, 371 + ZEN_GRID_YOFFSET, 0, 3 },
    { 124 + ZEN_GRID_XOFFSET, 369 + ZEN_GRID_YOFFSET, 1, 3 },
    { 211 + ZEN_GRID_XOFFSET, 368 + ZEN_GRID_YOFFSET, 2, 3 },
    { 302 + ZEN_GRID_XOFFSET, 369 + ZEN_GRID_YOFFSET, 3, 3 },
    { 425 + ZEN_GRID_XOFFSET, 375 + ZEN_GRID_YOFFSET, 4, 3 },
    { 512 + ZEN_GRID_XOFFSET, 368 + ZEN_GRID_YOFFSET, 5, 3 },
    { 602 + ZEN_GRID_XOFFSET, 365 + ZEN_GRID_YOFFSET, 6, 3 },
    { 691 + ZEN_GRID_XOFFSET, 368 + ZEN_GRID_YOFFSET, 7, 3 }
};
...
float ZenGarden::PlantPottedDrawHeightOffset(SeedType theSeedType, float theScale)
{
    ...
    else if (theSeedType == SeedType::SEED_POTATOMINE || theSeedType == SeedType::SEED_POPCORN)
    {
        aScaleOffsetFix += 5.0f;
    }
...
{
    int aOffsetX = 0;
    if (thePottedPlant->mFacing == PottedPlant::FacingDirection::FACING_LEFT && (thePottedPlant->mSeedType == SeedType::SEED_POTATOMINE || thePottedPlant->mSeedType == SeedType::SEED_POPCORN))
    {
        aOffsetX -= 6;
    }
    return aOffsetX;
...
void ZenGarden::SetPlantAnimSpeed(Plant* thePlant)
{
    ...
    else if (thePlant->mSeedType == SeedType::SEED_POTATOMINE || thePlant->mSeedType == SeedType::SEED_POPCORN)
    {
        aTargetRate = 12.0f;
    }
    else
...
SeedType ZenGarden::PickRandomSeedType()
{
    ...
    for (int i = 0; i < 40; i++)
    {
        ...
        if (aSeedType != SeedType::SEED_MARIGOLD && aSeedType != SeedType::SEED_FLOWERPOT && aSeedType != SeedType::SEED_WATERPOT && aSeedType != SeedType::SEED_COFFEEPOT)
        {
