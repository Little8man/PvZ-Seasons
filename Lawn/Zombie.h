...
constexpr const float THROWN_ZOMBIE_GRAVITY = 0.05f;
...
constexpr const float RALLIED_SPEED_FACTOR = 1.5f;
// Spook Poison Constants
constexpr const int BASE_POISON_COUNTER = 2000;
constexpr const int BASE_POISON_TICKS = 120;
constexpr const int BASE_POISON_DAMAGE = 3;
constexpr const int MAX_POISON_STACK = 5;
const Color ZOMBIE_POISON_COLOR = Color(63, 0, 255, 255);
// Spook Vinenut Constants
constexpr const int BASE_VINENUT_DAMAGE = 20;
// Garg throwing
constexpr const float MIN_IMP_THROWING_DISTANCE = 256.0f;
...
public:
    ...
    bool                            mRallied;                                   // Whether there is a rally zombie present
    // Poison Values
    int                             mPoisonCounter[MAX_POISON_STACK];           // How long the zombie is poisoned
    int                             mPoisonRate;                                // Zombie poison damage timer
    int                             mPoisonDamage[MAX_POISON_STACK];            // Poison damage amount
    // Minecraft Values
    int                             mMinecraftDefensePoints;                    // Zombie poison damage timer
    int                             mMinecraftToughnessPoints;                  // Poison damage amount
    // Armor Values
    ArmorType                       mArmorType;
    int                             mArmorHealth;
    int                             mArmorMaxHealth;
    int                             mArmorJustGotShotCounter;
    int                             mArmorRecoilCounter;
...
public:
    ...
    static /*inline*/ bool			IsZombotany(int theZombieType);
    // Poison Functions
    ...
    bool                            IsFloating();
    // Easter Eggs
    /* Look away if you don't want easter egg spoilers. */
    void                            EnableDevMode(bool theEnableDevMode);
    // Armor
    int                             TakeArmorDamage(int theDamage, unsigned int theDamageFlags);
    int                             GetArmorDamageIndex();
    void                            AttachArmor();
    void                            DetachArmor();
    void                            DropArmor(unsigned int theDamageFlags);
    // Talisman
    void                            UpdateZombieTalisman();
    // Giga!
    void                            UpdateZombieGigaFootball();
    void                            UpdateZombieIceQueenHead();
    void                            UpdateZombieExplodenutHead();
    static ZombieType               ConvertZombieToGiga(ZombieType theZombieType, bool theIsGiga);
    Zombie*                         FindRallyZombie();
    // Conciseness
    int                             GetNumBackup(ZombieType theZombieType);
    // Health
    int                             Health();
    int                             MaxHealth();
        // Find Type
    static const bool               IsBasic(int aZombieType);
    static const bool               IsGiga(int aZombieType);
    static const bool               IsBasicCanDance(int aZombieType);
    static const bool               IsNormal(int aZombieType);
    static const bool               IsFlag(int aZombieType);
    static const bool               IsCone(int aZombieType);
    static const bool               IsPole(int aZombieType);
    static const bool               IsBucket(int aZombieType);
    static const bool               IsNewspaper(int aZombieType);
    static const bool               IsDoor(int aZombieType);
    static const bool               IsFootball(int aZombieType);
    static const bool               IsDancer(int aZombieType);
    static const bool               IsBackup(int aZombieType);
    static const bool               IsSnorkel(int aZombieType);
    static const bool               IsZomboni(int aZombieType);
    static const bool               IsBobsled(int aZombieType);
    static const bool               IsDolphinRider(int aZombieType);
    static const bool               IsJack(int aZombieType);
    static const bool               IsBalloon(int aZombieType);
    static const bool               IsDigger(int aZombieType);
    static const bool               IsPogo(int aZombieType);
    static const bool               IsYeti(int aZombieType);
    static const bool               IsBungee(int aZombieType);
    static const bool               IsLadder(int aZombieType);
    static const bool               IsCatapult(int aZombieType);
    static const bool               IsGargantuar(int aZombieType);
    static const bool               IsImp(int aZombieType);
    static const bool               IsCoffin(int aZombieType);
    static const bool               IsOuthouse(int aZombieType);
    static const bool               IsHelmet(int aZombieType);
    static const bool               IsTalisman(int aZombieType);
    static const bool               IsPeahead(int aZombieType);
    static const bool               IsWallnuthead(int aZombieType);
    static const bool               IsGatlinghead(int aZombieType);
    static const bool               IsTallnuthead(int aZombieType);
    static const bool               IsSquashhead(int aZombieType);
    static const bool               IsJalapenohead(int aZombieType);
    static const bool               CanSquish(int aZombieType);
    static const bool               IsMachine(int aZombieType);
    static const bool               NoEat(int aZombieType);
    static const bool               IsDancerOrBackup(int aZombieType);
    static const bool               IsWaterOnly(int aZombieType);
    static const bool               IsAngel(int aZombieType);
    // Minecraft
    void                            UpdateCreeper();
    void                            UpdateSkeleton();
    Plant*                          FindSkeletonTarget();
    void                            SkeletonFire(Plant* thePlant);
    static const bool               IsMinecraft(int aZombieType);
    static const bool               IsMinecraftZombie(int aZombieType);
    static const bool               IsMinecraftBaby(int aZombieType);
    static const bool               IsMinecraftSkeleton(int aZombieType);
    static const bool               IsMinecraftLeather(int aZombieType);
    static const bool               IsMinecraftIron(int aZombieType);
    // Chilly Pepper
    void                            BossDestroyFireballInRow(int theRow);
};
