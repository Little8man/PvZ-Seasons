...
public:
    ...
    //Pierce code
    ZombieID                mPierceZombieIDs[NUM_MAX_PIERCE];
    int                     mPierce;
    bool                    mPersistentPierce;
    // Boomerang
    float                   mTargetX;
    float                   mOriginX;
    int                     mTime;
...
public:
    ...
    void                    Die();
    void                    DoImpact(Zombie* theZombie, Plant* thePlant);
    void                    UpdateMotion();
    ...
    void                    ConvertToFirepea(int theGridX);
    ...
    void                    DoSplashWarm();
    // Retarget
    Zombie*                 FindRetargetZombie();
    // Pierce
    bool                    IsPierce();
    bool                    IsBounce();
    bool                    ZombieIsInList(Zombie* theZombie);
    // Zombotany
    bool                    IsSplashDamage(Plant* thePlant);
    unsigned int            GetDamageFlags(Plant* thePlant);
    void                    DoPlantSplashDamage(Plant* thePlant);
