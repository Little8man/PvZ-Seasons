...
ZombieDefinition gZombieDefs[NUM_ZOMBIE_TYPES] = {  //0x69DA80
    ...
    { ZOMBIE_IMP,               REANIM_IMP,                 1,      48,     1,      4000,   _S("IMP") },
    // Moon
    { ZOMBIE_COFFIN,            REANIM_ZOMBIE,              5,      53,     10,     3500,   _S("COFFIN_ZOMBIE") },
    { ZOMBIE_OUTHOUSE,          REANIM_ZOMBIE,              6,      56,     10,     2500,   _S("OUTHOUSE_ZOMBIE") },
    { ZOMBIE_HELMET_GARGANTUAR, REANIM_GARGANTUAR,          10,     58,     15,     750,    _S("HELMET_GARGANTUAR") },
    // Fall
    { ZOMBIE_GHOST,             REANIM_JACKINTHEBOX,        4,      38,     10,     1000,   _S("WRAITH_ZOMBIE") },
    { ZOMBIE_TALISMAN,          REANIM_ZOMBIE_NEWSPAPER,    7,      11,     10,     1000,   _S("TALISMAN_ZOMBIE") },
    // Spring
    { ZOMBIE_SEAHORSE_POGO,     REANIM_POGO,                4,      38,     10,     1000,   _S("SEAHORSE_POGO_ZOMBIE") },
    { ZOMBIE_BOSS,              REANIM_BOSS,                10,     60,     1,      0,      _S("BOSS") },
    { ZOMBIE_PEA_HEAD,          REANIM_ZOMBIE,              1,      99,     1,      4000,   _S("PEASHOOTER_ZOMBIE") },
    { ZOMBIE_WALLNUT_HEAD,      REANIM_ZOMBIE,              4,      99,     1,      3000,   _S("WALL_NUT_ZOMBIE") },
    { ZOMBIE_JALAPENO_HEAD,     REANIM_ZOMBIE,              3,      99,     10,     1000,   _S("JALAPENO_ZOMBIE") },
    { ZOMBIE_GATLING_HEAD,      REANIM_ZOMBIE,              3,      99,     10,     2000,   _S("GATLING_PEA_ZOMBIE") },
    { ZOMBIE_SQUASH_HEAD,       REANIM_ZOMBIE,              3,      99,     10,     2000,   _S("SQUASH_ZOMBIE") },
    { ZOMBIE_TALLNUT_HEAD,      REANIM_ZOMBIE,              4,      99,     10,     2000,   _S("TALL_NUT_ZOMBIE") },
    // Angel
    { ZOMBIE_ANGEL,             REANIM_ZOMBIE,              2,      99,     1,      4000,   _S("ANGEL_ZOMBIE") },
    { ZOMBIE_ANGEL_FLAG,        REANIM_ZOMBIE,              2,      99,     1,      0,      _S("FLAG_ANGEL_ZOMBIE") },
    { ZOMBIE_ANGEL_CONE,        REANIM_ZOMBIE,              4,      99,     1,      4000,   _S("CONEHEAD_ANGEL_ZOMBIE") },
    { ZOMBIE_ANGEL_BUCKET,      REANIM_ZOMBIE,              8,      99,     1,      3000,   _S("BUCKETHEAD_ANGEL_ZOMBIE") },
    { ZOMBIE_ANGEL_GARGANTUAR,  REANIM_GARGANTUAR,          10,     99,     15,     1500,   _S("ANGEL_GARGANTUAR") },
    { ZOMBIE_ANGEL_IMP,         REANIM_IMP,                 1,      99,     1,      4000,   _S("ANGEL_IMP") },
    // MINECRAFT
    { MC_ZOMBIE,                REANIM_ZOMBIE,              1,      99,     1,      4000,   _S("MINECRAFT_ZOMBIE") },
    { MC_ZOMBIE_LEATHER,        REANIM_ZOMBIE,              2,      99,     1,      4000,   _S("MINECRAFT_LEATHER_ZOMBIE") },
    { MC_ZOMBIE_IRON,           REANIM_ZOMBIE,              4,      99,     1,      4000,   _S("MINECRAFT_IRON_ZOMBIE") },
    { MC_BABYZOMBIE,            REANIM_ZOMBIE,              2,      99,     1,      4000,   _S("MINECRAFT_BABYZOMBIE") },
    { MC_BABYZOMBIE_LEATHER,    REANIM_ZOMBIE,              3,      99,     1,      4000,   _S("MINECRAFT_LEATHER_BABYZOMBIE") },
    { MC_BABYZOMBIE_IRON,       REANIM_ZOMBIE,              5,      99,     1,      4000,   _S("MINECRAFT_IRON_BABYZOMBIE") },
    { MC_SKELETON,              REANIM_ZOMBIE,              2,      99,     1,      4000,   _S("MINECRAFT_SKELETON") },
    { MC_SKELETON_LEATHER,      REANIM_ZOMBIE,              3,      99,     1,      4000,   _S("MINECRAFT_LEATHER_SKELETON") },
    { MC_SKELETON_IRON,         REANIM_ZOMBIE,              5,      99,     1,      4000,   _S("MINECRAFT_IRON_SKELETON") },
    { MC_SPIDER,                REANIM_ZOMBIE,              2,      99,     1,      4000,   _S("MINECRAFT_SPIDER") },
    { MC_CREEPER,               REANIM_ZOMBIE,              2,      99,     1,      4000,   _S("MINECRAFT_CREEPER") },
    // New Types
        // Giga
    { ZOMBIE_MUSTACHE,          REANIM_ZOMBIE,              2,      1,      1,      4000,   _S("MUSTACHE_ZOMBIE") }, // Double Health
    { ZOMBIE_RALLY,             REANIM_ZOMBIE,              2,      1,      1,      0,      _S("RALLY_ZOMBIE") }, // Buffs Nearby Zombies
    { ZOMBIE_GIGACONE,          REANIM_ZOMBIE,              4,      3,      1,      4000,   _S("POT_ZOMBIE") }, // Lobbed projectiles bounce off
    { ZOMBIE_GIGAVAULTER,       REANIM_ZOMBIE_GIGAVAULTER,  4,      6,      5,      2000,   _S("ATHLETE_ZOMBIE") }, // Keeps speed
    { ZOMBIE_GIGABUCKET,        REANIM_ZOMBIE,              8,      6,      1,      3000,   _S("BRICK_ZOMBIE") }, // Brickhead
    { ZOMBIE_SUNDAY,            REANIM_ZOMBIE_SUNDAY,       4,      11,     1,      1000,   _S("SUNDAY_ZOMBIE") }, // Even faster
    { ZOMBIE_GIGADOOR,          REANIM_ZOMBIE,              8,      13,     5,      3500,   _S("FRONT_DOOR_ZOMBIE") }, // Fumes can't pass
    { ZOMBIE_GIGAFOOTBALL,      REANIM_ZOMBIE_GIGAFOOTBALL, 10,     16,     5,      4000,   _S("BERSERKER_ZOMBIE") }, // Tackles First Plant
    { ZOMBIE_DISCO,             REANIM_ZOMBIE_DISCO,        10,     18,     5,      1000,   _S("DISCO_ZOMBIE") }, // Unsure
    { ZOMBIE_BACKUP_DISCO,      REANIM_ZOMBIE_BACKUP_DISCO, 2,      18,     1,      0,      _S("BACKUP_DISCO") }, // Unsure
    { ZOMBIE_GIGASNORKEL,       REANIM_SNORKEL,             6,      23,     10,     2000,   _S("GIGA_SNORKEL_ZOMBIE") }, // Unsure
    { ZOMBIE_GIGAZOMBONI,       REANIM_ZOMBIE_ZAMBONI,      14,     26,     10,     2000,   _S("GIGA_ZOMBONI") }, // Survives two pops
    { ZOMBIE_GIGABOBSLED,       REANIM_BOBSLED,             6,      26,     10,     2000,   _S("GIGA_ZOMBIE_BOBSLED_TEAM") }, // Unsure
    { ZOMBIE_ORCA_RIDER,        REANIM_ZOMBIE_DOLPHINRIDER, 6,      28,     10,     1500,   _S("ORCA_RIDER_ZOMBIE") }, // WATER POGO
    { ZOMBIE_GIGAJACK,          REANIM_JACKINTHEBOX,        6,      31,     10,     1000,   _S("GIGA_JACK_ZOMBIE") }, // Bigger Range
    { ZOMBIE_GIGABALLOON,       REANIM_BALLOON,             4,      33,     10,     2000,   _S("GIGA_BALLOON_ZOMBIE") }, // Takes Two Blovers
    { ZOMBIE_GIGADIGGER,        REANIM_DIGGER,              8,      36,     10,     1000,   _S("GIGA_DIGGER_ZOMBIE") }, // Forwards
    { ZOMBIE_GIGAPOGO,          REANIM_POGO,                8,      38,     10,     1000,   _S("POGO_ZOMBIE") }, // Unsure
    { ZOMBIE_BIGFOOT,           REANIM_YETI,                8,      40,     1,      1,      _S("ZOMBIE_BIGFOOT") }, // Drops Double Loot
    { ZOMBIE_GIGABUNGEE,        REANIM_BUNGEE,              6,      41,     10,     1000,   _S("GIGA_BUNGEE_ZOMBIE") }, // Unsure
    { ZOMBIE_GIGALADDER,        REANIM_LADDER,              8,      43,     10,     1000,   _S("GIGA_LADDER_ZOMBIE") }, // Keeps Speed?
    { ZOMBIE_GIGACATAPULT,      REANIM_CATAPULT,            10,     46,     10,     1500,   _S("GIGA_CATAPULT_ZOMBIE") }, // Double Damage?
    { ZOMBIE_GIGAGARGANTUAR,    REANIM_GIGA_GARGANTUAR,     10,     48,     15,     6000,   _S("REDEYED_GARGANTUAR") },
    { ZOMBIE_GIGAIMP,           REANIM_IMP,                 2,      48,     1,      4000,   _S("GIGA_IMP") }, // Explodes?
    { ZOMBIE_GIGACOFFIN,        REANIM_ZOMBIE,              5,      13,     5,      1750,   _S("GIGA_COFFIN_ZOMBIE") },
    { ZOMBIE_GIGAOUTHOUSE,      REANIM_ZOMBIE,              6,      13,     5,      1250,   _S("GIGA_OUTHOUSE_ZOMBIE") },
        // Zombotanies
    { ZOMBIE_SNOWPEA_HEAD,      REANIM_ZOMBIE,              2,      99,     1,      4000,   _S("SNOWPEA_ZOMBOTANY") },
    { ZOMBIE_GIANTNUT_HEAD,     REANIM_ZOMBIE,              8,      99,     1,      3000,   _S("GIANT_WALL_NUT_ZOMBOTANY") },
    { ZOMBIE_PICKLED_HEAD,      REANIM_ZOMBIE,              6,      99,     10,     1000,   _S("PICKLED_PEPPER_ZOMBOTANY") },
    { ZOMBIE_ICEQUEEN_HEAD,     REANIM_ZOMBIE,              6,      99,     10,     2000,   _S("ICE_QUEEN_PEA_ZOMBOTANY") },
    { ZOMBIE_EXPLODENUT_HEAD,   REANIM_ZOMBIE,              6,      99,     10,     2000,   _S("EXPLODE_O_NUT_ZOMBOTANY") },
    { ZOMBIE_VINENUT_HEAD,      REANIM_ZOMBIE,              8,      99,     10,     2000,   _S("VINE_NUT_ZOMBOTANY") },
};
...
static ZombieType gBossZombieList[] = {  //0x69DE1C
    ...
    ZombieType::ZOMBIE_COFFIN,
    ZombieType::ZOMBIE_OUTHOUSE,
    ZombieType::ZOMBIE_GARGANTUAR,
    ZombieType::ZOMBIE_HELMET_GARGANTUAR,
};
...
void Zombie::ZombieInitialize(int theRow, ZombieType theType, bool theVariant, Zombie* theParentZombie, int theFromWave)
{
    ...
    mRallied = false;
    // Poison Initialize
    for (int i = 0; i < MAX_POISON_STACK; i++)
    {
        mPoisonCounter[i] = 0;
        mPoisonDamage[i] = BASE_POISON_DAMAGE;
    }
    mPoisonRate = BASE_POISON_TICKS;
    // Minecraft
    mMinecraftDefensePoints = 0;
    mMinecraftToughnessPoints = 0;
    // Armor
    mArmorType = ArmorType::ARMORTYPE_NONE;
    mArmorMaxHealth = 0;
    mArmorJustGotShotCounter = 0;
    mArmorRecoilCounter = 0;
    ...
    bool aUseGigaReanim = (IsGiga(mZombieType) && mApp->GetConfigCheckbox(true, CONFIG_CHECKBOX_GIGA_ABILITIES));

    if (IsBasic(mZombieType))
    {
        LoadPlainZombieReanim();
        if (IsFlag(mZombieType))
        {
            mHasObject = true;
        ...
        if (IsCone(mZombieType))
        {
            ReanimShowPrefix("anim_hair", RENDER_GROUP_HIDDEN);
            ReanimShowPrefix("anim_cone", RENDER_GROUP_NORMAL);
            if (aUseGigaReanim)
            {
                mHelmType = HelmType::HELMTYPE_POT;
                Reanimation* aBodyReanim = mApp->ReanimationGet(mBodyReanimID);
                aBodyReanim->SetImageOverride("anim_cone", IMAGE_REANIM_ZOMBIE_POT1);
            }
            else
            {
        ...
        if (IsDoor(mZombieType))
        {
            mShieldType = ShieldType::SHIELDTYPE_DOOR;
            mShieldHealth = 1100;
            AttachShield();
        }
        if (IsCoffin(mZombieType))
        {
            mArmorType = ArmorType::ARMORTYPE_COFFIN;
            mArmorHealth = 370;
            AttachArmor();
        }
        else if (IsOuthouse(mZombieType))
        {
            mArmorType = ArmorType::ARMORTYPE_OUTHOUSE;
            mArmorHealth = 1100;
            AttachArmor();
        }
        if (IsPeahead(mZombieType))
        {
            ReanimShowPrefix("anim_hair", RENDER_GROUP_HIDDEN);
            ...
            Reanimation* aHeadReanim = mApp->AddReanimation(0.0f, 0.0f, 0, aUseGigaReanim ? ReanimationType::REANIM_SNOWPEA : ReanimationType::REANIM_PEASHOOTER);
        ...
        else if (IsWallnuthead(mZombieType))
        {
            ReanimShowPrefix("anim_hair", RENDER_GROUP_HIDDEN);
            ...
            mHelmHealth = 1100;
            mVariant = false;
            if (aUseGigaReanim) mScaleZombie = 2.0f;
        }
        else if (IsTallnuthead(mZombieType))
        {
            ReanimShowPrefix("anim_hair", RENDER_GROUP_HIDDEN);
            ReanimShowPrefix("anim_head", RENDER_GROUP_HIDDEN);
            ReanimShowPrefix("Zombie_tie", RENDER_GROUP_HIDDEN);
        ...
        else if (IsJalapenohead(mZombieType))
        {
            ReanimShowPrefix("anim_hair", RENDER_GROUP_HIDDEN);
            ReanimShowPrefix("anim_head", RENDER_GROUP_HIDDEN);
            ReanimShowPrefix("Zombie_tie", RENDER_GROUP_HIDDEN);
            ...
            Reanimation* aBodyReanim = mApp->ReanimationGet(mBodyReanimID);
            ReanimatorTrackInstance* aTrackInstance = aBodyReanim->GetTrackInstanceByName("Zombie_body");
            Reanimation* aHeadReanim = mApp->AddReanimation(0.0f, 0.0f, 0, aUseGigaReanim ? ReanimationType::REANIM_PICKLEDPEPPER : ReanimationType::REANIM_JALAPENO);
            aHeadReanim->PlayReanim("anim_idle", ReanimLoopType::REANIM_LOOP, 0, 15.0f);
            mSpecialHeadReanimID = mApp->ReanimationGetID(aHeadReanim);
            AttachEffect* aAttachEffect = AttachReanim(aTrackInstance->mAttachmentID, aHeadReanim, 0.0f, 0.0f);
            aBodyReanim->mFrameBasePose = 0;
        ...
        else if (IsGatlinghead(mZombieType))
        {
            ReanimShowPrefix("anim_hair", RENDER_GROUP_HIDDEN);
            ReanimShowPrefix("anim_head2", RENDER_GROUP_HIDDEN);
            ...
            ReanimatorTrackInstance* aTrackInstance = aBodyReanim->GetTrackInstanceByName("anim_head1");
            aTrackInstance->mImageOverride = IMAGE_BLANK;
            Reanimation* aHeadReanim = mApp->AddReanimation(0.0f, 0.0f, 0, aUseGigaReanim ? ReanimationType::REANIM_SNOWPEA : ReanimationType::REANIM_GATLINGPEA);
            aHeadReanim->PlayReanim("anim_head_idle", ReanimLoopType::REANIM_LOOP, 0, 15.0f);
            mSpecialHeadReanimID = mApp->ReanimationGetID(aHeadReanim);
            AttachEffect* aAttachEffect = AttachReanim(aTrackInstance->mAttachmentID, aHeadReanim, 0.0f, 0.0f);
            aBodyReanim->mFrameBasePose = 0;
        ...
        else if (IsSquashhead(mZombieType))
        {
            ReanimShowPrefix("anim_hair", RENDER_GROUP_HIDDEN);
            ReanimShowPrefix("anim_head2", RENDER_GROUP_HIDDEN);
            ...
            ReanimatorTrackInstance* aTrackInstance = aBodyReanim->GetTrackInstanceByName("anim_head1");
            aTrackInstance->mImageOverride = IMAGE_BLANK;
            Reanimation* aHeadReanim = mApp->AddReanimation(0.0f, 0.0f, 0, aUseGigaReanim ? ReanimationType::REANIM_EXPLODEONUT : ReanimationType::REANIM_SQUASH);
            aHeadReanim->PlayReanim("anim_idle", ReanimLoopType::REANIM_LOOP, 0, 15.0f);
            mSpecialHeadReanimID = mApp->ReanimationGetID(aHeadReanim);
            AttachEffect* aAttachEffect = AttachReanim(aTrackInstance->mAttachmentID, aHeadReanim, 0.0f, 0.0f);
            aBodyReanim->mFrameBasePose = 0;
            aUseGigaReanim ? TodScaleRotateTransformMatrix(aAttachEffect->mOffset, 50.0f, 0.0f, 0.2f, -0.8f, 0.8f) :
    ...
    else if (IsFootball(mZombieType))
    {
        ...
        mVariant = false;
        if (IsGiga(mZombieType) && mBoard && mApp->GetConfigCheckbox(true, CONFIG_CHECKBOX_GIGA_ABILITIES)) mZombiePhase = ZombiePhase::PHASE_FOOTBALL_PRE_TACKLE;
    }
    else if (IsDigger(mZombieType))
    {
    ...
    else if (IsDolphinRider(mZombieType))
    {
        mBodyHealth = 500;
        mAnimTicksPerFrame = 6;
    ...
    else if (IsGargantuar(mZombieType))
    {
        mWidth = 180;
        mHeight = 180;
        mBodyHealth = 3000;
        ...
        if (IsHelmet(mZombieType))
        {
            ReanimShowPrefix("anim_helmet", RENDER_GROUP_NORMAL);
            mHelmType = HelmType::HELMTYPE_HELMET;
            mHelmHealth = 3000;
        }
        else
        {
        ...
        int aPoleVariant;
        if (!IsOnBoard() || mBoard->mLevel == ROOF_LEVEL_INDEX + 8)
        {
            aPoleVariant = 0;
        }
        else
    ...
    else if (IsCatapult(mZombieType))
    {
        mBodyHealth = 850;
    ...
    else if (IsNewspaper(mZombieType))
    {
        mZombieAttackRect = Rect(20, 0, 50, 115);
    ...
    else if (IsTalisman(mZombieType))
    {
        mBodyHealth = 1400;
        mVariant = false;
    }
    else if (IsMinecraft(mZombieType))
    {
        Reanimation* aBodyReanim = mApp->ReanimationGet(mBodyReanimID);
        LoadPlainZombieReanim();
        mBodyHealth = 400;
        if (IsMinecraftZombie(mZombieType))
        {
            aBodyReanim->SetImageOverride("anim_head1", IMAGE_REANIM_MCZOMBIE_HEAD);
            mMinecraftDefensePoints += 2;
        }
        if (IsMinecraftBaby(mZombieType))
        {
            mScaleZombie = 0.5f;
        }
        if (IsMinecraftSkeleton(mZombieType))
        {
            aBodyReanim->SetImageOverride("anim_head1", IMAGE_REANIM_MCSKELETON_HEAD);
            mSummonCounter = 20;
        }
        if (mZombieType == MC_SPIDER)
        {
            aBodyReanim->SetImageOverride("anim_head1", IMAGE_REANIM_MCSPIDER_HEAD);
            mBodyHealth = 320;
        }
        if (mZombieType == MC_CREEPER)
        {
            aBodyReanim->SetImageOverride("anim_head1", IMAGE_REANIM_MCCREEPER_HEAD);
        }
            
        if (IsMinecraftLeather(mZombieType))
        {
            mMinecraftDefensePoints += 7;
        }
        if (IsMinecraftIron(mZombieType))
        {
            mMinecraftDefensePoints += 15;
        }
        if (false) // Chainmail
        {
            mMinecraftDefensePoints += 12;
        }
        if (false) // Diamond
        {
            mMinecraftDefensePoints += 20;
            mMinecraftToughnessPoints = 8;
        }
    }
    else if (mZombieType == ZombieType::ZOMBIE_BOSS)
    {
        mPosX = 0.0f;
        mPosY = 0.0f;
        mZombieRect = Rect(660 + LAWN_XMIN, LAWN_YMIN, 90, 430);
        mZombieAttackRect = Rect(0, 0, 0, 0);
    ...
    if (IsGiga(mZombieType)) {
        ...
        if (IsBasic(mZombieType)) {
            Reanimation* aBodyReanim = mApp->ReanimationGet(mBodyReanimID);
            aBodyReanim->SetImageOverride("Zombie_body", IMAGE_REANIM_ZOMBIE_GIGA_BODY);
            aBodyReanim->SetImageOverride("anim_innerarm2", IMAGE_REANIM_ZOMBIE_GIGA_INNERARM_LOWER);
            aBodyReanim->SetImageOverride("Zombie_innerarm_screendoor", IMAGE_REANIM_ZOMBIE_GIGA_INNERARM_SCREENDOOR);
            aBodyReanim->SetImageOverride("anim_innerarm1", IMAGE_REANIM_ZOMBIE_GIGA_INNERARM_UPPER);
            aBodyReanim->SetImageOverride("Zombie_outerarm_lower", IMAGE_REANIM_ZOMBIE_GIGA_OUTERARM_LOWER);
            aBodyReanim->SetImageOverride("Zombie_outerarm_screendoor", IMAGE_REANIM_ZOMBIE_GIGA_OUTERARM_SCREENDOOR);
            aBodyReanim->SetImageOverride("Zombie_outerarm_upper", IMAGE_REANIM_ZOMBIE_GIGA_OUTERARM_UPPER);
            aBodyReanim->SetImageOverride("Zombie_tie", IMAGE_REANIM_ZOMBIE_GIGA_TIE);
            if (!IsZombotany(mZombieType))
                aBodyReanim->SetImageOverride("anim_head1", IMAGE_REANIM_ZOMBIE_HEAD_GIGA);
        }
    }

    if (IsAngel(mZombieType))
        mAltitude = 25.0f;

    if (IsBasic(mZombieType) && !IsZombotany(mZombieType) && mApp->IsDeadplantsLevel() && (IsOnBoard() || theFromWave == Zombie::ZOMBIE_WAVE_CUTSCENE)) {
        Reanimation* aBodyReanim = mApp->ReanimationGet(mBodyReanimID);
        IsGiga(mZombieType) ? aBodyReanim->SetImageOverride("anim_head1", IMAGE_REANIM_CORPSE_HEAD_GIGA) : aBodyReanim->SetImageOverride("anim_head1", IMAGE_REANIM_CORPSE_HEAD);
        aBodyReanim->SetImageOverride("anim_head2", IMAGE_REANIM_CORPSE_JAW);
    }
...
void Zombie::SetupReanimLayers(Reanimation* aReanim, ZombieType theZombieType)
{
    ...
    else if (IsHelmet(theZombieType))
    {
        aReanim->AssignRenderGroupToPrefix("anim_helmet", RENDER_GROUP_NORMAL);
    }
}
...
void Zombie::LoadPlainZombieReanim()
{
    ...
    if ((mBoard && (mBoard->mPlantRow[mRow] == PlantRowType::PLANTROW_POOL || mBoard->mPlantRow[mRow] == PlantRowType::PLANTROW_STREAM)) || mZombieType == ZombieType::ZOMBIE_DUCKY_TUBE)
    {
...
int Zombie::CountBungeesTargetingSunFlowers()
{
    ...
    {
        if (!aZombie->IsDeadOrDying() && IsBungee(aZombie->mZombieType) && aZombie->mTargetCol != -1)
        {
            Plant* aPlant = mBoard->GetTopPlantAt(aZombie->mTargetCol, aZombie->mRow, PlantPriority::TOPPLANT_BUNGEE_ORDER);
            if (aPlant && Plant::MakesSun(aPlant->mSeedType))
            {
                aCount++;
            }
        }
    ...
    for (int x = 0; x < MAX_GRID_SIZE_X; x++)
    {
        if (theColumn == -1 || theColumn == x)  // 限制仅能在 theColumn 列寻找目标，除非 theColumn 为 -1
        {
            for (int y = 0; y < MAX_GRID_SIZE_Y; y++)
            {
                ...
                if (aPlant)
                {
                    if (!aAllowSunFlowerTarget && Plant::MakesSun(aPlant->mSeedType))
                    {
                        continue;
                    }
...
void Zombie::PickRandomSpeed()
{
    ...
    else if (IsImp(mZombieType)) // && mApp->IsIZombieLevel())
        mVelX = 0.9f;
    else if (mZombiePhase == ZombiePhase::PHASE_YETI_RUNNING)
        mVelX = 0.8f;
    else if (IsYeti(mZombieType))
        mVelX = 0.4f;
    else if (IsPogo(mZombieType) && mHasObject && ZombieTypeCanGoInPool(mZombieType))
        mInPool ? mVelX = 0.675f : mVelX = 0.3f;
    else if (IsDancerOrBackup(mZombieType) || (IsPogo(mZombieType) && mHasObject) || IsFlag(mZombieType))
        mVelX = 0.45f;
    /*else if (mZombiePhase == ZombiePhase::PHASE_LADDER_CARRYING || mZombieType == ZombieType::ZOMBIE_SQUASH_HEAD || mZombiePhase == ZombiePhase::PHASE_FOOTBALL_PRE_TACKLE)
        mVelX = RandRangeFloat(0.79f, 0.81f);
    else if (mZombiePhase == ZombiePhase::PHASE_DIGGER_TUNNELING || mZombiePhase == ZombiePhase::PHASE_POLEVAULTER_PRE_VAULT || (IsPole(mZombieType) && IsGiga(mZombieType)) ||
        IsFootball(mZombieType) || IsSnorkel(mZombieType) || IsJack(mZombieType))
        mVelX = RandRangeFloat(0.66f, 0.68f);
    else if (mZombiePhase == ZombiePhase::PHASE_NEWSPAPER_MAD && IsGiga(mZombieType))
        mVelX = RandRangeFloat(1.335f, 1.365f);
    ...
    {
        mVelX = 0.32f; // Originally 0.275
        if (mZombieType == MC_CREEPER || IsMinecraftSkeleton(mZombieType)) mVelX /= 0.92;
        if (mZombieType == MC_SPIDER) mVelX /= 0.77;
        if (IsMinecraftBaby(mZombieType)) mVelX *= 2;
    }
    else
    {
        ...
        if (mZombiePhase == ZombiePhase::PHASE_LADDER_CARRYING || IsSquashhead(mZombieType) || mZombiePhase == ZombiePhase::PHASE_FOOTBALL_PRE_TACKLE)
            mVelX *= 2.91;
        else if (mZombiePhase == ZombiePhase::PHASE_DIGGER_TUNNELING || mZombiePhase == ZombiePhase::PHASE_POLEVAULTER_PRE_VAULT || (IsPole(mZombieType) && IsGiga(mZombieType)) ||
            IsFootball(mZombieType) || IsJack(mZombieType) || mZombiePhase == ZombiePhase::PHASE_SNORKEL_WALKING)
            mVelX *= 2.44;
        else if (mZombiePhase == ZombiePhase::PHASE_NEWSPAPER_MAD || mZombiePhase == ZombiePhase::PHASE_DOLPHIN_WALKING ||
            mZombiePhase == ZombiePhase::PHASE_DOLPHIN_WALKING_WITHOUT_DOLPHIN)
            mVelX *= 3.27;
        ...
        if ((mZombiePhase == ZombiePhase::PHASE_NEWSPAPER_MAD && IsGiga(mZombieType)) || IsAngel(mZombieType))
            mVelX *= 1.5;
    }
...
void Zombie::BungeeLiftTarget()
{
    ...
    while (mBoard->IterateZombies(aZombie))
    {
        if (IsBungee(aZombie->mZombieType) && aZombie != this && aZombie->mTargetPlantID == mTargetPlantID)
        {
...
void Zombie::BungeeLanding()
{
    ...
    {
        if (Rand(1000) == 1) mApp->PlayFoley(FoleyType::FOLEY_BUNGEE_MEME);
        else mApp->PlayFoley(FoleyType::FOLEY_BUNGEE_SCREAM);
...
void Zombie::SkeletonFire(Plant* thePlant)
{
    float aOriginX = mPosX + 113.0f;
    float aOriginY = mPosY - 44.0f;
    int aTargetX, aTargetY;
    ...
    Projectile* aProjectile = mBoard->AddProjectile(aOriginX, aOriginY, mRenderOrder, mRow, ProjectileType::PROJECTILE_MCARROW);
    float aRangeX = aOriginX - aTargetX - 20.0f;
    float aRangeY = aTargetY - aOriginY;
    if (aRangeX < 40.0f)
    {
...
Plant* Zombie::FindSkeletonTarget()
{
    Plant* aTarget = nullptr;
...
void Zombie::UpdateZombieCatapult()
{
    ...
    {
        if (mPosX <= 610 + LAWN_XMIN && FindCatapultTarget() && mSummonCounter > 0)
        {
...
void Zombie::LandFlyer(unsigned int theDamageFlags)
{
    ...
    if (mBoard->mPlantRow[mRow] == PlantRowType::PLANTROW_POOL || mBoard->mPlantRow[mRow] == PlantRowType::PLANTROW_STREAM)
    {
        DieWithLoot();
    }
    else
...
void Zombie::UpdateZombiePolevaulter()
{
    if (mZombiePhase == ZombiePhase::PHASE_POLEVAULTER_PRE_VAULT && mHasHead && mZombieHeight == ZombieHeight::HEIGHT_ZOMBIE_NORMAL)
    {
        ...
        if (aPlant)
        {
            ...
            if ((mApp->IsWallnutBowlingLevel() && Plant::IsWallNut(aPlant->mSeedType)) || aPlant->mSeedType == SeedType::SEED_BOWLNUT)
            {
                aJumpDistance = 0;
            }
...
void Zombie::UpdateZombieDolphinRider()
{
    ...
    {
        if (mX > LAWN_XMIN + 660 && mX <= LAWN_XMIN + 680)
        {
...
void Zombie::UpdateZombieSnorkel()
{
    ...
    {
        if (mX > 660 + LAWN_XMIN && mX <= 680 + LAWN_XMIN)
        {
            mVelX = 0.2f;
...
void Zombie::UpdateZombieJackInTheBox()
{
    ...
    else if (mZombiePhase == ZombiePhase::PHASE_JACK_IN_THE_BOX_POPPING)
    {
        ...
        if (mPhaseCounter <= 0)
        {
            ...
            int aDamage = IsGiga(mZombieType) && mApp->GetConfigCheckbox(true, CONFIG_CHECKBOX_GIGA_ABILITIES) ? 900 : 1800;
            if (mMindControlled)
            {
                if (IsGiga(mZombieType) && mApp->GetConfigCheckbox(true, CONFIG_CHECKBOX_GIGA_ABILITIES))
                    mBoard->KillAllZombiesInRadius(mRow, aPosX, aPosY, JackInTheBoxZombieRadius * 2, 3, true, 900, 127, 274U);
                mBoard->KillAllZombiesInRadius(mRow, aPosX, aPosY, JackInTheBoxZombieRadius, 1, true, aDamage, 127, 274U);
            }
            else
            {
                if (IsGiga(mZombieType) && mApp->GetConfigCheckbox(true, CONFIG_CHECKBOX_GIGA_ABILITIES))
                {
                    mBoard->KillAllZombiesInRadius(mRow, aPosX, aPosY, JackInTheBoxZombieRadius * 2, 3, true, 900, 255, 274U);
                    mBoard->KillAllPlantsInRadius(aPosX, aPosY, JackInTheBoxPlantRadius * 2, 900);
                }
                mBoard->KillAllZombiesInRadius(mRow, aPosX, aPosY, JackInTheBoxZombieRadius, 1, true, aDamage, 255, 274U);
                mBoard->KillAllPlantsInRadius(aPosX, aPosY, JackInTheBoxPlantRadius, aDamage);
            }
...
void Zombie::UpdateZombieGargantuar()
{
    ...
    float aThrowingDistance = mPosX - 320.0f - LAWN_XMIN;
    if (mZombiePhase == ZombiePhase::PHASE_GARGANTUAR_THROWING)
    {
        ...
        if (aBodyReanim->ShouldTriggerTimedEvent(0.74f))
        {
            ...
            Zombie* aZombieImp = mBoard->AddZombie(ConvertZombieToGiga(IsAngel(mZombieType) ? ZombieType::ZOMBIE_ANGEL_IMP : ZombieType::ZOMBIE_IMP, IsGiga(mZombieType)), mFromWave);
            if (aZombieImp == nullptr)
                return;
            
            float aMinThrowDistance = MIN_IMP_THROWING_DISTANCE;
            if (mBoard->StageHasRoof())
            {
                aThrowingDistance -= 180.0f;
                aMinThrowDistance = MIN_IMP_THROWING_DISTANCE - 180.0f;
            }
            ...
            aZombieImp->mVelZ = 0.5f * (aThrowingDistance / aZombieImp->mVelX) * THROWN_ZOMBIE_GRAVITY;
    ...
    if (mHasObject && mBodyHealth < mBodyMaxHealth / 2 && aThrowingDistance > MIN_IMP_THROWING_DISTANCE)
    {
...
void Zombie::UpdateZombieTalisman()
{
    if (mZombiePhase == ZombiePhase::PHASE_NEWSPAPER_MADDENING)
    {
        Reanimation* aBodyReanim = mApp->ReanimationGet(mBodyReanimID);
    ...
    if (mZombiePhase == ZombiePhase::PHASE_ZOMBIE_NORMAL && mBodyHealth < mBodyMaxHealth / 2)
    {
        mZombiePhase = ZombiePhase::PHASE_NEWSPAPER_MADDENING;
        int aPickCount = 0;
        Plant* aPlants[MAX_GRID_SIZE_X];
        Plant* aPlant = nullptr;
        while (mBoard->IteratePlants(aPlant))
        {
            if (aPlant->mRow == mRow && !aPlant->IsInsomniac() && !aPlant->mIsAsleep)
            {
                aPlants[aPickCount] = aPlant;
                aPickCount++;
            }
        }
        aPlants[Rand(aPickCount)]->SetSleeping(true);
    }
}
...
void Zombie::UpdateZombiePeaHead()
{
    ...
    else if (mPhaseCounter == 0)
    {
        ...
        if (mMindControlled)  // 魅惑修复
        {
            ...
            Projectile* aProjectile = mBoard->AddProjectile(aOriginX, aOriginY, mRenderOrder, mRow, IsGiga(mZombieType) && mApp->GetConfigCheckbox(true, CONFIG_CHECKBOX_GIGA_ABILITIES) ? ProjectileType::PROJECTILE_SNOWPEA : ProjectileType::PROJECTILE_PEA);
...
void Zombie::UpdateZombieJalapenoHead()
{
    ...
    if (mPhaseCounter == 0)
    {
        ...
        if (mMindControlled)
        {
            IsGiga(mZombieType) ? mBoard->KillZombieColFromPixel(mPosX + (GetZombieRect().mWidth / 2), mPosY, true, 1800, 127, 274U) : mBoard->KillZombieRow(mRow, true, 1800, 127, 274U);
        }
        else
        {
            IsGiga(mZombieType) ? mBoard->KillPlantColFromPixel(mPosX, mPosY, 1800) : mBoard->KillPlantRow(mRow, 1800);
        }
        DieNoLoot();
    }
}
...
void Zombie::UpdateZombieIceQueenHead()
{
    if (!mHasHead)
        return;
    ...
    else if (mPhaseCounter == 18 || mPhaseCounter == 35)
    {
        mApp->PlayFoley(FoleyType::FOLEY_THROW);
        ...
        {
            aOriginX += 90.0f * mScaleZombie;
            Projectile* aProjectile = mBoard->AddProjectile(aOriginX, aOriginY, mRenderOrder, mRow, ProjectileType::PROJECTILE_ICEPEA);
            aProjectile->mDamageRangeFlags = 1;
        }
        else
        {
            ...
            if (mMindControlled)  // 魅惑修复
            {
                ...
                while (mBoard->IterateZombies(aZombie))
                {
                    if ((aZombie->mRow == mRow || aZombie->mZombieType == ZombieType::ZOMBIE_BOSS) && aZombie->EffectedByDamage(13U))
                    {
                        ...
                        if (GetRectOverlap(aAttackRect, aZombieRect) > (IsFootball(aZombie->mZombieType) ? -20 : 0))
                        {
...
void Zombie::UpdateZombieExplodenutHead()
{
    ...
    else if (mZombiePhase == ZombiePhase::PHASE_JACK_IN_THE_BOX_POPPING)
    {
        ...
        if (mPhaseCounter <= 0)
        {
            ...
            if (mMindControlled)
            {
                mBoard->KillAllZombiesInRadius(mRow, aPosX, aPosY, JackInTheBoxZombieRadius, 1, true, 1800, 127, 274U);
            }
            else
            {
                mBoard->KillAllZombiesInRadius(mRow, aPosX, aPosY, JackInTheBoxZombieRadius, 1, true, 1800, 255, 274U);
                mBoard->KillAllPlantsInRadius(aPosX, aPosY, JackInTheBoxPlantRadius, 1800);
            }
...
void Zombie::UpdateCreeper()
{

    if (mIsEating && PHASE_ZOMBIE_NORMAL)
    {
        mPhaseCounter = 110;
        mZombiePhase = ZombiePhase::PHASE_JACK_IN_THE_BOX_POPPING;
...
void Zombie::UpdateSkeleton()
{
    if (mZombiePhase == ZombiePhase::PHASE_ZOMBIE_NORMAL)
    {
        if (mPosX <= 610 + LAWN_XMIN && FindSkeletonTarget() && mSummonCounter > 0)
        {
            mZombiePhase = ZombiePhase::PHASE_CATAPULT_LAUNCHING;
            mPhaseCounter = 300;
            PlayZombieReanim("anim_shoot", ReanimLoopType::REANIM_PLAY_ONCE_AND_HOLD, 0, 24.0f);
    ...
    else if (mZombiePhase == ZombiePhase::PHASE_CATAPULT_LAUNCHING)
    {
        ...
        if (aBodyReanim->ShouldTriggerTimedEvent(0.545f))
        {
            Plant* aPlant = FindSkeletonTarget();
            SkeletonFire(aPlant);
        }
        if (aBodyReanim->mLoopCount > 0)
        {
...
ZombieID Zombie::SummonBackupDancer(int theRow, int thePosX)
{
    ...
    Zombie* aZombie = IsGiga(mZombieType) ? mBoard->AddZombie(ZombieType::ZOMBIE_BACKUP_DISCO, mFromWave) : mBoard->AddZombie(ZombieType::ZOMBIE_BACKUP_DANCER, mFromWave);
...
void Zombie::SummonBackupDancers()
{
    if (!mHasHead)
        return;
    if (GetNumBackup(mZombieType) == NUM_BACKUP_DISCOS) 
    {
        for (int i = 0; i < NUM_BACKUP_DISCOS; i++)
        {
            if (mBoard->ZombieTryToGet(mFollowerZombieID[i]) == nullptr)
            {
                ...
                switch (i)
                {
                case 0:     aRow = mRow - 1;    aPosX = mPosX + 50;     break;
                case 1:     aRow = mRow + 1;    aPosX = mPosX + 50;     break;
                case 2:     aRow = mRow - 1;    aPosX = mPosX - 50;     break;
                case 3:     aRow = mRow + 1;    aPosX = mPosX - 50;     break;
                case 4:     aRow = mRow;        aPosX = mPosX - 100;    break;
                case 5:     aRow = mRow;        aPosX = mPosX + 100;    break;
...
{
    for (int i = 0; i < GetNumBackup(mZombieType); i++)
    {
        if (mBoard->ZombieTryToGet(mFollowerZombieID[i]) == nullptr)
        {
...
void Zombie::UpdateZombiePool()
{
    if (mZombieHeight == ZombieHeight::HEIGHT_OUT_OF_POOL)
    {
        ...
        if (mAltitude >= 0.0f)
        {
            ...
            mZombieHeight = ZombieHeight::HEIGHT_ZOMBIE_NORMAL;
            mInPool = false;
            if (IsPogo(mZombieType)) PickRandomSpeed();
        }
    }
...
void Zombie::OverrideParticleColor(TodParticleSystem* aParticle)
{
    if (aParticle)
    {
        bool aPoisonColor = false;
        for (int i = 0; i < MAX_POISON_STACK; i++)
        {
            if (mPoisonCounter[i] > 0) aPoisonColor = true;
        }
        if (mMindControlled)
        {
        ...
        //Poison color code
        else if (aPoisonColor)
        {
            aParticle->OverrideColor(nullptr, Color(ZOMBIE_POISON_COLOR));
            aParticle->OverrideExtraAdditiveDraw(nullptr, true);
        }
    }
}
...
{
    if ((mZombieType != ZombieType::ZOMBIE_FLAG && mZombieType != ZombieType::ZOMBIE_RALLY) || !mHasObject)
        return;
...
{
    return 
        !IsGargantuar(mZombieType) &&
        !IsBungee(mZombieType) &&
        !IsMachine(mZombieType) &&
        mZombieType != ZombieType::ZOMBIE_BOSS && 
        mZombieHeight != ZombieHeight::HEIGHT_ZOMBIQUARIUM && 
        !IsFloating() && 
        !IsMinecraft(mZombieType) &&
...
void Zombie::SetupReanimForLostHead()
{
    ...
    ReanimShowPrefix("anim_mustache", RENDER_GROUP_HIDDEN);
}
...
void Zombie::DropHead(unsigned int theDamageFlags)
{
    ...
    // Kill Ding
    if (mApp->GetConfigCheckbox(false, CONFIG_CHECKBOX_KILL_SOUND))
        mApp->PlayFoley(FoleyType::FOLEY_KILL_DING);
    ...
    if (IsDancer(mZombieType))
    {
        aRenderOrder = mRenderOrder - 1;
    }
    if (IsNewspaper(mZombieType))
    {
    ...
    else if (IsPole(mZombieType))
    {
        DropPole();
            ...
            mZombieType == ZombieType::ZOMBIE_RALLY)
    {
        DropFlag();
    }
    ...
    if (aParticle)
    {
        ...
        else if (mZombieType == ZombieType::ZOMBIE_BACKUP_DISCO)
        {
            ReanimShowPrefix("anim_earing", RENDER_GROUP_HIDDEN);
            aParticle->OverrideImage(nullptr, IMAGE_ZOMBIEBACKUPDANCERHEAD);
        }
            ...
            aParticle->OverrideImage(nullptr, IMAGE_ZOMBIEYETIHEAD);
        else if (mApp->IsDeadplantsLevel())
            IsGiga(mZombieType) ?
            aParticle->OverrideImage(nullptr, IMAGE_CORPSEGIGAHEAD) : 
            aParticle->OverrideImage(nullptr, IMAGE_CORPSEHEAD);
        else if (IsGiga(mZombieType))
            aParticle->OverrideImage(nullptr, IMAGE_ZOMBIEGIGAHEAD);
    }

    Reanimation* aBodyReanim = mApp->ReanimationTryToGet(mBodyReanimID);
    if ((IsGiga(mZombieType) || mBoard->mMustacheMode) && !IsZombotany(mZombieType) && aBodyReanim->TrackExists("Zombie_mustache"))
    {
...
void Zombie::UpdateDamageStates(unsigned int theDamageFlags)
{
    ...
    if (mHasHead && mBodyHealth < mBodyMaxHealth / 3)
    {
        ...
        if (TestBit(theDamageFlags, (int)DamageFlags::DAMAGE_SPORE))
        {
            ...
            int aPosX = aRect.mX + aRect.mWidth / 2;
            if (mBoard->CanPlantAt(mBoard->PixelToGridX(aPosX, aRect.mY), mRow, SeedType::SEED_SPORESHROOM) == PlantingReason::PLANTING_OK)
            {
                Plant* aPlant = mBoard->AddPlant(mBoard->PixelToGridX(aPosX, aRect.mY), mRow, SeedType::SEED_SPORESHROOM);
                aPlant->mPlantMaxHealth = aPlant->mPlantHealth = 150;
            }
        }
...
bool Zombie::ZombieNotWalking()
{
    ...
    if (mZombiePhase == ZombiePhase::PHASE_JACK_IN_THE_BOX_POPPING || 
        ...
        mZombiePhase == ZombiePhase::PHASE_FOOTBALL_IN_TACKLE ||
        mZombiePhase == ZombiePhase::PHASE_FOOTBALL_STUNNED)
    {
        return true;
    }

    if (IsDancerOrBackup(mZombieType))
    {
...
{
    if (mPosX > 360.0f + LAWN_XMIN && !mFlatTires)
    {
    ...
    if (mBoard->StageHasRoof())
    {
        anIceX = max(anIceX, 460 + LAWN_XMIN);
    }
    else
    {
        anIceX = max(anIceX, -15 + LAWN_XMIN);
    }
    if (anIceX < mBoard->mIceMinX[mRow])
    {
        mBoard->mIceMinX[mRow] = anIceX;
    }
    if (anIceX < 760 + LAWN_XMIN)
    {
...
void Zombie::UpdateZombieWalking()
{
    ...
    if (aBodyReanim)
    {
        ...
        if (IsBouncingPogo() || mZombiePhase == ZombiePhase::PHASE_BALLOON_FLYING || mZombiePhase == ZombiePhase::PHASE_DOLPHIN_RIDING || 
            mZombiePhase == ZombiePhase::PHASE_SNORKEL_WALKING_IN_POOL || IsCatapult(mZombieType))
        {
            aSpeed = mVelX;
        ...
        else if (IsZomboni(mZombieType) || mZombiePhase == ZombiePhase::PHASE_DIGGER_TUNNELING || mZombiePhase == ZombiePhase::PHASE_DOLPHIN_IN_JUMP ||
        ...
        if (IsFootball(mZombieType) && mFromWave != Zombie::ZOMBIE_WAVE_WINNER)
        {
    ...
    else
    {
        ...
        if (mZombiePhase == ZombiePhase::PHASE_POLEVAULTER_IN_VAULT || 
            mZombiePhase == ZombiePhase::PHASE_DIGGER_TUNNELING || 
            IsDancerOrBackup(mZombieType) || IsBobsled(mZombieType) || IsPogo(mZombieType) || IsDolphinRider(mZombieType) || IsBalloon(mZombieType))
        {
            doWalk = true;
        }
        else if (IsSnorkel(mZombieType) && mInPool)
        {
            doWalk = true;
        }
...
{
    if ((IsMachine(mZombieType) && !mFlatTires) || (CanSquish(mZombieType) && !IsDeadOrDying() && mHasHead))
    {
...
{
    if (IsBungee(mZombieType) || mZombieType == ZombieType::ZOMBIE_BOSS ||
...
void Zombie::UpdateClimbingLadder()
{
    ...
    if (mBoard->GetLadderAt(aLadderOriginX, mRow) == nullptr && mZombieType != MC_SPIDER)
    {
        mZombieHeight = ZombieHeight::HEIGHT_FALLING;
        return;
    }
...
void Zombie::UpdateActions()
{
    ...
    if (IsCatapult(mZombieType))
        UpdateZombieCatapult();
    if (IsDolphinRider(mZombieType))
        UpdateZombieDolphinRider();
    if (IsSnorkel(mZombieType))
        UpdateZombieSnorkel();
    if (IsBalloon(mZombieType))
        UpdateZombieFlyer();
    if (IsNewspaper(mZombieType))
        UpdateZombieNewspaper();
    if (IsDigger(mZombieType))
        UpdateZombieDigger();
    if (IsJack(mZombieType))
        UpdateZombieJackInTheBox();
    if (IsGargantuar(mZombieType))
        UpdateZombieGargantuar();
    if (IsBobsled(mZombieType))
        UpdateZombieBobsled();
    if (IsZomboni(mZombieType))
        UpdateZamboni();
    if (IsLadder(mZombieType))
        UpdateLadder();
    if (IsYeti(mZombieType))
        UpdateYeti();
    if (IsDancer(mZombieType))
        UpdateZombieDancer();
    if (IsBackup(mZombieType))
        UpdateZombieBackupDancer();
    if (IsFootball(mZombieType) && IsGiga(mZombieType) && mApp->GetConfigCheckbox(true, CONFIG_CHECKBOX_GIGA_ABILITIES))
        UpdateZombieGigaFootball();
    if (IsImp(mZombieType))
        UpdateZombieImp();
    if (IsTalisman(mZombieType))
        UpdateZombieTalisman();
    if (IsPeahead(mZombieType))
        UpdateZombiePeaHead();
    if (IsJalapenohead(mZombieType))
        UpdateZombieJalapenoHead();
    if (IsGatlinghead(mZombieType) && IsGiga(mZombieType) && mApp->GetConfigCheckbox(true, CONFIG_CHECKBOX_GIGA_ABILITIES))
        UpdateZombieIceQueenHead();
    else if (IsGatlinghead(mZombieType))
        UpdateZombieGatlingHead();
    if (IsSquashhead(mZombieType) && IsGiga(mZombieType) && mApp->GetConfigCheckbox(true, CONFIG_CHECKBOX_GIGA_ABILITIES))
        UpdateZombieExplodenutHead();
    else if (IsSquashhead(mZombieType))
...
{
    if (IsWalkingBackwards() && mPosX > WIDE_BOARD_WIDTH + 50)
    {
        DieNoLoot();
        return;
    }
    ...
    if (IsGargantuar(mZombieType) || IsPole(mZombieType))
        aEdgeX = -150;
    else if (IsMachine(mZombieType) || IsFootball(mZombieType))
        aEdgeX = -175;
    else if (IsDancerOrBackup(mZombieType) || IsSnorkel(mZombieType))
        aEdgeX = -130;

    if (mX <= aEdgeX && mHasHead)
    {
        if (mApp->IsIZombieLevel()) DieNoLoot();
        else mBoard->ZombiesWon(this);
    }
    if (mX <= aEdgeX + 70 && !mHasHead) TakeDamage(1800, 9U);
}
...
void Zombie::UpdatePlaying()
{
    ...
    if (mGroanCounter == 0 && Rand(aZombiesCount) == 0 && mHasHead && mZombieType != ZombieType::ZOMBIE_BOSS && mZombieType != ZombieType::MC_CREEPER && !mBoard->HasLevelAwardDropped() && !mApp->IsDeadplantsLevel())
    {
        float aPitch = 0.0f;
        if (mApp->IsLittleTroubleLevel() || IsMinecraftBaby(mZombieType))
        {
            aPitch = RandRangeFloat(40.0f, 50.0f);
        }

        if (IsGargantuar(mZombieType)) mApp->PlayFoley(FoleyType::FOLEY_LOW_GROAN);
        else if (IsImp(mZombieType) && mVariant) mApp->PlayFoley(FoleyType::FOLEY_IMP_BRAINS);
        else if (IsImp(mZombieType)) mApp->PlayFoley(FoleyType::FOLEY_IMP_LAUGH);
        else if (IsMinecraftZombie(mZombieType)) mApp->PlayFoley(FoleyType::FOLEY_MCZOMBIE_IDLE);
        else if (IsMinecraftSkeleton(mZombieType)) mApp->PlayFoley(FoleyType::FOLEY_MCSKELETON_IDLE);
        else if (mZombieType == MC_SPIDER) mApp->PlayFoley(FoleyType::FOLEY_MCSPIDER_IDLE);
        else if (mApp->mSukhbirMode) mApp->PlayFoleyPitch(FoleyType::FOLEY_SUKHBIR, aPitch);
        else if (mVariant) mApp->PlayFoleyPitch(FoleyType::FOLEY_BRAINS, aPitch);
        else mApp->PlayFoleyPitch(FoleyType::FOLEY_GROAN, aPitch);
    ...
    if (mChilledCounter > 0 && (!mApp->GetConfigCheckbox(true, CONFIG_CHECKBOX_CHILL_REBALANCE) || mIceTrapCounter <= 0))
    {
        mChilledCounter--;
    ...
    for (int i = 0; i < MAX_POISON_STACK; i++)
    {
        if (mPoisonCounter[i] > 0)
        {
            mPoisonCounter[i]--;
            aPoisonStack++;
            aPoisonDamage += mPoisonDamage[i];
        }
    }
    ...
    {
        mButteredCounter--;
        if (mButteredCounter == 0) RemoveButter();
    }
    if (mZombieType != ZombieType::ZOMBIE_RALLY && mApp->GetConfigCheckbox(true, CONFIG_CHECKBOX_GIGA_ABILITIES))
    {
        if (!mRallied)
        {
            mRallied = FindRallyZombie();
            if (mRallied) UpdateAnimSpeed();
        }
        else
        {
            mRallied = FindRallyZombie();
    ...
    if (!IsDeadOrDying() && mFromWave != Zombie::ZOMBIE_WAVE_WINNER)
    {
        if (aPoisonStack > 0)
        {
            if (mPoisonRate > 0) mPoisonRate--;
            else
            {
                mPoisonRate = BASE_POISON_TICKS;
                TakeDamage(aPoisonDamage, 33U);
            }
        }
        ...
        if (IsMachine(mZombieType))
        {
            if (mBodyHealth < 200) isDying = true;
        }

        if (isDying)
        {
            int aDamage = 1;
            if (IsYeti(mZombieType)) aDamage = 10;
            if (mBodyMaxHealth >= 500) aDamage = 3;

            if (Rand(5) == 0) TakeDamage(aDamage, 9U);
        }
    }
}
...
bool Zombie::HasYuckyFaceImage()
{
    ...
    return 
        IsBasic(mZombieType) ||
        IsDancerOrBackup(mZombieType) ||
        IsNewspaper(mZombieType) ||
        IsPole(mZombieType);
}
...
void Zombie::AnimateChewSound()
{
    ...
    if (aPlant)
    {
        ...
        {
            if (aPlant->IsWall(aPlant->mSeedType))
            {
...
void Zombie::AnimateChewEffect()
{
    ...
    if (aPlant)
    {
        if (aPlant->IsNut(aPlant->mSeedType))
        {
            ...
            if (IsWaterOnly(mZombieType))
            {
                aPosX -= 7.0f;
                aPosY += 70.0f;
            }
            else if (IsWalkingBackwards()) aPosX += 47.0f;
            else if (IsBalloon(mZombieType)) aPosY += 47.0f;
            else if (IsImp(mZombieType))
            {
                aPosX += 24.0f;
                aPosY += 40.0f;
...
void Zombie::Animate()
{
    ...
    if (mIsEating && mHasHead)
    {
        ...
        if (aBodyReanim)
        {
            ...
            else if (IsNewspaper(mZombieType) || IsLadder(mZombieType))
            {
                aLeftHandTime = 0.42f;
...
void Zombie::DrawZombie(Graphics* g, const ZombieDrawPosition& theDrawPos)
{
    ...
    case ZombieType::ZOMBIE_COFFIN:
    case ZombieType::ZOMBIE_OUTHOUSE:
    case ZombieType::ZOMBIE_FOOTBALL:
    case ZombieType::ZOMBIE_DOLPHIN_RIDER:
    case ZombieType::ZOMBIE_LADDER:

    case ZombieType::ZOMBIE_MUSTACHE:
    case ZombieType::ZOMBIE_RALLY:
    case ZombieType::ZOMBIE_GIGACONE:
    case ZombieType::ZOMBIE_GIGABUCKET:
    case ZombieType::ZOMBIE_SUNDAY:
    case ZombieType::ZOMBIE_GIGADOOR:
    case ZombieType::ZOMBIE_GIGACOFFIN:
    case ZombieType::ZOMBIE_GIGAOUTHOUSE:
    case ZombieType::ZOMBIE_GIGAFOOTBALL:
    case ZombieType::ZOMBIE_ORCA_RIDER:
    case ZombieType::ZOMBIE_GIGALADDER:

    case ZombieType::ZOMBIE_ANGEL:
...
bool Zombie::IsWalkingBackwards()
{
    ...
    return (IsYeti(mZombieType)) && !mHasObject;
}
...
void Zombie::DrawZombiePart(Graphics* g, Image* theImage, int theFrame, int theRow, const ZombieDrawPosition& theDrawPos)
{
    ...
    {
        g->SetColorizeImages(true);
        Color aPoisonColor = ZOMBIE_POISON_COLOR;
        aPoisonColor.mAlpha = anAlpha;
        g->SetColor(aPoisonColor);
        g->DrawImageMirror(theImage, aDestRect, aSrcRect, aMirror);
...
void Zombie::UpdateReanim()
{
    ...
    if (IsMachine(mZombieType) && mZombiePhase != ZombiePhase::PHASE_ZOMBIE_BURNED)
    {
    ...
    if (IsFootball(mZombieType) && mScaleZombie < 1.0f)
    {
...
void Zombie::DrawReanim(Graphics* g, const ZombieDrawPosition& theDrawPos, int theBaseRenderGroup)
{
    ...
    {
        aColorOverride = ZOMBIE_POISON_COLOR;
        aColorOverride.mAlpha = aFadeAlpha;
        aExtraAdditiveColor = aColorOverride;
        aEnableExtraAdditiveDraw = true;
    }
    ...
    if (mJustGotShotCounter > 0 && !IsBobsledTeamWithSled())
    {
        ...
        int aRedness = TodAnimateCurve(0, 39, mZombieAge % 40, 63, 255, TodCurves::CURVE_BOUNCE);
        Color aHighlightColor(aRedness, 0, 0, 255);
        aExtraAdditiveColor = ColorAdd(aHighlightColor, aExtraAdditiveColor);
        aEnableExtraAdditiveDraw = true;
    }
...
void Zombie::GetDrawPos(ZombieDrawPosition& theDrawPos)
{
    ...
    case ZombieType::ZOMBIE_GIGABOBSLED:
        ...
        break;
    case ZombieType::ZOMBIE_BOSS:
        theDrawPos.mImageOffsetX = -40 + LAWN_XMIN;
        theDrawPos.mImageOffsetY = -80 + LAWN_YMIN;
        break;
    }
...
void Zombie::DrawButter(Graphics* g, const ZombieDrawPosition& theDrawPos)
{
    ...
    else if (IsCatapult(mZombieType)) GetTrackPosition("Zombie_catapult_driver_head", aOffsetX, aOffsetY);
    else if (mBodyReanimID != ReanimationID::REANIMATIONID_NULL) GetTrackPosition("anim_head1", aOffsetX, aOffsetY);
...
{
    if (((mApp->IsWallnutBowlingLevel() && Plant::IsWallNut(thePlant->mSeedType)) || thePlant->mSeedType == SeedType::SEED_BOWLNUT) && theAttackType != ZombieAttackType::ATTACKTYPE_VAULT)
        return false;
    ...
    if (thePlant->IsSpiky() || (thePlant->mSeedType == SeedType::SEED_INFINUT && thePlant->mState == PlantState::STATE_INVULNERABLE))
    {
        return 
            IsGargantuar(mZombieType) || IsZomboni(mZombieType) ||
            mBoard->IsPoolSquare(thePlant->mPlantCol, thePlant->mRow) || 
            mBoard->GetFlowerPotAt(thePlant->mPlantCol, thePlant->mRow) ||
            mBoard->GetWaterPotAt(thePlant->mPlantCol, thePlant->mRow);
    }
    ...
    if (theAttackType == ZombieAttackType::ATTACKTYPE_DRIVE_OVER)
    {
        if (thePlant->mSeedType == SeedType::SEED_CHERRYBOMB || thePlant->mSeedType == SeedType::SEED_JALAPENO 
            || thePlant->mSeedType == SeedType::SEED_CHILLYPEPPER || thePlant->mSeedType == SeedType::SEED_PICKLEDPEPPER 
            || thePlant->mSeedType == SeedType::SEED_BLOVER || thePlant->mSeedType == SeedType::SEED_SQUASH || thePlant->mSeedType == SeedType::SEED_SPOOKYSQUASH
            || thePlant->mSeedType == SeedType::SEED_DOOMSHROOM || thePlant->mSeedType == SeedType::SEED_ICESHROOM || thePlant->mSeedType == SeedType::SEED_SEASTARFRUIT
            )
        {
    ...
    if (mZombiePhase == ZombiePhase::PHASE_LADDER_CARRYING || mZombiePhase == ZombiePhase::PHASE_LADDER_PLACING)
    {
        ...
        if (thePlant->IsWall(thePlant->mSeedType))
        {
            aPlaceLadder = true;
        }
...
bool Zombie::IsMovingAtChilledSpeed()
{
    ...
    if (IsDancerOrBackup(mZombieType))
    {
        ...
        if (aLeader)
        {
            if (aLeader->mChilledCounter > 0) return true;
            for (int i = 0; i < GetNumBackup(mZombieType); i++)
            {
                Zombie* aDancer = mBoard->ZombieTryToGet(aLeader->mFollowerZombieID[i]);
                if (aDancer && aDancer->mChilledCounter > 0) return true;
            }
        }
    }
...
{
    Reanimation* aBodyReanim = mApp->ReanimationTryToGet(mBodyReanimID);
    if (aBodyReanim) aBodyReanim->mAnimRate = IsMovingAtChilledSpeed() ? 
        mRallied ? theAnimRate : theAnimRate * 0.5f :
        mRallied ? theAnimRate * 2 : theAnimRate;
}
...
void Zombie::UpdateAnimSpeed()
{
    ...
    if (mIsEating)
    {
        if (IsPole(mZombieType) || IsBalloon(mZombieType) || IsImp(mZombieType) || IsDigger(mZombieType) || IsJack(mZombieType) || IsSnorkel(mZombieType) || IsYeti(mZombieType)) ApplyAnimRate(20.0f);
        else ApplyAnimRate(36.0f);
    }
    else 
    {
        if (ZombieNotWalking() || IsBobsledTeamWithSled() || IsCatapult(mZombieType) || mZombiePhase == ZombiePhase::PHASE_DOLPHIN_RIDING ||
            mZombiePhase == ZombiePhase::PHASE_SNORKEL_WALKING_IN_POOL) ApplyAnimRate(mOriginalAnimRate);
        else if (aBodyReanim->TrackExists("_ground"))
        {
...
void Zombie::StartWalkAnim(int theBlendTime)
{
    ...
    else if (IsBasic(mZombieType) && mShieldType == ShieldType::SHIELDTYPE_NONE && mBoard->mDanceMode)
    {
    ...
    else
    {
        ...
        if (mZombieType == ZombieType::ZOMBIE_FLAG || mZombieType == ZombieType::ZOMBIE_RALLY)
        {
            aWalkAnimVariant = 0;
        }
...
void Zombie::StopEating()
{
    ...
    if (aBodyReanim && !IsSnorkel(mZombieType))
    {
        StartWalkAnim(20);
    }
...
{
    if (NoEat(mZombieType) ||
        CanSquish(mZombieType) ||
        mZombieType == ZombieType::ZOMBIE_BOSS || 
        IsBouncingPogo() || 
        IsBobsledTeamWithSled() ||
        mZombiePhase == ZombiePhase::PHASE_POLEVAULTER_IN_VAULT ||
        ...
        !mHasHead || 
        IsFlying() ||
        mZombiePhase == ZombiePhase::PHASE_FOOTBALL_PRE_TACKLE ||
        mZombiePhase == ZombiePhase::PHASE_FOOTBALL_IN_TACKLE || 
        mZombiePhase == ZombiePhase::PHASE_FOOTBALL_STUNNED)
        return;
...
{
    if (mZombieHeight != ZombieHeight::HEIGHT_ZOMBIE_NORMAL || IsBungee(mZombieType))
        return;
...
void Zombie::EatPlant(Plant* thePlant)
{
    ...
    if ((mBoard->GetLadderAt(thePlant->mPlantCol, thePlant->mRow) || mZombieType == MC_SPIDER) && !IsDigger(mZombieType))  // 矿工僵尸无视梯子
    {
        StopEating();
    ...
    if ((thePlant->mSeedType == SeedType::SEED_JALAPENO || 
        ...
        thePlant->mSeedType == SeedType::SEED_PICKLEDPEPPER ||
        ...
        thePlant->mState == PlantState::STATE_INVULNERABLE ||
        ...
        thePlant->mSeedType == SeedType::SEED_SEASTARFRUIT
        )
        && !thePlant->mIsAsleep)
        return;
    if ((thePlant->mSeedType == SeedType::SEED_POTATOMINE || thePlant->mSeedType == SeedType::SEED_POPCORN) && thePlant->mState != PlantState::STATE_NOTREADY && !thePlant->mIsAsleep)
        return;
    if ((thePlant->mSeedType == SeedType::SEED_BLOVER 
        || (thePlant->mSeedType == SeedType::SEED_GOLDBLOOM && thePlant->mState != PlantState::STATE_NOTREADY)
        || thePlant->mSeedType == SeedType::SEED_ICESHROOM)
        && !thePlant->mIsAsleep)
    {
        thePlant->DoSpecial();
    ...
    if (mApp->IsIZombieLevel() && thePlant->mSeedType == SeedType::SEED_SUNFLOWER)
    {
        ...
        {
            mBoard->AddCoin(thePlant->mX, thePlant->mY, CoinType::COIN_LARGESUN, CoinMotion::COIN_MOTION_FROM_PLANT);
        }
    }
    ...
    if (thePlant->mLaunchCounter == 0) {
        if (thePlant->mSeedType == SeedType::SEED_VINENUT) 
        {
            TakeDamage(BASE_VINENUT_DAMAGE, 33U);
        }
        else if (thePlant->mSeedType == SeedType::SEED_FIRESHROOM)
        {
            mApp->PlayFoley(FoleyType::FOLEY_IGNITE);
            TakeDamage(BASE_VINENUT_DAMAGE * 8, 33U);
        }
    }
    if (mZombiePhase == ZombiePhase::PHASE_NEWSPAPER_MAD && IsGiga(mZombieType)) thePlant->mPlantHealth -= DAMAGE_PER_EAT;
    if (IsImp(mZombieType) || mZombiePhase == ZombiePhase::PHASE_NEWSPAPER_MAD) thePlant->mPlantHealth -= DAMAGE_PER_EAT;
    ...
    if (thePlant->mPlantHealth <= 0)
    {
        ...
        if (mBoard->mLevel >= DAY_LEVEL_INDEX + 2 && mBoard->mLevel <= DAY_LEVEL_INDEX + 4 && mApp->IsFirstTimeAdventureMode())
        {
...
bool Zombie::TrySpawnLevelAward()
{
    ...
    {
        if (mBoard->mLevel % LEVELS_PER_AREA == LEVELS_PER_AREA - 1)
        {
            aCoinType = CoinType::COIN_NOTE;
        }
        else if (mBoard->mLevel == FINAL_LEVEL)
        {
        ...
        else if (mBoard->mLevel == DAY_LEVEL_INDEX + LEVEL_MID_AREA - 1)
        {
            aCoinType = CoinType::COIN_SHOVEL;
        }
        else if (mBoard->mLevel == NIGHT_LEVEL_INDEX + LEVEL_MID_AREA - 1)
        {
            aCoinType = CoinType::COIN_ALMANAC;
        }
        else if (mBoard->mLevel == POOL_LEVEL_INDEX + LEVEL_MID_AREA - 1)
        {
            aCoinType = CoinType::COIN_CARKEYS;
        }
        else if (mBoard->mLevel == FOG_LEVEL_INDEX + LEVEL_MID_AREA - 1)
        {
            aCoinType = CoinType::COIN_TACO;
        }
        else if (mBoard->mLevel == ROOF_LEVEL_INDEX + LEVEL_MID_AREA - 1)
        {
...
void Zombie::DropLoot()
{
    ...
    if (IsYeti(mZombieType)) mBoard->mKilledYeti = true;
    ...
    if (IsYeti(mZombieType))
    {
        ...
        if (mZombieType == ZombieType::ZOMBIE_BIGFOOT) {
            mBoard->AddCoin(aCenterX - 60, aCenterY, CoinType::COIN_DIAMOND, CoinMotion::COIN_MOTION_COIN);
            mBoard->AddCoin(aCenterX - 70, aCenterY, CoinType::COIN_DIAMOND, CoinMotion::COIN_MOTION_COIN);
            mBoard->AddCoin(aCenterX - 80, aCenterY, CoinType::COIN_DIAMOND, CoinMotion::COIN_MOTION_COIN);
            mBoard->AddCoin(aCenterX - 90, aCenterY, CoinType::COIN_DIAMOND, CoinMotion::COIN_MOTION_COIN);
        }
    }
    else
    {
...
void Zombie::DieNoLoot()
{
    ...
    mDead = true;
    TrySpawnLevelAward();
    if (IsBobsled(mZombieType)) BobsledDie();
    if (IsBungee(mZombieType)) BungeeDie();
    if (mZombieType == ZombieType::ZOMBIE_BOSS) 
        BossDie();
}
...
{
    if (IsDolphinRider(mZombieType)) mApp->PlayFoley(FoleyType::FOLEY_DOLPHIN_APPEARS);
    else if (IsBalloon(mZombieType)) mApp->PlayFoley(FoleyType::FOLEY_BALLOONINFLATE);
    else if (IsZomboni(mZombieType))mApp->PlayFoley(FoleyType::FOLEY_ZAMBONI);
}
...
void Zombie::StopZombieSound()
{
    if (IsDancerOrBackup(mZombieType))
    {
        ...
        if (mBoard)
        {
            ...
            while (mBoard->IterateZombies(aZombie))
            {
                if (aZombie->mHasHead && !aZombie->IsDeadOrDying() && aZombie->IsOnBoard() && IsDancerOrBackup(mZombieType))
                {
                    aStopSound = true;
                    break;
                }
    ...
    if (mPlayingSong)
    {
        ...
        if (IsJack(mZombieType)) mApp->mSoundSystem->StopFoley(FoleyType::FOLEY_JACKINTHEBOX);
        else if (IsDigger(mZombieType)) mApp->mSoundSystem->StopFoley(FoleyType::FOLEY_DIGGER);
    }
}
...
// Spook Poison Apply
void Zombie::ApplyPoison(int aPoisonTime, int aPoisonDamage, bool theDoesStack)
{
    if (!CanBeChilled())
        return;
    ...
    {
        int aBestCounter = 0;
        int aBestWeight = 9999;
        bool aPlaySound = true;
        for (int i = 0; i < MAX_POISON_STACK; i++)
        {
            if (mPoisonCounter[i] < aBestWeight)
            {
                aBestCounter = i;
                aBestWeight = mPoisonCounter[i];
            }
            if (mPoisonCounter[i] > 0) aPlaySound = false;
        }
        mPoisonCounter[aBestCounter] = max(aPoisonTime, mPoisonCounter[aBestCounter]);
        mPoisonDamage[aBestCounter] = aPoisonDamage;
        if (aPlaySound) mApp->PlayFoley(FoleyType::FOLEY_FROZEN);
    }
    else
    {
        if (mPoisonCounter[0] == 0)
        {
            mApp->PlayFoley(FoleyType::FOLEY_FROZEN);
        }

        mPoisonCounter[0] = max(aPoisonTime, mPoisonCounter[0]);
        mPoisonDamage[0] = aPoisonDamage;
    }
...
void Zombie::DropHelm(unsigned int theDamageFlags)
{
    ...
    else if (mHelmType == HelmType::HELMTYPE_POT)
    {
        GetTrackPosition("anim_cone", aPosX, aPosY);
        ReanimShowPrefix("anim_cone", RENDER_GROUP_HIDDEN);
        ReanimShowPrefix("anim_hair", RENDER_GROUP_NORMAL);
        aEffect = ParticleEffect::PARTICLE_ZOMBIE_POT;
    }
    else if (mHelmType == HelmType::HELMTYPE_BRICK)
    {

    }
    else if (mHelmType == HelmType::HELMTYPE_HELMET)
    {
        GetTrackPosition("anim_helmet", aPosX, aPosY);
        ReanimShowPrefix("anim_helmet", RENDER_GROUP_HIDDEN);
        aEffect = ParticleEffect::PARTICLE_ZOMBIE_GARGANTUAR_HELMET;
    }
...
int Zombie::TakeHelmDamage(int theDamage, unsigned int theDamageFlags)
{
    ...
    // Pot Lobbed Resistance
    if (mHelmType == HelmType::HELMTYPE_POT && TestBit(theDamageFlags, (int)DamageFlags::DAMAGE_LOBBED))
        return 0;
    ...
    if (TestBit(theDamageFlags, (int)DamageFlags::DAMAGE_POISON))
        ApplyPoison(BASE_POISON_COUNTER, BASE_POISON_DAMAGE, true);
    ...
    if (aDamageIndexBeforeDamage != aDamageIndexAfterDamage)
    {
        ...
        else if (mHelmType == HelmType::HELMTYPE_HELMET && aDamageIndexAfterDamage == 1)
        {
            aBodyReanim->SetImageOverride("anim_helmet", IMAGE_REANIM_ZOMBIE_GARGANTUAR_HELMET2);
        }
        else if (mHelmType == HelmType::HELMTYPE_HELMET && aDamageIndexAfterDamage == 2)
        {
            TOD_ASSERT(aBodyReanim);
            aBodyReanim->SetImageOverride("anim_helmet", IMAGE_REANIM_ZOMBIE_GARGANTUAR_HELMET3);
        }
        else if (mHelmType == HelmType::HELMTYPE_POT && aDamageIndexAfterDamage == 1)
        {
            aBodyReanim->SetImageOverride("anim_cone", IMAGE_REANIM_ZOMBIE_POT2);
        }
        else if (mHelmType == HelmType::HELMTYPE_POT && aDamageIndexAfterDamage == 2)
        {
            aBodyReanim->SetImageOverride("anim_cone", IMAGE_REANIM_ZOMBIE_POT3);
        }
        else if (mHelmType == HelmType::HELMTYPE_BRICK && aDamageIndexAfterDamage == 1)
        {
            aBodyReanim->SetImageOverride("anim_bucket", IMAGE_REANIM_WALLNUT_CRACKED1);
        }
        else if (mHelmType == HelmType::HELMTYPE_BRICK && aDamageIndexAfterDamage == 2)
        {
            aBodyReanim->SetImageOverride("anim_bucket", IMAGE_REANIM_WALLNUT_CRACKED2);
        }
...
void Zombie::TakeBodyDamage(int theDamage, unsigned int theDamageFlags)
{
    ...
    if (IsMinecraft(mZombieType))
    {
        int aCalculatedDamage = theDamage * (1.0f - (max(mMinecraftDefensePoints / 5.0f, mMinecraftDefensePoints - ((4.0f * theDamage) / (mMinecraftToughnessPoints + 8.0f))) / 25.0f));
        mBodyHealth -= aCalculatedDamage;
    }
    else mBodyHealth -= theDamage;
    ...
    else if (IsGargantuar(mZombieType) && !IsGiga(mZombieType))
    {
        Reanimation* aBodyReanim = mApp->ReanimationGet(mBodyReanimID);
        if (aDamageIndexBeforeDamage != aDamageIndexAfterDamage)
        {
    ...
    else if (mZombieType == ZombieType::ZOMBIE_GIGAGARGANTUAR)
    {
        Reanimation* aBodyReanim = mApp->ReanimationGet(mBodyReanimID);
        if (aDamageIndexBeforeDamage != aDamageIndexAfterDamage)
        {
            if (aDamageIndexAfterDamage == 1)
            {
                aBodyReanim->SetImageOverride("Zombie_gargantua_body1", IMAGE_REANIM_ZOMBIE_GIGA_GARGANTUAR_BODY1_2);
                aBodyReanim->SetImageOverride("Zombie_gargantuar_outerarm_lower", IMAGE_REANIM_ZOMBIE_GIGA_GARGANTUAR_OUTERARM_LOWER2);
            }
            else if (aDamageIndexAfterDamage == 2)
            {
                aBodyReanim->SetImageOverride("Zombie_gargantua_body1", IMAGE_REANIM_ZOMBIE_GIGA_GARGANTUAR_BODY1_3);
                aBodyReanim->SetImageOverride("Zombie_gargantuar_outerleg_foot", IMAGE_REANIM_ZOMBIE_GIGA_GARGANTUAR_FOOT2);
                aBodyReanim->SetImageOverride("Zombie_gargantuar_outerarm_lower", IMAGE_REANIM_ZOMBIE_GIGA_GARGANTUAR_OUTERARM_LOWER2);
                aBodyReanim->SetImageOverride("anim_head1", IMAGE_REANIM_ZOMBIE_GIGA_GARGANTUAR_HEAD2);
            }
        }
    }
    else if (mZombieType == ZombieType::ZOMBIE_BOSS)
    ...
    if (mBodyHealth <= 0)
    {
        ...
        if (TestBit(theDamageFlags, (int)DamageFlags::DAMAGE_BURN))
            ...
            PlayDeathAnim(theDamageFlags);
        if (mHasHead && TestBit(theDamageFlags, (int)DamageFlags::DAMAGE_SPORE))
        {
            Rect aRect = GetZombieRect();
            int aPosX = aRect.mX + aRect.mWidth / 2;
            if (mBoard->CanPlantAt(mBoard->PixelToGridX(aPosX, aRect.mY), mRow, SeedType::SEED_SPORESHROOM) == PlantingReason::PLANTING_OK)
...
void Zombie::TakeDamage(int theDamage, unsigned int theDamageFlags)
{
    ...
    if (aDamageRemaining > 0 && mArmorType != ArmorType::ARMORTYPE_NONE)
    {
        aDamageRemaining = TakeArmorDamage(aDamageRemaining, theDamageFlags);
        if (TestBit(theDamageFlags, (int)DamageFlags::DAMAGE_HITS_SHIELD_AND_BODY))
            aDamageRemaining = theDamage;
    }
...
float Zombie::GetPosYBasedOnRow(int theRow)
{
    ...
    if (IsBalloon(mZombieType)) aPosY -= 30.0f;
    else if (IsPogo(mZombieType)) aPosY -= 16.0f;
...
{
    if (IsZomboni(mZombieType) || IsBobsledTeamWithSled() || IsDeadOrDying())
        return false;

    if ((IsPeahead(mZombieType) || IsGatlinghead(mZombieType)) && IsGiga(mZombieType) && mApp->GetConfigCheckbox(true, CONFIG_CHECKBOX_GIGA_ABILITIES))
        return false;
...
bool Zombie::CanBeFrozen()
{
    ...
    return !IsBungee(mZombieType) || mZombiePhase == ZombiePhase::PHASE_BUNGEE_AT_BOTTOM;
}
...
bool Zombie::EffectedByDamage(unsigned int theDamageRangeFlags)
{
    ...
    else if (mMindControlled) return false;

    if (IsBungee(mZombieType) && mZombiePhase != ZombiePhase::PHASE_BUNGEE_AT_BOTTOM && mZombiePhase != ZombiePhase::PHASE_BUNGEE_GRABBING)
    {
    ...
    if (IsBobsled(mZombieType) && GetBobsledPosition() > 0)
    {
    ...
    if (!IsBobsled(mZombieType) && GetZombieRect().mX > WIDE_BOARD_WIDTH)
        return false;

    bool submerged = IsSnorkel(mZombieType) && mInPool && !mIsEating;
    ...
    if (TestBit(theDamageRangeFlags, (int)DamageRangeFlags::DAMAGES_ONLY_GROUND) && IsFlying())
        return false;

    if (TestBit(theDamageRangeFlags, (int)DamageRangeFlags::DAMAGES_FLYING) && IsFloating())
        return true;

    return TestBit(theDamageRangeFlags, (int)DamageRangeFlags::DAMAGES_GROUND) && !IsFloating() && !submerged && !underground;
}
...
void Zombie::RiseFromGrave(int theCol, int theRow)
{
    ...
    if (mBoard->StageHasWater())
    {
        ...
        if ((IsBasic(mZombieType) && (mHelmType == HELMTYPE_TRAFFIC_CONE || mHelmType == HELMTYPE_POT)) && aParticle)
            aBodyReanim->AttachParticleToTrack("anim_cone", aParticle, 37.0f, 20.0f);
        else if ((IsBasic(mZombieType) && mHelmType == HELMTYPE_PAIL) && aParticle)
...
{
    return
        IsBasic(theZombieType) 
        || theZombieType == ZombieType::ZOMBIE_SEAHORSE_POGO
        || IsWaterOnly(theZombieType);
}

bool Zombie::ZombieTypeCanGoOnHighGround(ZombieType theZombieType)
{
    return !IsBobsled(theZombieType) && !IsZomboni(theZombieType);
}
...
void Zombie::HitIceTrap()
{
    ...
    if (mInPool)
        aIceTrapTime = 300;
    else if (cold && !mApp->GetConfigCheckbox(true, CONFIG_CHECKBOX_CHILL_REBALANCE))
        aIceTrapTime = RandRangeInt(300, 400);
    mIceTrapCounter = max(aIceTrapTime, mIceTrapCounter);
    StopZombieSound();
    if (IsBalloon(mZombieType)) BalloonPropellerHatSpin(false);
...
void Zombie::HitIceTrapCustom(int theTime)
{
    bool cold = false;
    if ((mChilledCounter > 0 || mIceTrapCounter != 0) && !mApp->GetConfigCheckbox(true, CONFIG_CHECKBOX_CHILL_REBALANCE))
        cold = true;
    ApplyChill(true);
    if (!CanBeFrozen())
        return;
...
bool Zombie::IsSquashTarget(Plant* theExcept)
{
    ...
    while (mBoard->IteratePlants(aPlant))
    {
        if (aPlant != theExcept && (aPlant->mSeedType == SeedType::SEED_SQUASH || aPlant->mSeedType == SeedType::SEED_SPOOKYSQUASH) && aPlant->mTargetZombieID == anId)
            return true;
    }
...
void Zombie::RemoveButter()
{
    ...
    if (IsZombotany(mZombieType))
    {
        ...
        if (aHeadReanim)
        {
            if (IsPeahead(mZombieType) && aHeadReanim->IsAnimPlaying("anim_shooting"))
                aHeadReanim->mAnimRate = 35.0f;
            else if (IsGatlinghead(mZombieType) && aHeadReanim->IsAnimPlaying("anim_shooting"))
...
void Zombie::ApplyButter()
{
    ...
    if (IsZomboni(mZombieType) || mZombieType == ZombieType::ZOMBIE_BOSS || IsTangleKelpTarget() || IsBobsledTeamWithSled() || IsFloating())
        return;
    ...
    else if (IsZombotany(mZombieType))
    {
        Reanimation* aHeadReanim = mApp->ReanimationTryToGet(mSpecialHeadReanimID);
        if (aHeadReanim)
...
void Zombie::MowDown()
{
    ...
    if (mZombiePhase == ZombiePhase::PHASE_ZOMBIE_DYING || 
        ...
        IsGargantuar(mZombieType) || IsBungee(mZombieType) ||
        IsDigger(mZombieType) || IsImp(mZombieType) ||
        IsYeti(mZombieType) || IsDolphinRider(mZombieType) ||
        IsBobsledTeamWithSled() || 
        IsFlying() || 
        mInPool)
    {
    ...
    if (mZombieType == ZombieType::ZOMBIE_FLAG || mZombieType == ZombieType::ZOMBIE_RALLY)
        ...
        DropPole();
    else if (IsNewspaper(mZombieType) || IsBalloon(mZombieType))
        DropHead(0U);
    else if (IsPogo(mZombieType))
    {
        DropHead(0U);
...
void Zombie::ApplyBurn()
{
    ...
    else if (IsBungee(mZombieType) || IsYeti(mZombieType) || IsZombotany(mZombieType) || IsBobsledTeamWithSled() || IsFlying() || !mHasHead)
    {
        SetAnimRate(0.0f);
        Reanimation* aHeadReanim = mApp->ReanimationTryToGet(mSpecialHeadReanimID);
        if (aHeadReanim)
    ...
    else
    {
        ...
        if (IsBalloon(mZombieType)) aCharredPosY += 31.0f;
        if (IsImp(mZombieType))
        {
            aCharredPosX -= 6.0f;
        ...
        if (IsDigger(mZombieType))
        {
            if (IsWalkingBackwards()) aCharredPosX += 14.0f;
        ...
        if (mZombiePhase == ZombiePhase::PHASE_DIGGER_WALKING_WITHOUT_AXE) aCharredReanim->SetFramesForLayer("anim_crumble_noaxe");
        else if (IsDigger(mZombieType)) aCharredReanim->SetFramesForLayer("anim_crumble");
        else if (IsGargantuar(mZombieType) && !mHasObject)
        {
...
{
    const char* aTrackName = "anim_screendoor";
    Reanimation* aBodyReanim = mApp->ReanimationGet(mBodyReanimID);
    if (mShieldType == ShieldType::SHIELDTYPE_DOOR)
    {
        ShowDoorArms(true);
...
void Zombie::PlayDeathAnim(unsigned int theDamageFlags)
{
    ...
    // Kill Ding
    if (mHasHead && mApp->GetConfigCheckbox(false, CONFIG_CHECKBOX_KILL_SOUND)) mApp->PlayFoley(FoleyType::FOLEY_KILL_DING);
    ...
    if (IsDolphinRider(mZombieType) && mZombiePhase != ZombiePhase::PHASE_DOLPHIN_WALKING_IN_POOL)
    {
        DieNoLoot();
        return;
    }
    ...
    if (TestBit(theDamageFlags, (int)DamageFlags::DAMAGE_DOESNT_LEAVE_BODY))
    {
        if (mZombieType != ZombieType::ZOMBIE_BOSS && !IsGargantuar(mZombieType))
        {
            DieNoLoot();
            return;
        }
    ...
    if (IsPogo(mZombieType)) mAltitude = 0.0f;
    ...
    if (mShieldType != ShieldType::SHIELDTYPE_NONE)
        DropShield(1U);
    if (mArmorType != ArmorType::ARMORTYPE_NONE)
        DropArmor(1U);
    if (mZombieType == ZombieType::ZOMBIE_SQUASH_HEAD && !mHasHead)
    {
        mApp->RemoveReanimation(mSpecialHeadReanimID);
    ...
    bool aCanDoSuperLongDeath = mApp->HasFinishedAdventure() || mBoard->mLevel > DAY_LEVEL_INDEX + LEVEL_MID_AREA;
...
void Zombie::DoDaisies()
{
    ...
    if (IsMachine(mZombieType) || IsBobsled(mZombieType))
        return;
    ...
    if (IsDancerOrBackup(mZombieType) || IsFootball(mZombieType)) aOffsetX += 160.0f;
    else if (IsPogo(mZombieType)) aOffsetY += 120.0f;
    else if (IsBalloon(mZombieType))
    {
        aOffsetY += 30.0f;
        aOffsetX += 110.0f;
...
void Zombie::UpdateDeath()
{
    ...
    if (!mInPool)
    {
        float aFallTime;
        if (IsSnorkel(mZombieType)
            || IsZomboni(mZombieType)
            || IsDolphinRider(mZombieType)
            || IsBungee(mZombieType)
            || IsCatapult(mZombieType)
            || IsImp(mZombieType)
            || mZombieType == ZombieType::ZOMBIE_BOSS
            )
            aFallTime = -1.0f;
        else if (IsBasic(mZombieType))
        {
            ...
            aFallTime = 0.63f;
        else if (IsDancerOrBackup(mZombieType))
            aFallTime = 0.83f;
        else if (IsBobsled)
            aFallTime = 0.81f;
        else if (IsJack)
    ...
    if (IsZomboni(mZombieType) && mPhaseCounter > 0)
    {
        mPhaseCounter--;
        if (mPhaseCounter == 0)
        {
...
bool Zombie::HasShadow()
{
    if (mZombiePhase == ZombiePhase::PHASE_ZOMBIE_DYING ||
        ...
        mZombiePhase == ZombiePhase::PHASE_SNORKEL_INTO_POOL)
        return false;
    if (IsMachine(mZombieType) || mZombieType == ZombieType::ZOMBIE_BOSS)
        return false;
    if (IsBungee(mZombieType) && (!IsOnBoard() || mHitUmbrella))
        return false;
    if (mZombieHeight == ZombieHeight::HEIGHT_DRAGGED_UNDER ||
        mZombieHeight == ZombieHeight::HEIGHT_IN_TO_CHIMNEY ||
        mZombieHeight == ZombieHeight::HEIGHT_GETTING_BUNGEE_DROPPED)
...
bool Zombie::SetupDrawZombieWon(Graphics* g)
{
    ...
    case BackgroundType::BACKGROUND_DAY_FALL:
    case BackgroundType::BACKGROUND_DAY_WINTER:
    case BackgroundType::BACKGROUND_NIGHT_WINTER:
    case BackgroundType::BACKGROUND_DAY_SPRING:
    case BackgroundType::BACKGROUND_NIGHT_SPRING:
    case BackgroundType::BACKGROUND_RESORT:
    case BackgroundType::BACKGROUND_DEADPLANTS:
    case BackgroundType::BACKGROUND_HEAVEN:
        g->ClipRect(-123 - mX, -mY, BOARD_WIDTH, BOARD_HEIGHT);
        break;
    case BackgroundType::BACKGROUND_3_POOL:
    case BackgroundType::BACKGROUND_4_FOG:
    case BackgroundType::BACKGROUND_POOL_FALL:
    case BackgroundType::BACKGROUND_FOG_FALL:
    case BackgroundType::BACKGROUND_POOL_WINTER:
    case BackgroundType::BACKGROUND_FOG_WINTER:
    case BackgroundType::BACKGROUND_POOL_SPRING:
    case BackgroundType::BACKGROUND_FOG_SPRING:
        g->ClipRect(-172 - mX, -mY, BOARD_WIDTH, BOARD_HEIGHT);
        break;
    case BackgroundType::BACKGROUND_5_ROOF:
    case BackgroundType::BACKGROUND_6_BOSS:
    case BackgroundType::BACKGROUND_ROOF_FALL:
    case BackgroundType::BACKGROUND_MOON_FALL:
    case BackgroundType::BACKGROUND_ROOF_WINTER:
    case BackgroundType::BACKGROUND_MOON_WINTER:
    case BackgroundType::BACKGROUND_ROOF_SPRING:
    case BackgroundType::BACKGROUND_MOON_SPRING:
...
void Zombie::DrawShadow(Graphics* g)
{
    ...
    if (mZombieHeight == ZombieHeight::HEIGHT_UP_LADDER || mZombieHeight == ZombieHeight::HEIGHT_FALLING || 
        mZombiePhase == ZombiePhase::PHASE_IMP_GETTING_THROWN || IsBungee(mZombieType) || IsBouncingPogo() || IsFlying())
    {
...
{
    return IsAngel(mZombieType) || IsFloating();
}

bool Zombie::IsFloating()
{
...
void Zombie::WalkIntoHouse()
{
    ...
    if (mBoard->mBackground == BackgroundType::BACKGROUND_1_DAY || mBoard->mBackground == BackgroundType::BACKGROUND_2_NIGHT || 
        mBoard->mBackground == BackgroundType::BACKGROUND_DAY_FALL || mBoard->mBackground == BackgroundType::BACKGROUND_NIGHT_FALL ||
        mBoard->mBackground == BackgroundType::BACKGROUND_DAY_WINTER || mBoard->mBackground == BackgroundType::BACKGROUND_NIGHT_WINTER ||
        mBoard->mBackground == BackgroundType::BACKGROUND_DAY_SPRING || mBoard->mBackground == BackgroundType::BACKGROUND_NIGHT_SPRING ||
        mBoard->mBackground == BackgroundType::BACKGROUND_DEADPLANTS || mBoard->mBackground == BackgroundType::BACKGROUND_HEAVEN ||
        mBoard->mBackground == BackgroundType::BACKGROUND_3_POOL || mBoard->mBackground == BackgroundType::BACKGROUND_4_FOG ||
        mBoard->mBackground == BackgroundType::BACKGROUND_POOL_FALL || mBoard->mBackground == BackgroundType::BACKGROUND_FOG_FALL ||
        mBoard->mBackground == BackgroundType::BACKGROUND_POOL_WINTER || mBoard->mBackground == BackgroundType::BACKGROUND_FOG_WINTER ||
        mBoard->mBackground == BackgroundType::BACKGROUND_POOL_SPRING || mBoard->mBackground == BackgroundType::BACKGROUND_FOG_SPRING ||
        mBoard->mBackground == BackgroundType::BACKGROUND_RESORT)
    {
        mPosY = 290.0f;
    ...
    else if (mBoard->mBackground == BackgroundType::BACKGROUND_5_ROOF || mBoard->mBackground == BackgroundType::BACKGROUND_6_BOSS)
    {
        ...
        Reanimation* aBodyReanim = mApp->ReanimationTryToGet(mBodyReanimID);
        if (aBodyReanim && aBodyReanim->TrackExists("anim_idle") && !IsPole(mZombieType))
        {
...
void Zombie::BossSpawnContact()
{
    ...
    aZombie->mPosX = 560.0f + LAWN_XMIN;
}
...
void Zombie::BossDestroyFireballInRow(int theRow)
{
    //if (theRow != mFireballRow)  // 此判断在原版中被移动至调用处进行，故参数的 theRow 亦被删去
    //    return;
...
void Zombie::BossHeadSpitContact()
{
    ...
    if (mIsFireBall)
    {
        aFireBallReanim = mApp->AddReanimation(415.0f + LAWN_XMIN, aPosY, mRenderOrder + 1, ReanimationType::REANIM_BOSS_FIREBALL);
    ...
    {
        aFireBallReanim = mApp->AddReanimation(415.0f + LAWN_XMIN, aPosY, mRenderOrder + 1, ReanimationType::REANIM_BOSS_ICEBALL);
        aFireBallReanim->PlayReanim("anim_form", ReanimLoopType::REANIM_PLAY_ONCE_AND_HOLD, 0, 16.0f);
        aFireBallReanim->mIsAttachment = true;
...
void Zombie::BossSetupReanim()
{
    ...
    Reanimation* aHeadReanim = mApp->AddReanimation(0, 0, 0, ReanimationType::REANIM_BOSS_DRIVER);
...
void Zombie::PreloadZombieResources(ZombieType theZombieType)
{
    ...
    else if (theZombieType == ZombieType::ZOMBIE_BOSS)
    {
        ...
        ReanimatorEnsureDefinitionLoaded(ReanimationType::REANIM_ZOMBIE_BACKUP_DISCO, true);
    else if (theZombieType == ZombieType::ZOMBIE_GARGANTUAR || theZombieType == ZombieType::ZOMBIE_HELMET_GARGANTUAR)
    {
    ...
    else if (theZombieType == ZombieType::ZOMBIE_ANGEL_GARGANTUAR)
    {
        ReanimatorEnsureDefinitionLoaded(ReanimationType::REANIM_IMP, true);
        ReanimatorEnsureDefinitionLoaded(ReanimationType::REANIM_ZOMBIE_CHARRED_IMP, true);
        ReanimatorEnsureDefinitionLoaded(ReanimationType::REANIM_ZOMBIE_CHARRED_GARGANTUAR, true);
    }
    else if (theZombieType == ZombieType::ZOMBIE_GIGAGARGANTUAR)
    {
        ReanimatorEnsureDefinitionLoaded(ReanimationType::REANIM_IMP, true);
        ReanimatorEnsureDefinitionLoaded(ReanimationType::REANIM_ZOMBIE_CHARRED_IMP, true);
        ReanimatorEnsureDefinitionLoaded(ReanimationType::REANIM_ZOMBIE_CHARRED_GARGANTUAR, true);
    }
    else if (IsZomboni(theZombieType))
        ReanimatorEnsureDefinitionLoaded(ReanimationType::REANIM_ZOMBIE_CHARRED_ZAMBONI, true);
    else if (IsCatapult(theZombieType))
...
{
    if (mFromWave == Zombie::ZOMBIE_WAVE_UI && !IsGiga(mZombieType))
        return;

    if (!mHasHead || IsZombotany(mZombieType))
        return;
    ...
    if (theEnableMustache || IsGiga(mZombieType))
    {
...
{
    if (mFromWave == Zombie::ZOMBIE_WAVE_UI || IsZombotany(mZombieType))
        return;
    ...
    if (theEnableFuture)
    {
        Image* aImage = aImage = IMAGE_REANIM_ZOMBIE_HEAD_SUNGLASSES1;
...
// U53RDV
void Zombie::EnableDevMode(bool theEnableDevMode)
{
    if (mFromWave == Zombie::ZOMBIE_WAVE_UI || IsZombotany(mZombieType))
        return;
    ...
    if (theEnableDevMode)
    {
        aBodyReanim->SetImageOverride("anim_head1", IMAGE_REANIM_ZOMBIE_HEAD_SUNGLASSES1);
    }
    else
        aBodyReanim->SetImageOverride("anim_head1", nullptr);
}
...
void Zombie::EnableDance(bool theEnableDance)
{
    ...
    if (IsBasicCanDance(mZombieType))
        StartWalkAnim(0);
}
...
int Zombie::GetNumBackup(ZombieType theZombieType) {
    return IsDancerOrBackup(mZombieType) && IsGiga(mZombieType) && mApp->GetConfigCheckbox(true, CONFIG_CHECKBOX_GIGA_ABILITIES) ? NUM_BACKUP_DISCOS : NUM_BACKUP_DANCERS;
}

// Armor

int Zombie::TakeArmorDamage(int theDamage, unsigned int theDamageFlags)
{
    if (!TestBit(theDamageFlags, (int)DamageFlags::DAMAGE_DOESNT_CAUSE_FLASH))
    {
        mArmorJustGotShotCounter = 25;
        if (mJustGotShotCounter < 0)
        {
            mJustGotShotCounter = 0;
        }
    ...
    if (!TestBit(theDamageFlags, (int)DamageFlags::DAMAGE_DOESNT_CAUSE_FLASH) && !TestBit(theDamageFlags, (int)DamageFlags::DAMAGE_HITS_SHIELD_AND_BODY))
        mArmorRecoilCounter = 12;

    int aDamageIndexBeforeDamage = GetArmorDamageIndex();
    int aDamageActual = min(mArmorHealth, theDamage);
    int aDamageRemaining = theDamage - aDamageActual;
    mArmorHealth -= aDamageActual;
    if (mArmorHealth == 0)
    {
        DropArmor(theDamageFlags);
        return aDamageRemaining;
    }

    int aDamageIndexAfterDamage = GetArmorDamageIndex();
    if (aDamageIndexAfterDamage != aDamageIndexBeforeDamage)
    {
        Reanimation* aBodyReanim = mApp->ReanimationTryToGet(mBodyReanimID);
        if ((mArmorType == ArmorType::ARMORTYPE_COFFIN || mArmorType == ArmorType::ARMORTYPE_OUTHOUSE) && aDamageIndexAfterDamage == 1)
        {
            TOD_ASSERT(aBodyReanim);
            aBodyReanim->SetImageOverride("anim_screendoor", IMAGE_REANIM_ZOMBIE_SCREENDOOR2);
        }
...
int Zombie::GetArmorDamageIndex()
{
    if (mArmorHealth < mArmorMaxHealth / 3)
        return 2;
    if (mArmorHealth < mArmorMaxHealth * 2 / 3)
        return 1;
    return 0;
}

void Zombie::AttachArmor()
{
    const char* aTrackName = "anim_screendoor";
    Reanimation* aBodyReanim = mApp->ReanimationGet(mBodyReanimID);
    if (mArmorType == ArmorType::ARMORTYPE_COFFIN || mArmorType == ArmorType::ARMORTYPE_OUTHOUSE)
    {
        ShowDoorArms(true);
        ReanimShowPrefix("Zombie_outerarm_screendoor", RENDER_GROUP_OVER_SHIELD);
        aTrackName = "anim_screendoor";
...
//0x5330E0
void Zombie::DetachArmor()
{
    Reanimation* aBodyReanim = mApp->ReanimationTryToGet(mBodyReanimID);
    if (aBodyReanim)
    {
        if (mArmorType == ArmorType::ARMORTYPE_COFFIN)
            ShowDoorArms(false);
    }
...
void Zombie::DropArmor(unsigned int theDamageFlags)
{
    if (mArmorType == ArmorType::ARMORTYPE_NONE)
        return;
...
void Zombie::UpdateZombieGigaFootball() {
    if (mZombiePhase == ZombiePhase::PHASE_FOOTBALL_PRE_TACKLE) {
        Plant* aPlant = FindPlantTarget(ZombieAttackType::ATTACKTYPE_CHEW);
        if (aPlant && !aPlant->IsSpiky()) {
            SquishAllInSquare(aPlant->mPlantCol, aPlant->mRow, ZombieAttackType::ATTACKTYPE_CHEW);
            mZombiePhase = ZombiePhase::PHASE_FOOTBALL_IN_TACKLE;
            mPhaseCounter = 70;
        }
    }
    else if (mZombiePhase == ZombiePhase::PHASE_FOOTBALL_IN_TACKLE) {
        if (mPhaseCounter <= 0) {
            mZombiePhase = ZombiePhase::PHASE_FOOTBALL_STUNNED;
            mPhaseCounter = 300;
        }
    ...
    else if (mZombiePhase == ZombiePhase::PHASE_FOOTBALL_STUNNED) {
        if (mPhaseCounter <= 0) {
            mZombiePhase = ZombiePhase::PHASE_FOOTBALL_POST_TACKLE;
            StartWalkAnim(0);
        }
    }
}
...
{
    return mArmorMaxHealth + mBodyMaxHealth + mFlyingMaxHealth + mHelmMaxHealth + mShieldMaxHealth;
}

int Zombie::Health()
{
    return mArmorHealth + mBodyHealth + mFlyingHealth + mHelmHealth + mShieldHealth;
}

// Convert
ZombieType Zombie::ConvertZombieToGiga(ZombieType theZombieType, bool theIsGiga) {
    if (!theIsGiga) return theZombieType;
    switch (theZombieType) {
    case ZombieType::ZOMBIE_NORMAL: return ZombieType::ZOMBIE_MUSTACHE;
    case ZombieType::ZOMBIE_FLAG: return ZombieType::ZOMBIE_RALLY;
    case ZombieType::ZOMBIE_TRAFFIC_CONE: return ZombieType::ZOMBIE_GIGACONE;
    case ZombieType::ZOMBIE_POLEVAULTER: return ZombieType::ZOMBIE_GIGAVAULTER;
    case ZombieType::ZOMBIE_PAIL: return ZombieType::ZOMBIE_GIGABUCKET;
    case ZombieType::ZOMBIE_NEWSPAPER: return ZombieType::ZOMBIE_SUNDAY;
    case ZombieType::ZOMBIE_DOOR: return ZombieType::ZOMBIE_GIGADOOR;
    case ZombieType::ZOMBIE_COFFIN: return ZombieType::ZOMBIE_GIGACOFFIN;
    case ZombieType::ZOMBIE_OUTHOUSE: return ZombieType::ZOMBIE_GIGAOUTHOUSE;
    case ZombieType::ZOMBIE_FOOTBALL: return ZombieType::ZOMBIE_GIGAFOOTBALL;
    case ZombieType::ZOMBIE_DANCER: return ZombieType::ZOMBIE_DISCO;
    case ZombieType::ZOMBIE_BACKUP_DANCER: return ZombieType::ZOMBIE_BACKUP_DISCO;
    case ZombieType::ZOMBIE_SNORKEL: return ZombieType::ZOMBIE_GIGASNORKEL;
    case ZombieType::ZOMBIE_DOLPHIN_RIDER: return ZombieType::ZOMBIE_ORCA_RIDER;
    case ZombieType::ZOMBIE_BOBSLED: return ZombieType::ZOMBIE_GIGABOBSLED;
    case ZombieType::ZOMBIE_ZAMBONI: return ZombieType::ZOMBIE_GIGAZOMBONI;
    case ZombieType::ZOMBIE_JACK_IN_THE_BOX: return ZombieType::ZOMBIE_GIGAJACK;
    case ZombieType::ZOMBIE_BALLOON: return ZombieType::ZOMBIE_GIGABALLOON;
    case ZombieType::ZOMBIE_DIGGER: return ZombieType::ZOMBIE_GIGADIGGER;
    case ZombieType::ZOMBIE_POGO: return ZombieType::ZOMBIE_GIGAPOGO;
    case ZombieType::ZOMBIE_YETI: return ZombieType::ZOMBIE_BIGFOOT;
    case ZombieType::ZOMBIE_BUNGEE: return ZombieType::ZOMBIE_GIGABUNGEE;
    case ZombieType::ZOMBIE_LADDER: return ZombieType::ZOMBIE_GIGALADDER;
    case ZombieType::ZOMBIE_CATAPULT: return ZombieType::ZOMBIE_GIGACATAPULT;
    case ZombieType::ZOMBIE_GARGANTUAR: return ZombieType::ZOMBIE_GIGAGARGANTUAR;
    case ZombieType::ZOMBIE_IMP: return ZombieType::ZOMBIE_GIGAIMP;
    case ZombieType::ZOMBIE_PEA_HEAD: return ZombieType::ZOMBIE_SNOWPEA_HEAD;
    case ZombieType::ZOMBIE_WALLNUT_HEAD: return ZombieType::ZOMBIE_GIANTNUT_HEAD;
    case ZombieType::ZOMBIE_GATLING_HEAD: return ZombieType::ZOMBIE_ICEQUEEN_HEAD;
    case ZombieType::ZOMBIE_TALLNUT_HEAD: return ZombieType::ZOMBIE_VINENUT_HEAD;
    case ZombieType::ZOMBIE_SQUASH_HEAD: return ZombieType::ZOMBIE_EXPLODENUT_HEAD;
    case ZombieType::ZOMBIE_JALAPENO_HEAD: return ZombieType::ZOMBIE_PICKLED_HEAD;
    default: return theZombieType;
    }
}

// Get Type

Zombie* Zombie::FindRallyZombie() {
    Zombie* aZombie = nullptr;
    while (mBoard->IterateZombies(aZombie))
    {
        if (IsFlag(aZombie->mZombieType) && IsGiga(aZombie->mZombieType) && aZombie->mHasHead && !aZombie->IsImmobilizied())
            return aZombie;
    }
    return nullptr;
}

const bool Zombie::IsNormal(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_NORMAL
        || aZombieType == ZombieType::ZOMBIE_MUSTACHE
        || aZombieType == ZombieType::ZOMBIE_ANGEL
        ;
}

const bool Zombie::IsFlag(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_FLAG
        || aZombieType == ZombieType::ZOMBIE_RALLY
        || aZombieType == ZombieType::ZOMBIE_ANGEL_FLAG
        ;
}

const bool Zombie::IsCone(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_TRAFFIC_CONE
        || aZombieType == ZombieType::ZOMBIE_GIGACONE
        || IsCoffin(aZombieType)
        || aZombieType == ZombieType::ZOMBIE_ANGEL_CONE
        ;
}

const bool Zombie::IsPole(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_POLEVAULTER 
        || aZombieType == ZombieType::ZOMBIE_GIGAVAULTER;
}

const bool Zombie::IsBucket(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_PAIL
        || aZombieType == ZombieType::ZOMBIE_GIGABUCKET
        || IsOuthouse(aZombieType)
        || aZombieType == ZombieType::ZOMBIE_ANGEL_BUCKET
        ;
}

const bool Zombie::IsNewspaper(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_NEWSPAPER 
        || aZombieType == ZombieType::ZOMBIE_SUNDAY
        ;
}

const bool Zombie::IsDoor(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_DOOR
        || aZombieType == ZombieType::ZOMBIE_GIGADOOR
        ;
}

const bool Zombie::IsFootball(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_FOOTBALL 
        || aZombieType == ZombieType::ZOMBIE_GIGAFOOTBALL
        ;
}

const bool Zombie::IsDancer(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_DANCER 
        || aZombieType == ZombieType::ZOMBIE_DISCO
        ;
}

const bool Zombie::IsBackup(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_BACKUP_DANCER 
        || aZombieType == ZombieType::ZOMBIE_BACKUP_DISCO
        ;
}

const bool Zombie::IsSnorkel(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_SNORKEL 
        || aZombieType == ZombieType::ZOMBIE_GIGASNORKEL
        ;
}

const bool Zombie::IsZomboni(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_ZAMBONI 
        || aZombieType == ZombieType::ZOMBIE_GIGAZOMBONI
        ;
}

const bool Zombie::IsBobsled(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_BOBSLED 
        || aZombieType == ZombieType::ZOMBIE_GIGABOBSLED
        ;
}

const bool Zombie::IsDolphinRider(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_DOLPHIN_RIDER 
        || aZombieType == ZombieType::ZOMBIE_ORCA_RIDER
        ;
}

const bool Zombie::IsJack(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_JACK_IN_THE_BOX 
        || aZombieType == ZombieType::ZOMBIE_GIGAJACK
        ;
}

const bool Zombie::IsBalloon(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_BALLOON 
        || aZombieType == ZombieType::ZOMBIE_GIGABALLOON
        ;
}

const bool Zombie::IsDigger(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_DIGGER 
        || aZombieType == ZombieType::ZOMBIE_GIGADIGGER
        ;
}

const bool Zombie::IsPogo(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_POGO 
        || aZombieType == ZombieType::ZOMBIE_GIGAPOGO
        || aZombieType == ZombieType::ZOMBIE_SEAHORSE_POGO
        ;
}

const bool Zombie::IsYeti(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_YETI 
        || aZombieType == ZombieType::ZOMBIE_BIGFOOT
        ;
}

const bool Zombie::IsBungee(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_BUNGEE 
        || aZombieType == ZombieType::ZOMBIE_GIGABUNGEE
        ;
}

const bool Zombie::IsLadder(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_LADDER 
        || aZombieType == ZombieType::ZOMBIE_GIGALADDER
        ;
}

const bool Zombie::IsCatapult(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_CATAPULT 
        || aZombieType == ZombieType::ZOMBIE_GIGACATAPULT
        ;
}

const bool Zombie::IsGargantuar(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_GARGANTUAR 
        || aZombieType == ZombieType::ZOMBIE_GIGAGARGANTUAR
        || aZombieType == ZombieType::ZOMBIE_HELMET_GARGANTUAR
        || aZombieType == ZombieType::ZOMBIE_ANGEL_GARGANTUAR
        ;
}

const bool Zombie::IsImp(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_IMP 
        || aZombieType == ZombieType::ZOMBIE_GIGAIMP
        || aZombieType == ZombieType::ZOMBIE_ANGEL_IMP
        ;
}

const bool Zombie::IsCoffin(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_COFFIN
        || aZombieType == ZombieType::ZOMBIE_GIGACOFFIN
        ;
}

const bool Zombie::IsOuthouse(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_OUTHOUSE
        || aZombieType == ZombieType::ZOMBIE_GIGAOUTHOUSE
        ;
}

const bool Zombie::IsHelmet(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_HELMET_GARGANTUAR
        ;
}

const bool Zombie::IsTalisman(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_TALISMAN
        ;
}

const bool Zombie::IsPeahead(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_PEA_HEAD
        || aZombieType == ZombieType::ZOMBIE_SNOWPEA_HEAD
        ;
}

const bool Zombie::IsWallnuthead(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_WALLNUT_HEAD
        || aZombieType == ZombieType::ZOMBIE_GIANTNUT_HEAD
        ;
}

const bool Zombie::IsTallnuthead(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_TALLNUT_HEAD
        || aZombieType == ZombieType::ZOMBIE_VINENUT_HEAD
        ;
}

const bool Zombie::IsGatlinghead(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_GATLING_HEAD
        || aZombieType == ZombieType::ZOMBIE_ICEQUEEN_HEAD
        ;
}

const bool Zombie::IsSquashhead(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_SQUASH_HEAD
        || aZombieType == ZombieType::ZOMBIE_EXPLODENUT_HEAD
        ;
}

const bool Zombie::IsJalapenohead(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_JALAPENO_HEAD
        || aZombieType == ZombieType::ZOMBIE_PICKLED_HEAD
        ;
}

bool Zombie::IsZombotany(int theZombieType)
{
    return
        IsPeahead(theZombieType)
        || IsWallnuthead(theZombieType)
        || IsTallnuthead(theZombieType)
        || IsJalapenohead(theZombieType)
        || IsGatlinghead(theZombieType)
        || IsSquashhead(theZombieType)
        ;
}

const bool Zombie::CanSquish(int aZombieType) {
    return gLawnApp->IsDeadplantsLevel() || (IsGiga(aZombieType) && IsWallnuthead(aZombieType));
}

const bool Zombie::IsMachine(int aZombieType) {
    return
        IsZomboni(aZombieType) 
        || IsCatapult(aZombieType)
        ;
}

const bool Zombie::NoEat(int aZombieType) {
    return
        IsGargantuar(aZombieType) 
        || IsBungee(aZombieType) 
        || IsMachine(aZombieType)
        ;
}

const bool Zombie::IsDancerOrBackup(int aZombieType) {
    return
        IsDancer(aZombieType) 
        || IsBackup(aZombieType)
        ;
}

const bool Zombie::IsWaterOnly(int aZombieType) {
    return
        IsSnorkel(aZombieType) 
        || IsDolphinRider(aZombieType)
        ;
}

const bool Zombie::IsBasic(int aZombieType) {
    return
        IsBasicCanDance(aZombieType) 
        || IsDoor(aZombieType)
        ;
}

const bool Zombie::IsBasicCanDance(int aZombieType) {
    return
        IsZombotany(aZombieType)
        || IsNormal(aZombieType)
        || IsFlag(aZombieType)
        || IsCone(aZombieType)
        || IsBucket(aZombieType)
        || aZombieType == ZombieType::ZOMBIE_DUCKY_TUBE
        ;
}

const bool Zombie::IsGiga(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_MUSTACHE
        || aZombieType == ZombieType::ZOMBIE_RALLY
        || aZombieType == ZombieType::ZOMBIE_GIGACONE
...
const bool Zombie::IsAngel(int aZombieType) {
    return
        aZombieType == ZombieType::ZOMBIE_ANGEL
        || aZombieType == ZombieType::ZOMBIE_ANGEL_FLAG
        || aZombieType == ZombieType::ZOMBIE_ANGEL_CONE
...
const bool Zombie::IsMinecraft(int aZombieType) {
    return
        IsMinecraftZombie(aZombieType)
        || IsMinecraftSkeleton(aZombieType)
        || aZombieType == ZombieType::MC_SPIDER
        || aZombieType == ZombieType::MC_CREEPER
        ;
}

const bool Zombie::IsMinecraftZombie(int aZombieType) {
    return
        aZombieType == ZombieType::MC_ZOMBIE
        || aZombieType == ZombieType::MC_ZOMBIE_LEATHER
        || aZombieType == ZombieType::MC_ZOMBIE_IRON
        || aZombieType == ZombieType::MC_BABYZOMBIE
        || aZombieType == ZombieType::MC_BABYZOMBIE_LEATHER
        || aZombieType == ZombieType::MC_BABYZOMBIE_IRON
        ;
}

const bool Zombie::IsMinecraftBaby(int aZombieType) {
    return
        aZombieType == ZombieType::MC_BABYZOMBIE
        || aZombieType == ZombieType::MC_BABYZOMBIE_LEATHER
        || aZombieType == ZombieType::MC_BABYZOMBIE_IRON
...
const bool Zombie::IsMinecraftSkeleton(int aZombieType) {
    return
        aZombieType == ZombieType::MC_SKELETON
        || aZombieType == ZombieType::MC_SKELETON_LEATHER
        || aZombieType == ZombieType::MC_SKELETON_IRON
        ;
}

const bool Zombie::IsMinecraftLeather(int aZombieType) {
    return
        aZombieType == ZombieType::MC_ZOMBIE_LEATHER
        || aZombieType == ZombieType::MC_SKELETON_IRON
        ;
...
const bool Zombie::IsMinecraftIron(int aZombieType) {
    return
        aZombieType == ZombieType::MC_ZOMBIE_IRON
        || aZombieType == ZombieType::MC_SKELETON_IRON
        ;
