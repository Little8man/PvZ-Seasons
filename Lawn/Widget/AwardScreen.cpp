...
AwardScreen::AwardScreen(LawnApp* theApp, AwardType theAwardType)
{
    ...
    mStartButton->Resize(-76 + BOARD_XCENTER, 200 + BOARD_YCENTER, 156, 42);
    ...
    mMenuButton->Resize(-123 + BOARD_WIDTH, 16, 111, 26);
    ...
    if (mAwardType == AWARD_CREDITS_ZOMBIENOTE)
    {
        ...
        mStartButton->mColors[ButtonWidget::COLOR_LABEL_HILITE] = Color(213, 159, 43);
        mStartButton->Resize(-75 + BOARD_XCENTER, 205 + BOARD_YCENTER, 190, 73);
...
void AwardScreen::DrawBottom(Graphics* g, const SexyString& theTitle, const SexyString& theAward, const SexyString& theMessage)
{
    ...
    TodDrawString(g, theTitle, BOARD_XCENTER, -242 + BOARD_YCENTER, Sexy::FONT_DWARVENTODCRAFT24, Color(213, 159, 43), DS_ALIGN_CENTER);
    TodDrawString(g, theAward, BOARD_XCENTER, 26 + BOARD_YCENTER, Sexy::FONT_DWARVENTODCRAFT18YELLOW, Color::White, DS_ALIGN_CENTER);
    TodDrawStringWrapped(g, theMessage, Rect(-115 + BOARD_XCENTER, 60 + BOARD_YCENTER, 230, 90), Sexy::FONT_BRIANNETOD16, Color(40, 50, 90), DS_ALIGN_CENTER_VERTICAL_MIDDLE);
}
...
void AwardScreen::DrawAwardSeed(Graphics* g)
{
    ...
    g->SetScale(2, 2, -50 + BOARD_XCENTER, -171 + BOARD_YCENTER);
    DrawSeedPacket(g, -50 + BOARD_XCENTER, -171 + BOARD_YCENTER, aSeedType, SEED_NONE, 0, 255, true, false);
    g->SetScale(1, 1, 0, 0);
}
