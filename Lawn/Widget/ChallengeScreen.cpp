...
ChallengeDefinition gChallengeDefs[NUM_CHALLENGE_MODES] = {
	...
	{	GameMode::GAMEMODE_SURVIVAL_NORMAL_DAY_FALL,			0,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_FALL,	0,  0,  _S("[SURVIVAL_DAY_FALL_NORMAL]") },
	{	GameMode::GAMEMODE_SURVIVAL_NORMAL_NIGHT_FALL,			1,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_FALL,	0,  1,  _S("[SURVIVAL_NIGHT_FALL_NORMAL]") },
	{	GameMode::GAMEMODE_SURVIVAL_NORMAL_POOL_FALL,			2,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_FALL,	0,  2,  _S("[SURVIVAL_POOL_FALL_NORMAL]") },
	{	GameMode::GAMEMODE_SURVIVAL_NORMAL_FOG_FALL,			3,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_FALL,	0,  3,  _S("[SURVIVAL_FOG_FALL_NORMAL]") },
	{	GameMode::GAMEMODE_SURVIVAL_NORMAL_ROOF_FALL,			4,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_FALL,	0,  4,	_S("[SURVIVAL_ROOF_FALL_NORMAL]") },
	{	GameMode::GAMEMODE_SURVIVAL_NORMAL_MOON_FALL,			4,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_FALL,	0,  5,	_S("[SURVIVAL_MOON_FALL_NORMAL]") },
	{	GameMode::GAMEMODE_SURVIVAL_NORMAL_DAY_WINTER,			0,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_WINTER,	0,  0,  _S("[SURVIVAL_DAY_WINTER_NORMAL]") },
	{	GameMode::GAMEMODE_SURVIVAL_NORMAL_NIGHT_WINTER,		1,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_WINTER,	0,  1,  _S("[SURVIVAL_NIGHT_WINTER_NORMAL]") },
	{	GameMode::GAMEMODE_SURVIVAL_NORMAL_POOL_WINTER,			2,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_WINTER,	0,  2,  _S("[SURVIVAL_POOL_WINTER_NORMAL]") },
	{	GameMode::GAMEMODE_SURVIVAL_NORMAL_FOG_WINTER,			3,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_WINTER,	0,  3,  _S("[SURVIVAL_FOG_WINTER_NORMAL]") },
	{	GameMode::GAMEMODE_SURVIVAL_NORMAL_ROOF_WINTER,			4,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_WINTER,	0,	4,	_S("[SURVIVAL_ROOF_WINTER_NORMAL]") },
	{	GameMode::GAMEMODE_SURVIVAL_NORMAL_MOON_WINTER,			4,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_WINTER,	0,  5,	_S("[SURVIVAL_MOON_WINTER_NORMAL]") },
	{	GameMode::GAMEMODE_SURVIVAL_NORMAL_DAY_SPRING,			0,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_SPRING,	0,  0,  _S("[SURVIVAL_DAY_SPRING_NORMAL]") },
	{	GameMode::GAMEMODE_SURVIVAL_NORMAL_NIGHT_SPRING,		1,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_SPRING,	0,  1,  _S("[SURVIVAL_NIGHT_SPRING_NORMAL]") },
	{	GameMode::GAMEMODE_SURVIVAL_NORMAL_POOL_SPRING,			2,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_SPRING,	0,  2,  _S("[SURVIVAL_POOL_SPRING_NORMAL]") },
	{	GameMode::GAMEMODE_SURVIVAL_NORMAL_FOG_SPRING,			3,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_SPRING,	0,  3,  _S("[SURVIVAL_FOG_SPRING_NORMAL]") },
	{	GameMode::GAMEMODE_SURVIVAL_NORMAL_ROOF_SPRING,			4,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_SPRING,	0,  4,	_S("[SURVIVAL_ROOF_SPRING_NORMAL]") },
	{	GameMode::GAMEMODE_SURVIVAL_NORMAL_MOON_SPRING,			4,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_SPRING,	0,  5,	_S("[SURVIVAL_MOON_SPRING_NORMAL]") },
	{	GameMode::GAMEMODE_SURVIVAL_HARD_MOON,					9,	ChallengePage::CHALLENGE_PAGE_SURVIVAL,			1,	5,	_S("[SURVIVAL_MOON_HARD]") },
	{	GameMode::GAMEMODE_SURVIVAL_HARD_DAY_FALL,				5,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_FALL,	1,  0,  _S("[SURVIVAL_DAY_FALL_HARD]") },
	{	GameMode::GAMEMODE_SURVIVAL_HARD_NIGHT_FALL,			6,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_FALL,	1,  1,  _S("[SURVIVAL_NIGHT_FALL_HARD]") },
	{	GameMode::GAMEMODE_SURVIVAL_HARD_POOL_FALL,				7,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_FALL,	1,  2,  _S("[SURVIVAL_POOL_FALL_HARD]") },
	{	GameMode::GAMEMODE_SURVIVAL_HARD_FOG_FALL,				8,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_FALL,	1,  3,  _S("[SURVIVAL_FOG_FALL_HARD]") },
	{	GameMode::GAMEMODE_SURVIVAL_HARD_ROOF_FALL,				9,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_FALL,	1,  4,	_S("[SURVIVAL_ROOF_FALL_HARD]") },
	{	GameMode::GAMEMODE_SURVIVAL_HARD_MOON_FALL,				9,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_FALL,	1,	5,	_S("[SURVIVAL_MOON_FALL_HARD]") },
	{	GameMode::GAMEMODE_SURVIVAL_HARD_DAY_WINTER,			5,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_WINTER,	1,	0,  _S("[SURVIVAL_DAY_WINTER_HARD]") },
	{	GameMode::GAMEMODE_SURVIVAL_HARD_NIGHT_WINTER,			6,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_WINTER,	1,  1,  _S("[SURVIVAL_NIGHT_WINTER_HARD]") },
	{	GameMode::GAMEMODE_SURVIVAL_HARD_POOL_WINTER,			7,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_WINTER,	1,  2,  _S("[SURVIVAL_POOL_WINTER_HARD]") },
	{	GameMode::GAMEMODE_SURVIVAL_HARD_FOG_WINTER,			8,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_WINTER,	1,  3,  _S("[SURVIVAL_FOG_WINTER_HARD]") },
	{	GameMode::GAMEMODE_SURVIVAL_HARD_ROOF_WINTER,			9,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_WINTER,	1,  4,	_S("[SURVIVAL_ROOF_WINTER_HARD]") },
	{	GameMode::GAMEMODE_SURVIVAL_HARD_MOON_WINTER,			9,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_WINTER,	1,	5,	_S("[SURVIVAL_MOON_WINTER_HARD]") },
	{	GameMode::GAMEMODE_SURVIVAL_HARD_DAY_SPRING,			5,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_SPRING,	1,  0,  _S("[SURVIVAL_DAY_SPRING_HARD]") },
	{	GameMode::GAMEMODE_SURVIVAL_HARD_NIGHT_SPRING,			6,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_SPRING,	1,  1,  _S("[SURVIVAL_NIGHT_SPRING_HARD]") },
	{	GameMode::GAMEMODE_SURVIVAL_HARD_POOL_SPRING,			7,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_SPRING,	1,  2,  _S("[SURVIVAL_POOL_SPRING_HARD]") },
	{	GameMode::GAMEMODE_SURVIVAL_HARD_FOG_SPRING,			8,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_SPRING,	1,  3,  _S("[SURVIVAL_FOG_SPRING_HARD]") },
	{	GameMode::GAMEMODE_SURVIVAL_HARD_ROOF_SPRING,			9,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_SPRING,	1,  4,	_S("[SURVIVAL_ROOF_SPRING_HARD]") },
	{	GameMode::GAMEMODE_SURVIVAL_HARD_MOON_SPRING,			9,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_SPRING,	1,	5,	_S("[SURVIVAL_MOON_SPRING_HARD]") },
	{	GameMode::GAMEMODE_SURVIVAL_ENDLESS_MOON,				10,	ChallengePage::CHALLENGE_PAGE_SURVIVAL,			2,  5,  _S("[SURVIVAL_MOON_ENDLESS]") },
	{	GameMode::GAMEMODE_SURVIVAL_ENDLESS_DAY_FALL,			10,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_FALL,	2,  0,  _S("[SURVIVAL_DAY_FALL_ENDLESS]") },
	{	GameMode::GAMEMODE_SURVIVAL_ENDLESS_NIGHT_FALL,			10,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_FALL,	2,  1,  _S("[SURVIVAL_NIGHT_FALL_ENDLESS]") },
	{	GameMode::GAMEMODE_SURVIVAL_ENDLESS_POOL_FALL,			10,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_FALL,	2,  2,  _S("[SURVIVAL_POOL_FALL_ENDLESS]") },
	{	GameMode::GAMEMODE_SURVIVAL_ENDLESS_FOG_FALL,			10,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_FALL,	2,  3,  _S("[SURVIVAL_FOG_FALL_ENDLESS]") },
	{	GameMode::GAMEMODE_SURVIVAL_ENDLESS_ROOF_FALL,			10,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_FALL,	2,  4,	_S("[SURVIVAL_ROOF_FALL_ENDLESS]") },
	{	GameMode::GAMEMODE_SURVIVAL_ENDLESS_MOON_FALL,			10,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_FALL,	2,  5,	_S("[SURVIVAL_MOON_FALL_ENDLESS]") },
	{	GameMode::GAMEMODE_SURVIVAL_ENDLESS_DAY_WINTER,			10,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_WINTER,	2,	0,  _S("[SURVIVAL_DAY_WINTER_ENDLESS]") },
	{	GameMode::GAMEMODE_SURVIVAL_ENDLESS_NIGHT_WINTER,		10,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_WINTER,	2,	1,  _S("[SURVIVAL_NIGHT_WINTER_ENDLESS]") },
	{	GameMode::GAMEMODE_SURVIVAL_ENDLESS_POOL_WINTER,		10,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_WINTER,	2,	2,  _S("[SURVIVAL_POOL_WINTER_ENDLESS]") },
	{	GameMode::GAMEMODE_SURVIVAL_ENDLESS_FOG_WINTER,			10,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_WINTER,	2,	3,  _S("[SURVIVAL_FOG_WINTER_ENDLESS]") },
	{	GameMode::GAMEMODE_SURVIVAL_ENDLESS_ROOF_WINTER,		10,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_WINTER,	2,	4,	_S("[SURVIVAL_ROOF_WINTER_ENDLESS]") },
	{	GameMode::GAMEMODE_SURVIVAL_ENDLESS_MOON_WINTER,		10,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_WINTER,	2,	5,	_S("[SURVIVAL_MOON_WINTER_ENDLESS]") },
	{	GameMode::GAMEMODE_SURVIVAL_ENDLESS_DAY_SPRING,			10,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_SPRING,	2,	0,  _S("[SURVIVAL_DAY_SPRING_ENDLESS]") },
	{	GameMode::GAMEMODE_SURVIVAL_ENDLESS_NIGHT_SPRING,		10,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_SPRING,	2,	1,  _S("[SURVIVAL_NIGHT_SPRING_ENDLESS]") },
	{	GameMode::GAMEMODE_SURVIVAL_ENDLESS_POOL_SPRING,		10,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_SPRING,	2,	2,  _S("[SURVIVAL_POOL_SPRING_ENDLESS]") },
	{	GameMode::GAMEMODE_SURVIVAL_ENDLESS_FOG_SPRING,			10,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_SPRING,	2,	3,  _S("[SURVIVAL_FOG_SPRING_ENDLESS]") },
	{	GameMode::GAMEMODE_SURVIVAL_ENDLESS_ROOF_SPRING,		10,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_SPRING,	2,	4,	_S("[SURVIVAL_ROOF_SPRING_ENDLESS]") },
	{	GameMode::GAMEMODE_SURVIVAL_ENDLESS_MOON_SPRING,		10,	ChallengePage::CHALLENGE_PAGE_SURVIVAL_SPRING,	2,	5,	_S("[SURVIVAL_MOON_SPRING_ENDLESS]") },
...
ChallengeScreen::ChallengeScreen(LawnApp* theApp, ChallengePage thePage)
{
	...
	for (int aPageIdx = CHALLENGE_PAGE_SURVIVAL; aPageIdx < MAX_CHALLENGE_PAGES; aPageIdx++)
	{
		...
		if (!ShowPageButtons() || (IsSurvivalPage(aPageIdx) != IsSurvivalPage(mPageIndex)) || aPageIdx == CHALLENGE_PAGE_PUZZLE)
	...
	if (IsSurvivalPage(mPageIndex) && mApp->mPlayerInfo->mHasNewSurvival)
	{
...
int ChallengeScreen::MoreTrophiesNeeded(int theChallengeIndex)
{
	...
	if (mApp->IsTrialStageLocked())
	{
		...
		else if (IsSurvivalPage(mPageIndex) && aDef.mChallengeMode >= GAMEMODE_SURVIVAL_NORMAL_STAGE_4)
		{
	...
	else
	{
		...
		if ((aDef.mPage == CHALLENGE_PAGE_CHALLENGE || IsSurvivalPage(aDef.mPage)) && !mApp->HasFinishedAdventure())
		{
		...
		else
		{
			...
			if (IsSurvivalPage(aDef.mPage) || aDef.mPage == CHALLENGE_PAGE_CHALLENGE)
			{
				aNumTrophies += 3;
			}
			else
...
{
	return mApp->mTodCheatKeys && mPageIndex != CHALLENGE_PAGE_PUZZLE;
}
...
void ChallengeScreen::UpdateButtons()
{
	for (int aChallengeMode = 0; aChallengeMode < NUM_CHALLENGE_MODES; aChallengeMode++)
	{
		...
		if (IsSurvivalPage(aChlDef.mPage))
		{
...
int ChallengeScreen::AccomplishmentsNeeded(int theChallengeIndex)
{
	...
	if (mApp->IsSurvivalEndless(aGameMode) && aTrophiesNeeded <= 3 && mApp->GetNumTrophies(mPageIndex) < 10 &&
	...
	if (aChallengeButton->mVisible)
	{
		...
		if (AccomplishmentsNeeded(theChallengeIndex) <= 1)
		{
			...
			else
			{
				...
				int aHalfPos = (IsSurvivalPage(mPageIndex) && !aChallengeButton->mDisabled) ? 7 : (aNameLen / 2 - 1);
...
void ChallengeScreen::Draw(Graphics* g)
{
	...
	SexyString aTitleString = 
		IsSurvivalPage(mPageIndex) ? _S("[PICK_AREA]") : 
	...
	int aTrophiesTotal = IsSurvivalPage(mPageIndex) ? SURVIVAL_TROPHIES
...
void ChallengeScreen::ButtonDepress(int theId)
{
	...
	if (aPageIndex >= 0 && aPageIndex < ChallengePage::MAX_CHALLENGE_PAGES)
	{
	...
	for (int aChallengeMode = 0; aChallengeMode < NUM_CHALLENGE_MODES; aChallengeMode++)
	{
			...
			AccomplishmentsNeeded(aChallengeMode) <= 1)
		{
			...
			if (MoreTrophiesNeeded(aChallengeMode) > 0)
			{
				...
				else if (IsSurvivalPage(mPageIndex))
				{
...
bool ChallengeScreen::IsSurvivalPage(int thePage)
{
	return thePage == ChallengePage::CHALLENGE_PAGE_SURVIVAL
		|| thePage == ChallengePage::CHALLENGE_PAGE_SURVIVAL_FALL
		|| thePage == ChallengePage::CHALLENGE_PAGE_SURVIVAL_WINTER
		|| thePage == ChallengePage::CHALLENGE_PAGE_SURVIVAL_SPRING
		;
}
