...
void PlayerInfo::SyncDetails(DataSync& theSync)
{
	...
	for (int i = 0; i < sizeof(mConfigCheckbox); i++)
	{
		theSync.SyncBool(mConfigCheckbox[i]);
	}
...
void PlayerInfo::ResetConfig() 
{
	memset(mConfigCheckbox, false, sizeof(mConfigCheckbox));
	mConfigCheckbox[CONFIG_CHECKBOX_COFFEE_BOOST] = true;
	mConfigCheckbox[CONFIG_CHECKBOX_INDEPENDANT_UPGRADES] = true;
	mConfigCheckbox[CONFIG_CHECKBOX_NEW_PLANTS] = true;
	mConfigCheckbox[CONFIG_CHECKBOX_NERF_DOOM] = true;
	mConfigCheckbox[CONFIG_CHECKBOX_SLOT_HOTKEYS] = true;
	mConfigCheckbox[CONFIG_CHECKBOX_HOLD_TO_COLLECT] = true;
	mConfigCheckbox[CONFIG_CHECKBOX_GIGA_ABILITIES] = true;
	mConfigCheckbox[CONFIG_CHECKBOX_CHILL_REBALANCE] = true;
	// Inflation
	mConfigCheckbox[CONFIG_CHECKBOX_SUN_AMOUNT] = true;
	mConfigCheckbox[CONFIG_CHECKBOX_COIN_AMOUNT] = true;
}
