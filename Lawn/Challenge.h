...
constexpr const int SLOT_MACHINE_WINNING_SCORE = 160;
constexpr const int ZOMBIQUARIUM_WINNING_SCORE = 80;
...
public:
    ...
    // Wallnut Endless
    void                    InitZombieWavesWallnutSurvival();
    // Zombotany Survival
    void                    InitZombieWavesZombotanySurvival();
    // Chaos Endless
    void                    InitZombieWavesChaosSurvival();
};
