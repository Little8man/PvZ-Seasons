...
#define SUNNY_MULTIPLIER 0.5f
#define ECLIPSE_MULTIPLIER 2.0f
...
public:
	...
	void							KillAllPlantsInRadius(int theX, int theY, int theRadius, int theDamage);
	...
	void							KillAllZombiesInRadius(int theRow, int theX, int theY, int theRadius, int theRowRange, bool theBurn, int theDamage, int theDamageRangeFlags, unsigned int theDamageFlags);
	...
	const bool						IsLastStandFinalStage();
	...
	// Burn
	void							KillZombieRow(int theRow, bool theBurn, int theDamage, int theDamageRangeFlags, unsigned int theDamageFlags);
	void							KillZombieCol(int theCol, bool theBurn, int theDamage, int theDamageRangeFlags, unsigned int theDamageFlags);
	void							KillZombieColFromPixel(int theX, int theY, bool theBurn, int theDamage, int theDamageRangeFlags, unsigned int theDamageFlags);
	void							KillPlantRow(int theRow, int theDamage);
	void							KillPlantCol(int theCol, int theDamage);
	void							KillPlantColFromPixel(int theX, int theY, int theDamage);
	// Warming
	Plant*							FindWarmPlant(int theGridX, int theGridY);
	// Stage
		// Eclipse
	bool							StageHasSun();
		// Heaven
	bool							StageIsSunny();
		// Seasons
	/*inline*/ bool					StageHasEclipse();
	/*inline*/ bool					StageHasTiles();
	/*inline*/ bool					StageHasStream();
	/*inline*/ bool					StageIsFlooded();
	/*inline*/ bool					StageHasWater();
	/*inline*/ bool					StageHasGraveDanger();
	/*inline*/ bool					StageHasRain();
	/*inline*/ bool					StageHasStorm();
	/*inline*/ bool					StageIsFall();
	/*inline*/ bool					StageIsWinter();
	/*inline*/ bool					StageIsSpring();
	/*inline*/ bool					IsTileSquare(int theGridX, int theGridY);
	// Easter Eggs
	void							SetDevMode(bool theEnableDevMode);
	// Shadow Sunflower
	void							AddShadowSunMoney(int theAmount);
	int								CountShadowSunBeingCollected();
	bool							TakeShadowSunMoney(int theAmount);
	bool							CanTakeShadowSunMoney(int theAmount);
	// Pots
	Plant*							GetWaterPotAt(int theGridX, int theGridY);
	Plant*							GetCoffeePotAt(int theGridX, int theGridY);
	// Slot Hotkeys
	virtual void					KeyDownSeedbank(KeyCode theKey);
