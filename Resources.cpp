...
bool Sexy::ExtractResourcesByName(ResourceManager* theResourceManager, const char* theName)
{
	...
	// New
	else if (!strcmp(theName, "DelayLoad_BackgroundR"))			return ExtractDelayLoad_BackgroundRResources(theResourceManager);
	else if (!strcmp(theName, "DelayLoad_BackgroundE"))			return ExtractDelayLoad_BackgroundEResources(theResourceManager);
	else if (!strcmp(theName, "DelayLoad_BackgroundD"))			return ExtractDelayLoad_BackgroundDResources(theResourceManager);
	else if (!strcmp(theName, "DelayLoad_BackgroundH"))			return ExtractDelayLoad_BackgroundHResources(theResourceManager);
	else if (!strcmp(theName, "DelayLoad_BackgroundFog"))		return ExtractDelayLoad_BackgroundFogResources(theResourceManager);
	else if (!strcmp(theName, "DelayLoad_BackgroundM"))			return ExtractDelayLoad_BackgroundMResources(theResourceManager);
	else if (!strcmp(theName, "DelayLoad_Background1W"))		return ExtractDelayLoad_Background1WResources(theResourceManager);
}
...
// DelayLoad_BackgroundR Resources
Image* Sexy::IMAGE_BACKGROUNDR;

bool Sexy::ExtractDelayLoad_BackgroundRResources(ResourceManager* theManager)
{
	gNeedRecalcVariableToIdMap = true;
	...
	try
	{
		IMAGE_BACKGROUNDR = aMgr.GetImageThrow("IMAGE_BACKGROUNDR");
	}
	catch (ResourceManagerException&)
	{
		return false;
...
// DelayLoad_BackgroundE Resources
Image* Sexy::IMAGE_BACKGROUNDE;
Image* Sexy::IMAGE_BACKGROUNDE_GAMEOVER_INTERIOR_OVERLAY;
Image* Sexy::IMAGE_BACKGROUNDE_GAMEOVER_MASK;

bool Sexy::ExtractDelayLoad_BackgroundEResources(ResourceManager* theManager)
{
	gNeedRecalcVariableToIdMap = true;
	...
	try
	{
		IMAGE_BACKGROUNDE = aMgr.GetImageThrow("IMAGE_BACKGROUNDE");
		IMAGE_BACKGROUNDE_GAMEOVER_INTERIOR_OVERLAY = aMgr.GetImageThrow("IMAGE_BACKGROUNDE_GAMEOVER_INTERIOR_OVERLAY");
		IMAGE_BACKGROUNDE_GAMEOVER_MASK = aMgr.GetImageThrow("IMAGE_BACKGROUNDE_GAMEOVER_MASK");
	}
	catch (ResourceManagerException&)
	{
		return false;
...
// DelayLoad_BackgroundD Resources
Image* Sexy::IMAGE_BACKGROUNDD;
Image* Sexy::IMAGE_BACKGROUNDD_GAMEOVER_INTERIOR_OVERLAY;
Image* Sexy::IMAGE_BACKGROUNDD_GAMEOVER_MASK;

bool Sexy::ExtractDelayLoad_BackgroundDResources(ResourceManager* theManager)
{
	gNeedRecalcVariableToIdMap = true;
	...
	try
	{
		IMAGE_BACKGROUNDD = aMgr.GetImageThrow("IMAGE_BACKGROUNDD");
		IMAGE_BACKGROUNDD_GAMEOVER_INTERIOR_OVERLAY = aMgr.GetImageThrow("IMAGE_BACKGROUNDD_GAMEOVER_INTERIOR_OVERLAY");
		IMAGE_BACKGROUNDD_GAMEOVER_MASK = aMgr.GetImageThrow("IMAGE_BACKGROUNDD_GAMEOVER_MASK");
	}
	catch (ResourceManagerException&)
	{
		return false;
...
// DelayLoad_BackgroundH Resources

Image* Sexy::IMAGE_BACKGROUNDH;

bool Sexy::ExtractDelayLoad_BackgroundHResources(ResourceManager* theManager)
{
	gNeedRecalcVariableToIdMap = true;
	...
	try
	{
		IMAGE_BACKGROUNDH = aMgr.GetImageThrow("IMAGE_BACKGROUNDH");
	}
	catch (ResourceManagerException&)
	{
		return false;
...
// DelayLoad_BackgroundM Resources

Image* Sexy::IMAGE_BACKGROUNDM;

bool Sexy::ExtractDelayLoad_BackgroundMResources(ResourceManager* theManager)
{
	gNeedRecalcVariableToIdMap = true;
	...
	try
	{
		IMAGE_BACKGROUNDM = aMgr.GetImageThrow("IMAGE_BACKGROUNDM");
	}
	catch (ResourceManagerException&)
	{
		return false;
...
// DelayLoad_Background1W Resources
Image* Sexy::IMAGE_BACKGROUND1W;

bool Sexy::ExtractDelayLoad_Background1WResources(ResourceManager* theManager)
{
	gNeedRecalcVariableToIdMap = true;
	...
	try
	{
		IMAGE_BACKGROUND1W = aMgr.GetImageThrow("IMAGE_BACKGROUND1W");
	}
	catch (ResourceManagerException&)
	{
		return false;
...
// DelayLoad_BackgroundFog Resources
Image* Sexy::IMAGE_FOG;
Image* Sexy::IMAGE_FOG_SOFTWARE;

bool Sexy::ExtractDelayLoad_BackgroundFogResources(ResourceManager* theManager)
{
	gNeedRecalcVariableToIdMap = true;
...
// New Images
	// Projectile
Image* Sexy::IMAGE_PROJECTILE_FUTURESTAR;
Image* Sexy::IMAGE_PROJECTILEMINT;
Image* Sexy::IMAGE_PROJECTILEFIREBALL;
Image* Sexy::IMAGE_PROJECTILEPLASMABALL;
Image* Sexy::IMAGE_REANIM_ICEBERGLETTUCE_LETTUCE;
Image* Sexy::IMAGE_REANIM_PROJECTILEPEPPER;
	// Zombie Helmet
Image* Sexy::IMAGE_REANIM_ZOMBIE_GARGANTUAR_HELMET1;
Image* Sexy::IMAGE_REANIM_ZOMBIE_GARGANTUAR_HELMET2;
Image* Sexy::IMAGE_REANIM_ZOMBIE_GARGANTUAR_HELMET3;
Image* Sexy::IMAGE_REANIM_ZOMBIE_POT1;
Image* Sexy::IMAGE_REANIM_ZOMBIE_POT2;
Image* Sexy::IMAGE_REANIM_ZOMBIE_POT3;
	// Zombie (Corpse)
Image* Sexy::IMAGE_REANIM_CORPSE_HEAD;
Image* Sexy::IMAGE_REANIM_CORPSE_JAW;
Image* Sexy::IMAGE_REANIM_CORPSE_HEAD_GIGA;
Image* Sexy::IMAGE_CORPSEHEAD;
Image* Sexy::IMAGE_CORPSEGIGAHEAD;
	// Zombie (Giga)
Image* Sexy::IMAGE_REANIM_ZOMBIE_HEAD_GIGA;
Image* Sexy::IMAGE_REANIM_ZOMBIE_GIGA_BODY;
Image* Sexy::IMAGE_REANIM_ZOMBIE_GIGA_INNERARM_LOWER;
Image* Sexy::IMAGE_REANIM_ZOMBIE_GIGA_INNERARM_SCREENDOOR;
Image* Sexy::IMAGE_REANIM_ZOMBIE_GIGA_INNERARM_UPPER;
Image* Sexy::IMAGE_REANIM_ZOMBIE_GIGA_OUTERARM_LOWER;
Image* Sexy::IMAGE_REANIM_ZOMBIE_GIGA_OUTERARM_SCREENDOOR;
Image* Sexy::IMAGE_REANIM_ZOMBIE_GIGA_OUTERARM_UPPER;
Image* Sexy::IMAGE_REANIM_ZOMBIE_GIGA_OUTERARM_UPPER2;
Image* Sexy::IMAGE_REANIM_ZOMBIE_GIGA_TIE;
Image* Sexy::IMAGE_REANIM_ZOMBIE_GIGA_UNDERBODY;
Image* Sexy::IMAGE_REANIM_ZOMBIE_GIGA_GARGANTUAR_BODY1_2;
Image* Sexy::IMAGE_REANIM_ZOMBIE_GIGA_GARGANTUAR_BODY1_3;
Image* Sexy::IMAGE_REANIM_ZOMBIE_GIGA_GARGANTUAR_FOOT2;
Image* Sexy::IMAGE_REANIM_ZOMBIE_GIGA_GARGANTUAR_HEAD2;
Image* Sexy::IMAGE_REANIM_ZOMBIE_GIGA_GARGANTUAR_OUTERARM_LOWER2;
Image* Sexy::IMAGE_ZOMBIEGIGAHEAD;
	// Minecraft
Image* Sexy::IMAGE_REANIM_MCZOMBIE_HEAD;
Image* Sexy::IMAGE_REANIM_MCSKELETON_HEAD;
Image* Sexy::IMAGE_REANIM_MCSPIDER_HEAD;
Image* Sexy::IMAGE_REANIM_MCCREEPER_HEAD;
	// UI
Image* Sexy::IMAGE_BUTTON_FASTFORWARD;
Image* Sexy::IMAGE_BUTTON_FASTFORWARD_DOWN;
Image* Sexy::IMAGE_SHADOW_SUN_BANK;
...
bool Sexy::ExtractLoadingImagesResources(ResourceManager* theManager)
{
	...
	try
	{
		...
		// New Images
			// Projectiles
		IMAGE_PROJECTILE_FUTURESTAR = aMgr.GetImageThrow("IMAGE_PROJECTILE_FUTURESTAR");
		IMAGE_PROJECTILEMINT = aMgr.GetImageThrow("IMAGE_PROJECTILEMINT");
		IMAGE_PROJECTILEFIREBALL = aMgr.GetImageThrow("IMAGE_PROJECTILEFIREBALL");
		IMAGE_PROJECTILEPLASMABALL = aMgr.GetImageThrow("IMAGE_PROJECTILEPLASMABALL");
		IMAGE_REANIM_ICEBERGLETTUCE_LETTUCE = aMgr.GetImageThrow("IMAGE_REANIM_ICEBERGLETTUCE_LETTUCE");
		IMAGE_REANIM_PROJECTILEPEPPER = aMgr.GetImageThrow("IMAGE_REANIM_PROJECTILEPEPPER");
			// Zombie Armors
		IMAGE_REANIM_ZOMBIE_GARGANTUAR_HELMET1 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_GARGANTUAR_HELMET1");
		IMAGE_REANIM_ZOMBIE_GARGANTUAR_HELMET2 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_GARGANTUAR_HELMET2");
		IMAGE_REANIM_ZOMBIE_GARGANTUAR_HELMET3 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_GARGANTUAR_HELMET3");
		IMAGE_REANIM_ZOMBIE_POT1 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_POT1");
		IMAGE_REANIM_ZOMBIE_POT2 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_POT2");
		IMAGE_REANIM_ZOMBIE_POT3 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_POT3");
			// Zombie (Corpse)
		IMAGE_REANIM_CORPSE_HEAD = aMgr.GetImageThrow("IMAGE_REANIM_CORPSE_HEAD");
		IMAGE_REANIM_CORPSE_JAW = aMgr.GetImageThrow("IMAGE_REANIM_CORPSE_JAW");
		IMAGE_REANIM_CORPSE_HEAD_GIGA = aMgr.GetImageThrow("IMAGE_REANIM_CORPSE_HEAD_GIGA");
		IMAGE_CORPSEHEAD = aMgr.GetImageThrow("IMAGE_CORPSEHEAD");
		IMAGE_CORPSEGIGAHEAD = aMgr.GetImageThrow("IMAGE_CORPSEGIGAHEAD");
			// Zombie (Giga)
		IMAGE_REANIM_ZOMBIE_HEAD_GIGA = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_HEAD_GIGA");
		IMAGE_REANIM_ZOMBIE_GIGA_BODY = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_GIGA_BODY");
		IMAGE_REANIM_ZOMBIE_GIGA_INNERARM_LOWER = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_GIGA_INNERARM_LOWER");
		IMAGE_REANIM_ZOMBIE_GIGA_INNERARM_SCREENDOOR = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_GIGA_INNERARM_SCREENDOOR");
		IMAGE_REANIM_ZOMBIE_GIGA_INNERARM_UPPER = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_GIGA_INNERARM_UPPER");
		IMAGE_REANIM_ZOMBIE_GIGA_OUTERARM_LOWER = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_GIGA_OUTERARM_LOWER");
		IMAGE_REANIM_ZOMBIE_GIGA_OUTERARM_SCREENDOOR = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_GIGA_OUTERARM_SCREENDOOR");
		IMAGE_REANIM_ZOMBIE_GIGA_OUTERARM_UPPER = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_GIGA_OUTERARM_UPPER");
		IMAGE_REANIM_ZOMBIE_GIGA_OUTERARM_UPPER2 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_GIGA_OUTERARM_UPPER2");
		IMAGE_REANIM_ZOMBIE_GIGA_TIE = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_GIGA_TIE");
		IMAGE_REANIM_ZOMBIE_GIGA_UNDERBODY = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_GIGA_UNDERBODY");
		IMAGE_REANIM_ZOMBIE_GIGA_GARGANTUAR_BODY1_2 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_GIGA_GARGANTUAR_BODY1_2");
		IMAGE_REANIM_ZOMBIE_GIGA_GARGANTUAR_BODY1_3 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_GIGA_GARGANTUAR_BODY1_3");
		IMAGE_REANIM_ZOMBIE_GIGA_GARGANTUAR_FOOT2 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_GIGA_GARGANTUAR_FOOT2");
		IMAGE_REANIM_ZOMBIE_GIGA_GARGANTUAR_HEAD2 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_GIGA_GARGANTUAR_HEAD2");
		IMAGE_REANIM_ZOMBIE_GIGA_GARGANTUAR_OUTERARM_LOWER2 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_GIGA_GARGANTUAR_OUTERARM_LOWER2");
		IMAGE_ZOMBIEGIGAHEAD = aMgr.GetImageThrow("IMAGE_ZOMBIEGIGAHEAD");
			// Minecraft
		IMAGE_REANIM_MCZOMBIE_HEAD = aMgr.GetImageThrow("IMAGE_REANIM_MCZOMBIE_HEAD");
		IMAGE_REANIM_MCSKELETON_HEAD = aMgr.GetImageThrow("IMAGE_REANIM_MCSKELETON_HEAD");
		IMAGE_REANIM_MCSPIDER_HEAD = aMgr.GetImageThrow("IMAGE_REANIM_MCSPIDER_HEAD");
		IMAGE_REANIM_MCCREEPER_HEAD = aMgr.GetImageThrow("IMAGE_REANIM_MCCREEPER_HEAD");
			// UI
		IMAGE_BUTTON_FASTFORWARD = aMgr.GetImageThrow("IMAGE_BUTTON_FASTFORWARD");
		IMAGE_BUTTON_FASTFORWARD_DOWN = aMgr.GetImageThrow("IMAGE_BUTTON_FASTFORWARD_DOWN");
		IMAGE_SHADOW_SUN_BANK = aMgr.GetImageThrow("IMAGE_SHADOW_SUN_BANK");
	}
	catch (ResourceManagerException&)
	{
		return false;
...
// New Sounds
int Sexy::SOUND_SHADOW_SUN;
int Sexy::SOUND_KILL_DING;
int Sexy::SOUND_DEADPLANTS;

int Sexy::SOUND_JACK_EASTEREGG1;
int Sexy::SOUND_JACK_EASTEREGG2;
int Sexy::SOUND_BUNGEE_MEME1;
int Sexy::SOUND_BUNGEE_MEME2;

int Sexy::SOUND_IMP_LAUGH;
int Sexy::SOUND_IMP_LAUGH2;
int Sexy::SOUND_IMP_LAUGH3;
int Sexy::SOUND_IMP_LAUGH4;
int Sexy::SOUND_IMP_LAUGH5;

int Sexy::SOUND_SUNFLOWER_DEATH;
int Sexy::SOUND_SUNFLOWER_DEATH2;
int Sexy::SOUND_SUNFLOWER_DEATH3;
int Sexy::SOUND_SUNFLOWER_DEATH4;
int Sexy::SOUND_SUNFLOWER_DEATH5;
int Sexy::SOUND_SUNFLOWER_DEATH6;
int Sexy::SOUND_SUNFLOWER_DEATH7;
int Sexy::SOUND_SUNFLOWER_DEATH8;

int Sexy::SOUND_SUNFLOWER_PLANT;
int Sexy::SOUND_SUNFLOWER_PLANT2;
int Sexy::SOUND_SUNFLOWER_PLANT3;
int Sexy::SOUND_SUNFLOWER_PLANT4;
int Sexy::SOUND_SUNFLOWER_PLANT5;
int Sexy::SOUND_SUNFLOWER_PLANT6;
int Sexy::SOUND_SUNFLOWER_PLANT7;
int Sexy::SOUND_SUNFLOWER_PLANT8;
int Sexy::SOUND_SUNFLOWER_PLANT9;
int Sexy::SOUND_SUNFLOWER_PLANT10;
int Sexy::SOUND_SUNFLOWER_PLANT11;
int Sexy::SOUND_SUNFLOWER_PLANT12;
int Sexy::SOUND_SUNFLOWER_PLANT13;
int Sexy::SOUND_SUNFLOWER_PLANT14;
int Sexy::SOUND_SUNFLOWER_PLANT15;
int Sexy::SOUND_SUNFLOWER_PLANT16;
int Sexy::SOUND_SUNFLOWER_PLANT17;
int Sexy::SOUND_SUNFLOWER_PLANT18;

int Sexy::SOUND_PEASHOOTER_DEATH;
int Sexy::SOUND_PEASHOOTER_DEATH2;
int Sexy::SOUND_PEASHOOTER_DEATH3;
int Sexy::SOUND_PEASHOOTER_DEATH4;
int Sexy::SOUND_PEASHOOTER_DEATH5;
int Sexy::SOUND_PEASHOOTER_DEATH6;
int Sexy::SOUND_PEASHOOTER_DEATH7;
int Sexy::SOUND_PEASHOOTER_DEATH8;
int Sexy::SOUND_PEASHOOTER_DEATH9;
int Sexy::SOUND_PEASHOOTER_DEATH10;
int Sexy::SOUND_PEASHOOTER_DEATH11;
int Sexy::SOUND_PEASHOOTER_DEATH12;
int Sexy::SOUND_PEASHOOTER_DEATH13;

int Sexy::SOUND_PEASHOOTER_PLANT;
int Sexy::SOUND_PEASHOOTER_PLANT2;
int Sexy::SOUND_PEASHOOTER_PLANT3;
int Sexy::SOUND_PEASHOOTER_PLANT4;
int Sexy::SOUND_PEASHOOTER_PLANT5;
int Sexy::SOUND_PEASHOOTER_PLANT6;
int Sexy::SOUND_PEASHOOTER_PLANT7;
int Sexy::SOUND_PEASHOOTER_PLANT8;
int Sexy::SOUND_PEASHOOTER_PLANT9;
int Sexy::SOUND_PEASHOOTER_PLANT10;
int Sexy::SOUND_PEASHOOTER_PLANT11;
int Sexy::SOUND_PEASHOOTER_PLANT12;
int Sexy::SOUND_PEASHOOTER_PLANT13;
int Sexy::SOUND_PEASHOOTER_PLANT14;
int Sexy::SOUND_PEASHOOTER_PLANT15;

int Sexy::SOUND_MCZOMBIE_IDLE1;
int Sexy::SOUND_MCZOMBIE_IDLE2;
int Sexy::SOUND_MCZOMBIE_IDLE3;
int Sexy::SOUND_MCSKELETON_IDLE1;
int Sexy::SOUND_MCSKELETON_IDLE2;
int Sexy::SOUND_MCSKELETON_IDLE3;
int Sexy::SOUND_MCSPIDER_IDLE1;
int Sexy::SOUND_MCSPIDER_IDLE2;
int Sexy::SOUND_MCSPIDER_IDLE3;
int Sexy::SOUND_MCSPIDER_IDLE4;
...
bool Sexy::ExtractLoadingSoundsResources(ResourceManager* theManager)
{
	...
	try
	{
		...
		// New Sounds
		SOUND_SHADOW_SUN = aMgr.GetSoundThrow("SOUND_SHADOW_SUN");
		SOUND_KILL_DING = aMgr.GetSoundThrow("SOUND_KILL_DING");
		SOUND_DEADPLANTS = aMgr.GetSoundThrow("SOUND_DEADPLANTS");

		SOUND_JACK_EASTEREGG1 = aMgr.GetSoundThrow("SOUND_JACK_EASTEREGG1");
		SOUND_JACK_EASTEREGG2 = aMgr.GetSoundThrow("SOUND_JACK_EASTEREGG2");
		SOUND_BUNGEE_MEME1 = aMgr.GetSoundThrow("SOUND_BUNGEE_MEME1");
		SOUND_BUNGEE_MEME2 = aMgr.GetSoundThrow("SOUND_BUNGEE_MEME2");

		SOUND_IMP_LAUGH = aMgr.GetSoundThrow("SOUND_IMP_LAUGH");
		SOUND_IMP_LAUGH2 = aMgr.GetSoundThrow("SOUND_IMP_LAUGH2");
		SOUND_IMP_LAUGH3 = aMgr.GetSoundThrow("SOUND_IMP_LAUGH3");
		SOUND_IMP_LAUGH4 = aMgr.GetSoundThrow("SOUND_IMP_LAUGH4");
		SOUND_IMP_LAUGH5 = aMgr.GetSoundThrow("SOUND_IMP_LAUGH5");

		SOUND_SUNFLOWER_DEATH = aMgr.GetSoundThrow("SOUND_SUNFLOWER_DEATH");
		SOUND_SUNFLOWER_DEATH2 = aMgr.GetSoundThrow("SOUND_SUNFLOWER_DEATH2");
		SOUND_SUNFLOWER_DEATH3 = aMgr.GetSoundThrow("SOUND_SUNFLOWER_DEATH3");
		SOUND_SUNFLOWER_DEATH4 = aMgr.GetSoundThrow("SOUND_SUNFLOWER_DEATH4");
		SOUND_SUNFLOWER_DEATH5 = aMgr.GetSoundThrow("SOUND_SUNFLOWER_DEATH5");
		SOUND_SUNFLOWER_DEATH6 = aMgr.GetSoundThrow("SOUND_SUNFLOWER_DEATH6");
		SOUND_SUNFLOWER_DEATH7 = aMgr.GetSoundThrow("SOUND_SUNFLOWER_DEATH7");
		SOUND_SUNFLOWER_DEATH8 = aMgr.GetSoundThrow("SOUND_SUNFLOWER_DEATH8");

		SOUND_SUNFLOWER_PLANT = aMgr.GetSoundThrow("SOUND_SUNFLOWER_PLANT");
		SOUND_SUNFLOWER_PLANT2 = aMgr.GetSoundThrow("SOUND_SUNFLOWER_PLANT2");
		SOUND_SUNFLOWER_PLANT3 = aMgr.GetSoundThrow("SOUND_SUNFLOWER_PLANT3");
		SOUND_SUNFLOWER_PLANT4 = aMgr.GetSoundThrow("SOUND_SUNFLOWER_PLANT4");
		SOUND_SUNFLOWER_PLANT5 = aMgr.GetSoundThrow("SOUND_SUNFLOWER_PLANT5");
		SOUND_SUNFLOWER_PLANT6 = aMgr.GetSoundThrow("SOUND_SUNFLOWER_PLANT6");
		SOUND_SUNFLOWER_PLANT7 = aMgr.GetSoundThrow("SOUND_SUNFLOWER_PLANT7");
		SOUND_SUNFLOWER_PLANT8 = aMgr.GetSoundThrow("SOUND_SUNFLOWER_PLANT8");
		SOUND_SUNFLOWER_PLANT9 = aMgr.GetSoundThrow("SOUND_SUNFLOWER_PLANT9");
		SOUND_SUNFLOWER_PLANT10 = aMgr.GetSoundThrow("SOUND_SUNFLOWER_PLANT10");
		SOUND_SUNFLOWER_PLANT11 = aMgr.GetSoundThrow("SOUND_SUNFLOWER_PLANT11");
		SOUND_SUNFLOWER_PLANT12 = aMgr.GetSoundThrow("SOUND_SUNFLOWER_PLANT12");
		SOUND_SUNFLOWER_PLANT13 = aMgr.GetSoundThrow("SOUND_SUNFLOWER_PLANT13");
		SOUND_SUNFLOWER_PLANT14 = aMgr.GetSoundThrow("SOUND_SUNFLOWER_PLANT14");
		SOUND_SUNFLOWER_PLANT15 = aMgr.GetSoundThrow("SOUND_SUNFLOWER_PLANT15");
		SOUND_SUNFLOWER_PLANT16 = aMgr.GetSoundThrow("SOUND_SUNFLOWER_PLANT16");
		SOUND_SUNFLOWER_PLANT17 = aMgr.GetSoundThrow("SOUND_SUNFLOWER_PLANT17");
		SOUND_SUNFLOWER_PLANT18 = aMgr.GetSoundThrow("SOUND_SUNFLOWER_PLANT18");

		SOUND_PEASHOOTER_DEATH = aMgr.GetSoundThrow("SOUND_PEASHOOTER_DEATH");
		SOUND_PEASHOOTER_DEATH2 = aMgr.GetSoundThrow("SOUND_PEASHOOTER_DEATH2");
		SOUND_PEASHOOTER_DEATH3 = aMgr.GetSoundThrow("SOUND_PEASHOOTER_DEATH3");
		SOUND_PEASHOOTER_DEATH4 = aMgr.GetSoundThrow("SOUND_PEASHOOTER_DEATH4");
		SOUND_PEASHOOTER_DEATH5 = aMgr.GetSoundThrow("SOUND_PEASHOOTER_DEATH5");
		SOUND_PEASHOOTER_DEATH6 = aMgr.GetSoundThrow("SOUND_PEASHOOTER_DEATH6");
		SOUND_PEASHOOTER_DEATH7 = aMgr.GetSoundThrow("SOUND_PEASHOOTER_DEATH7");
		SOUND_PEASHOOTER_DEATH8 = aMgr.GetSoundThrow("SOUND_PEASHOOTER_DEATH8");
		SOUND_PEASHOOTER_DEATH9 = aMgr.GetSoundThrow("SOUND_PEASHOOTER_DEATH9");
		SOUND_PEASHOOTER_DEATH10 = aMgr.GetSoundThrow("SOUND_PEASHOOTER_DEATH10");
		SOUND_PEASHOOTER_DEATH11 = aMgr.GetSoundThrow("SOUND_PEASHOOTER_DEATH11");
		SOUND_PEASHOOTER_DEATH12 = aMgr.GetSoundThrow("SOUND_PEASHOOTER_DEATH12");
		SOUND_PEASHOOTER_DEATH13 = aMgr.GetSoundThrow("SOUND_PEASHOOTER_DEATH13");

		SOUND_PEASHOOTER_PLANT = aMgr.GetSoundThrow("SOUND_PEASHOOTER_PLANT");
		SOUND_PEASHOOTER_PLANT2 = aMgr.GetSoundThrow("SOUND_PEASHOOTER_PLANT2");
		SOUND_PEASHOOTER_PLANT3 = aMgr.GetSoundThrow("SOUND_PEASHOOTER_PLANT3");
		SOUND_PEASHOOTER_PLANT4 = aMgr.GetSoundThrow("SOUND_PEASHOOTER_PLANT4");
		SOUND_PEASHOOTER_PLANT5 = aMgr.GetSoundThrow("SOUND_PEASHOOTER_PLANT5");
		SOUND_PEASHOOTER_PLANT6 = aMgr.GetSoundThrow("SOUND_PEASHOOTER_PLANT6");
		SOUND_PEASHOOTER_PLANT7 = aMgr.GetSoundThrow("SOUND_PEASHOOTER_PLANT7");
		SOUND_PEASHOOTER_PLANT8 = aMgr.GetSoundThrow("SOUND_PEASHOOTER_PLANT8");
		SOUND_PEASHOOTER_PLANT9 = aMgr.GetSoundThrow("SOUND_PEASHOOTER_PLANT9");
		SOUND_PEASHOOTER_PLANT10 = aMgr.GetSoundThrow("SOUND_PEASHOOTER_PLANT10");
		SOUND_PEASHOOTER_PLANT11 = aMgr.GetSoundThrow("SOUND_PEASHOOTER_PLANT11");
		SOUND_PEASHOOTER_PLANT12 = aMgr.GetSoundThrow("SOUND_PEASHOOTER_PLANT12");
		SOUND_PEASHOOTER_PLANT13 = aMgr.GetSoundThrow("SOUND_PEASHOOTER_PLANT13");
		SOUND_PEASHOOTER_PLANT14 = aMgr.GetSoundThrow("SOUND_PEASHOOTER_PLANT14");
		SOUND_PEASHOOTER_PLANT15 = aMgr.GetSoundThrow("SOUND_PEASHOOTER_PLANT15");

		SOUND_MCZOMBIE_IDLE1 = aMgr.GetSoundThrow("SOUND_MCZOMBIE_IDLE1");
		SOUND_MCZOMBIE_IDLE2 = aMgr.GetSoundThrow("SOUND_MCZOMBIE_IDLE2");
		SOUND_MCZOMBIE_IDLE3 = aMgr.GetSoundThrow("SOUND_MCZOMBIE_IDLE3");
		SOUND_MCSKELETON_IDLE1 = aMgr.GetSoundThrow("SOUND_MCSKELETON_IDLE1");
		SOUND_MCSKELETON_IDLE2 = aMgr.GetSoundThrow("SOUND_MCSKELETON_IDLE2");
		SOUND_MCSKELETON_IDLE3 = aMgr.GetSoundThrow("SOUND_MCSKELETON_IDLE3");
		SOUND_MCSPIDER_IDLE1 = aMgr.GetSoundThrow("SOUND_MCSPIDER_IDLE1");
		SOUND_MCSPIDER_IDLE2 = aMgr.GetSoundThrow("SOUND_MCSPIDER_IDLE2");
		SOUND_MCSPIDER_IDLE3 = aMgr.GetSoundThrow("SOUND_MCSPIDER_IDLE3");
		SOUND_MCSPIDER_IDLE4 = aMgr.GetSoundThrow("SOUND_MCSPIDER_IDLE4");
	}
	catch (ResourceManagerException&)
	{
		return false;
...
void* gResources[(int)Sexy::ResourceId::RESOURCE_ID_MAX] =
{
	...
	// New Images
		// Projectiles
	&Sexy::IMAGE_PROJECTILE_FUTURESTAR,
	&Sexy::IMAGE_PROJECTILEMINT,
	&Sexy::IMAGE_PROJECTILEFIREBALL,
	&Sexy::IMAGE_PROJECTILEPLASMABALL,
	&Sexy::IMAGE_REANIM_ICEBERGLETTUCE_LETTUCE,
	&Sexy::IMAGE_REANIM_PROJECTILEPEPPER,
		// Zombie Armors
	&Sexy::IMAGE_REANIM_ZOMBIE_GARGANTUAR_HELMET1,
	&Sexy::IMAGE_REANIM_ZOMBIE_GARGANTUAR_HELMET2,
	&Sexy::IMAGE_REANIM_ZOMBIE_GARGANTUAR_HELMET3,
	&Sexy::IMAGE_REANIM_ZOMBIE_POT1,
	&Sexy::IMAGE_REANIM_ZOMBIE_POT2,
	&Sexy::IMAGE_REANIM_ZOMBIE_POT3,
		// Zombie (Corpse)
	&Sexy::IMAGE_REANIM_CORPSE_HEAD,
	&Sexy::IMAGE_REANIM_CORPSE_JAW,
	&Sexy::IMAGE_REANIM_CORPSE_HEAD_GIGA,
	&Sexy::IMAGE_CORPSEHEAD,
	&Sexy::IMAGE_CORPSEGIGAHEAD,
		// Zombie (Giga)
	&Sexy::IMAGE_REANIM_ZOMBIE_HEAD_GIGA,
	&Sexy::IMAGE_REANIM_ZOMBIE_GIGA_BODY,
	&Sexy::IMAGE_REANIM_ZOMBIE_GIGA_INNERARM_LOWER,
	&Sexy::IMAGE_REANIM_ZOMBIE_GIGA_INNERARM_SCREENDOOR,
	&Sexy::IMAGE_REANIM_ZOMBIE_GIGA_INNERARM_UPPER,
	&Sexy::IMAGE_REANIM_ZOMBIE_GIGA_OUTERARM_LOWER,
	&Sexy::IMAGE_REANIM_ZOMBIE_GIGA_OUTERARM_SCREENDOOR,
	&Sexy::IMAGE_REANIM_ZOMBIE_GIGA_OUTERARM_UPPER,
	&Sexy::IMAGE_REANIM_ZOMBIE_GIGA_OUTERARM_UPPER2,
	&Sexy::IMAGE_REANIM_ZOMBIE_GIGA_TIE,
	&Sexy::IMAGE_REANIM_ZOMBIE_GIGA_UNDERBODY,
	&Sexy::IMAGE_REANIM_ZOMBIE_GIGA_GARGANTUAR_BODY1_2,
	&Sexy::IMAGE_REANIM_ZOMBIE_GIGA_GARGANTUAR_BODY1_3,
	&Sexy::IMAGE_REANIM_ZOMBIE_GIGA_GARGANTUAR_FOOT2,
	&Sexy::IMAGE_REANIM_ZOMBIE_GIGA_GARGANTUAR_HEAD2,
	&Sexy::IMAGE_REANIM_ZOMBIE_GIGA_GARGANTUAR_OUTERARM_LOWER2,
	&Sexy::IMAGE_ZOMBIEGIGAHEAD,
		// Minecraft
	&Sexy::IMAGE_REANIM_MCZOMBIE_HEAD,
	&Sexy::IMAGE_REANIM_MCSKELETON_HEAD,
	&Sexy::IMAGE_REANIM_MCSPIDER_HEAD,
	&Sexy::IMAGE_REANIM_MCCREEPER_HEAD,
	&Sexy::IMAGE_BUTTON_FASTFORWARD,
	&Sexy::IMAGE_BUTTON_FASTFORWARD_DOWN,
	&Sexy::IMAGE_SHADOW_SUN_BANK,
	/* LoadingSounds */
	&Sexy::SOUND_AWOOGA,
	&Sexy::SOUND_BLEEP,
	&Sexy::SOUND_BUZZER,
	...
	/* Loading New Sounds */ 
	&Sexy::SOUND_SHADOW_SUN,
	&Sexy::SOUND_KILL_DING,
	&Sexy::SOUND_DEADPLANTS,

	&Sexy::SOUND_JACK_EASTEREGG1,
	&Sexy::SOUND_JACK_EASTEREGG2,
	&Sexy::SOUND_BUNGEE_MEME1,
	&Sexy::SOUND_BUNGEE_MEME2,

	&Sexy::SOUND_IMP_LAUGH,
	&Sexy::SOUND_IMP_LAUGH2,
	&Sexy::SOUND_IMP_LAUGH3,
	&Sexy::SOUND_IMP_LAUGH4,
	&Sexy::SOUND_IMP_LAUGH5,

	&Sexy::SOUND_SUNFLOWER_DEATH,
	&Sexy::SOUND_SUNFLOWER_DEATH2,
	&Sexy::SOUND_SUNFLOWER_DEATH3,
	&Sexy::SOUND_SUNFLOWER_DEATH4,
	&Sexy::SOUND_SUNFLOWER_DEATH5,
	&Sexy::SOUND_SUNFLOWER_DEATH6,
	&Sexy::SOUND_SUNFLOWER_DEATH7,
	&Sexy::SOUND_SUNFLOWER_DEATH8,

	&Sexy::SOUND_SUNFLOWER_PLANT,
	&Sexy::SOUND_SUNFLOWER_PLANT2,
	&Sexy::SOUND_SUNFLOWER_PLANT3,
	&Sexy::SOUND_SUNFLOWER_PLANT4,
	&Sexy::SOUND_SUNFLOWER_PLANT5,
	&Sexy::SOUND_SUNFLOWER_PLANT6,
	&Sexy::SOUND_SUNFLOWER_PLANT7,
	&Sexy::SOUND_SUNFLOWER_PLANT8,
	&Sexy::SOUND_SUNFLOWER_PLANT9,
	&Sexy::SOUND_SUNFLOWER_PLANT10,
	&Sexy::SOUND_SUNFLOWER_PLANT11,
	&Sexy::SOUND_SUNFLOWER_PLANT12,
	&Sexy::SOUND_SUNFLOWER_PLANT13,
	&Sexy::SOUND_SUNFLOWER_PLANT14,
	&Sexy::SOUND_SUNFLOWER_PLANT15,
	&Sexy::SOUND_SUNFLOWER_PLANT16,
	&Sexy::SOUND_SUNFLOWER_PLANT17,
	&Sexy::SOUND_SUNFLOWER_PLANT18,

	&Sexy::SOUND_PEASHOOTER_DEATH,
	&Sexy::SOUND_PEASHOOTER_DEATH2,
	&Sexy::SOUND_PEASHOOTER_DEATH3,
	&Sexy::SOUND_PEASHOOTER_DEATH4,
	&Sexy::SOUND_PEASHOOTER_DEATH5,
	&Sexy::SOUND_PEASHOOTER_DEATH6,
	&Sexy::SOUND_PEASHOOTER_DEATH7,
	&Sexy::SOUND_PEASHOOTER_DEATH8,
	&Sexy::SOUND_PEASHOOTER_DEATH9,
	&Sexy::SOUND_PEASHOOTER_DEATH10,
	&Sexy::SOUND_PEASHOOTER_DEATH11,
	&Sexy::SOUND_PEASHOOTER_DEATH12,
	&Sexy::SOUND_PEASHOOTER_DEATH13,

	&Sexy::SOUND_PEASHOOTER_PLANT,
	&Sexy::SOUND_PEASHOOTER_PLANT2,
	&Sexy::SOUND_PEASHOOTER_PLANT3,
	&Sexy::SOUND_PEASHOOTER_PLANT4,
	&Sexy::SOUND_PEASHOOTER_PLANT5,
	&Sexy::SOUND_PEASHOOTER_PLANT6,
	&Sexy::SOUND_PEASHOOTER_PLANT7,
	&Sexy::SOUND_PEASHOOTER_PLANT8,
	&Sexy::SOUND_PEASHOOTER_PLANT9,
	&Sexy::SOUND_PEASHOOTER_PLANT10,
	&Sexy::SOUND_PEASHOOTER_PLANT11,
	&Sexy::SOUND_PEASHOOTER_PLANT12,
	&Sexy::SOUND_PEASHOOTER_PLANT13,
	&Sexy::SOUND_PEASHOOTER_PLANT14,
	&Sexy::SOUND_PEASHOOTER_PLANT15,

	&Sexy::SOUND_MCZOMBIE_IDLE1,
	&Sexy::SOUND_MCZOMBIE_IDLE2,
	&Sexy::SOUND_MCZOMBIE_IDLE3,
	&Sexy::SOUND_MCSKELETON_IDLE1,
	&Sexy::SOUND_MCSKELETON_IDLE2,
	&Sexy::SOUND_MCSKELETON_IDLE3,
	&Sexy::SOUND_MCSPIDER_IDLE1,
	&Sexy::SOUND_MCSPIDER_IDLE2,
	&Sexy::SOUND_MCSPIDER_IDLE3,
	&Sexy::SOUND_MCSPIDER_IDLE4,
	...
	/* DelayLoad_TreeOfWisdom */
		// New
	/* DelayLoad_BackgroundE */
	&Sexy::IMAGE_BACKGROUNDR,
	/* DelayLoad_BackgroundE */
	&Sexy::IMAGE_BACKGROUNDE,
	&Sexy::IMAGE_BACKGROUNDE_GAMEOVER_INTERIOR_OVERLAY,
	&Sexy::IMAGE_BACKGROUNDE_GAMEOVER_MASK,
	/* DelayLoad_BackgroundD */
	&Sexy::IMAGE_BACKGROUNDD,
	&Sexy::IMAGE_BACKGROUNDD_GAMEOVER_INTERIOR_OVERLAY,
	&Sexy::IMAGE_BACKGROUNDD_GAMEOVER_MASK,
	/* DelayLoad_BackgroundH */
	&Sexy::IMAGE_BACKGROUNDH,
	/* DelayLoad_BackgroundM */
	&Sexy::IMAGE_BACKGROUNDM,
	/* DelayLoad_Background1W */
	&Sexy::IMAGE_BACKGROUND1W,
