...
enum FoleyType
{
    ...
    FOLEY_SHADOW_SUN,
    FOLEY_KILL_DING,
    FOLEY_JACK_EASTEREGG,
    FOLEY_BUNGEE_MEME,
    FOLEY_IMP_LAUGH,
    FOLEY_IMP_BRAINS,
    FOLEY_SUNFLOWER_DEATH,
    FOLEY_SUNFLOWER_PLANT,
    FOLEY_PEASHOOTER_DEATH,
    FOLEY_PEASHOOTER_PLANT,
    FOLEY_MCZOMBIE_IDLE,
    FOLEY_MCSKELETON_IDLE,
    FOLEY_MCSPIDER_IDLE,
    NUM_FOLEY
};
